...
`,_m=!1;function vm(){if(_m)return;_m=!0;let e=document.createElement(`style`);e.textContent=gm,document.head.append(e)}function ym(e){let t=new URLSearchParams(e).get(`ai`);if(!t)return;let n=t===`both`?[`machines`,`ancients`]:t.split(`,`).map(e=>e.trim()),r={};for(let e of n)(e===`machines`||e===`ancients`)&&(r[e]=`ai`);return Object.keys(r).length>0?r:void 0}var bm=1213353265,xm=250,Sm=85,Cm=100,wm=1800,Tm=[1,2,4],Em=80,Dm=3;function Om(e,t,n){let r,i=1/0;for(let a of e.buildings){if(a.state===`rubble`)continue;let e=(a.x-t)**2+(a.z-n)**2;e<i&&(i=e,r=a.id)}return r}var km=class{windowTicks;ticks=[];earned=[];total=0;last=null;constructor(e=360){this.windowTicks=e}add(e,t){for(this.last!==null&&t>this.last&&(this.total+=t-this.last),this.last=t,this.ticks.push(e),this.earned.push(this.total);this.ticks.length>1&&e-(this.ticks[0]??e)>this.windowTicks;)this.ticks.shift(),this.earned.shift()}get perMinute(){if(this.ticks.length<2)return 0;let e=(this.ticks.at(-1)??0)-(this.ticks[0]??0);return e<=0?0:((this.earned.at(-1)??0)-(this.earned[0]??0))/e*30*60}};function Am(e){switch(e.kind){case`produced`:case`constructionComplete`:case`productionQueued`:return null;case`productionRefused`:return`INSUFFICIENT HUMANS`;case`productionQueueFull`:return`QUEUE FULL (5)`;case`productionBlocked`:return`NO ROOM TO DEPLOY`;case`buildRefused`:return`CANNOT BUILD HERE`;case`constructionRefusedResources`:return`INSUFFICIENT HUMANS`;case`constructionStarted`:return`${(e.subject??`STRUCTURE`).toUpperCase()} SUMMONING`;case`constructionCancelled`:return`SUMMONING CANCELLED`;case`underAttack`:return`UNIT UNDER ATTACK`;case`combatHit`:return null;case`unitDown`:return`UNIT DESTROYED`;case`harbingerDown`:return`HARBINGER DESTROYED`;case`matchResolved`:return null;case`tier2`:return`TIER 2 UNLOCKED`;case`tier2Refused`:return`TIER 2 UNAVAILABLE`;case`deposited`:return null;case`playerFactionChanged`:return null}}var jm=new Set([`productionRefused`,`productionQueueFull`,`productionBlocked`,`constructionStarted`,`constructionCancelled`,`constructionRefusedResources`]);function Mm({world:e,renderer:t,toonEffect:n,renderSettings:r,overlayEl:i,boxEl:a,store:o,onLoadRequested:s,onSeedStepRequested:c,onExitToTitle:l,onPlayAgainRequested:u,onPlayerFactionCycleRequested:d,diagnosticsEnabled:f,detailedPerformance:p}){let m=new Do(e),h=new lm(e.city,e.army,r);h.units.preloadAll(e.playerFaction);let g=e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction),_=e.city.startAnchors[e.playerFaction===`machines`?0:1]??{x:0,z:0},v=g.length>0?{x:g.reduce((e,t)=>e+t.x,0)/g.length,z:g.reduce((e,t)=>e+t.z,0)/g.length}:_,y=new Xl(window.innerWidth/window.innerHeight,v),b=new ji(t.domElement),x=new dm,S=t=>{e.controllers[e.playerFaction]!==`ai`&&e.enqueue(e.playerFaction,t)},C=new Md(i),w=new kd,T=p&&r.modelMode===`detailed`;T&&(t.info.autoReset=!1);let E=new km,D=new km,O=new zd(document.body,e.city,e.population,e.populationCapacity,e.playerFaction),ee=new of(e.city,h.city,e.population,e.populationCapacity);h.scene.add(ee.group);let k=new pf(document.body),A=new Ef(e.city,e.army,e.population);h.scene.add(A.group);let j=new Ff;h.scene.add(j.group);let M=new Rf;h.scene.add(M.group);let N=null,te=0,P=(e,t)=>{N=e,te=t+wm},ne=t=>{t===`cancel`&&x.size>0?S({kind:`stop`,unitIds:x.list()}):t===`primary`&&x.size>0&&e.playerFaction===`machines`&&S({kind:`deploy`,unitIds:x.list()})},re=new wu(document.body,Uu({world:e,selected:0,banner:null}),ne),ie=Cm,F=null,I=null,L=!1,ae=0,oe={onDeploy:()=>S({kind:`deploy`,unitIds:x.list()}),onIsolateType:t=>{x.set(x.list().filter(n=>e.army.get(n)?.typeId===t))}},R=new tu(document.body,e.playerFaction,oe),z={onProduce:(e,t)=>S({kind:`produce`,producer:e,typeId:t}),onBuild:(t,n)=>{let r=fs(n).cost;if(!e.freeProduction&&e.resources.humans<r){P(`INSUFFICIENT HUMANS`,performance.now());return}I={builderId:t.id,structureTypeId:n},P(`CHOOSE SUMMONING SITE`,performance.now())},onUnlockTier2:()=>S({kind:`unlockTier2`})},se=new pu(document.body,e.playerFaction,z),ce=null,le=0,ue=null,de=!0,fe=null,pe=!1,B=()=>{fe?.dispose(),fe=null,pe=!1,b.consume()},me=()=>{fe||=(pe=!0,new fd(document.body,ue,{onSaveAndExit:()=>{if(!o){B(),l();return}let t=Sc(e);o.put(t,Date.now()).catch(e=>console.error(`save failed`,e)).finally(()=>{B(),l()})},onExitAnyway:()=>{B(),l()},onCancel:()=>B()}))},he=null,ge=t=>{he||=(fe&&B(),pe=!0,x.clear(),new pd(document.body,{winner:t.winner??void 0,playerFaction:e.playerFaction},{onPlayAgain:()=>u(),onBackToMenu:()=>l()}))};vm();let _e=document.createElement(`div`);_e.className=`control-notice`,_e.style.display=`none`;let ve=document.createElement(`div`);ve.className=`speed-notice`,ve.style.display=`none`,document.body.append(_e,ve);let ye=``,be=``,xe=()=>{let t=e.controllers[e.playerFaction]===`ai`?`AI CONTROLLED`:``;t!==ye&&(ye=t,_e.textContent=t,_e.style.display=t.length>0?`block`:`none`);let n=Tm[ae]??1,r=n===1?``:`${n}× SPEED`;r!==be&&(be=r,ve.textContent=r,ve.style.display=r.length>0?`block`:`none`)};xe();let Se=()=>{x.clear(),F=null,I=null,L=!1,N=null,ce=null,E=new km,D=new km,O.setFaction(e.playerFaction),re.dispose(),R.dispose(),se.dispose(),re=new wu(document.body,Uu({world:e,selected:0,banner:null}),ne),R=new tu(document.body,e.playerFaction,oe),se=new pu(document.body,e.playerFaction,z),ie=Cm,de=!0,xe()},Ce=()=>{t.setSize(window.innerWidth,window.innerHeight),y.setAspect(window.innerWidth/window.innerHeight),de=!0};window.addEventListener(`resize`,Ce);let we=new Me,Te=t=>{let n=Wl(y.camera,e.city,t);return jo(n===void 0?void 0:e.city.get(n),e.population)?n:void 0},Ee=t=>{if(x.size===0)return;let n=Al(y.camera,e.army,t,h.units),r=n===void 0?void 0:e.army.get(n);if(!(!r||e.army.typeOf(r).faction===e.playerFaction))return x.list().some(t=>{let n=e.army.get(t);if(!n||n.deployTimer>0)return!1;let r=e.army.typeOf(n);return r.faction===e.playerFaction&&(r.weaponIds??[]).some(e=>cs(e).targetClasses.includes(`unit`))})?r.id:void 0},De=0,Oe=null,ke=0,V=0,Ae=30,je=xm,H=0,Ne=0,Pe=0,Fe=!1,Ie=!1,U=e.tick,Le=``,W=NaN,G=NaN,K=NaN,Re=!0,ze=0,Be=!1,Ve=r=>{if(Be)return;let i=Oe===null?1e3/60:r-Oe;if(Oe=r,w.add(i),T&&t.info.reset(),b.sample(),!pe){y.update(b,i/1e3);let t=f(),n=I!==null&&b.orderAt!==void 0;n&&(I=null,P(`SUMMONING CANCELLED`,r));let a=e.controllers[e.playerFaction]===`human`;a||(x.size>0&&x.clear(),F=null,I=null,L=!1);let l=a?b.selectGesture:void 0;if(L&&b.orderAt!==void 0)L=!1,P(`ATTACK MOVE CANCELLED`,r);else if(L&&l&&!l.isBox){we.set((l.rect.x0+l.rect.x1)/2,(l.rect.y0+l.rect.y1)/2);let t=Wl(y.camera,e.city,we),n=kl(y.camera,we);if(t!==void 0&&x.size>0){let n=e.city.get(t);n&&(S({kind:`attack`,unitIds:x.list(),buildingId:n.id,x:n.x,z:n.z}),P(`DEMOLISHING`,r))}else n&&x.size>0&&(S({kind:`attackMove`,unitIds:x.list(),x:n.x,z:n.z}),P(`ATTACK MOVE`,r));L=!1}else if(l&&I){if(!l.isBox){we.set((l.rect.x0+l.rect.x1)/2,(l.rect.y0+l.rect.y1)/2);let t=kl(y.camera,we),n=t&&e.constructionPlacement(I.builderId,I.structureTypeId,t.x,t.z);n&&(S({kind:`build`,builderId:I.builderId,structureTypeId:I.structureTypeId,x:n.x,z:n.z}),I=null)}}else if(l)if(l.isBox){let t=Kl(y.camera,e.army,l.rect).filter(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});l.additive?x.add(t):x.set(t)}else{we.set((l.rect.x0+l.rect.x1)/2,(l.rect.y0+l.rect.y1)/2);let t=Al(y.camera,e.army,we,h.units),n=t===void 0?void 0:e.army.get(t),i=n&&e.army.typeOf(n).faction===e.playerFaction?t:void 0;if(n&&i===void 0)F=n.id,l.additive||x.clear();else if(i===void 0){l.additive||(F=null);let t=x.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),n=Ol(y.camera,e.crowds.all,we),i=Te(we);t.length>0&&n!==void 0?(S({kind:`harvest`,unitIds:t,crowdId:n}),P(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,r)):t.length>0&&i!==void 0?(S({kind:`harvest`,unitIds:t,buildingId:i}),P(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,r)):l.additive||x.clear()}else if(l.doubleClick){let t=n.typeId,r=ql(y.camera,e.army).filter(n=>{let r=e.army.get(n);return r!==void 0&&e.army.typeOf(r).faction===e.playerFaction&&r.typeId===t});F=null,l.additive?x.add(r):x.set(r)}else l.additive?(F=null,x.toggle(i)):(F=null,x.set([i]))}for(let e of um){let t=a?b.pressModifiers(`Digit${e}`):void 0;t&&(t.shift?x.assignGroup(e):x.recallGroup(e))}if(b.wasPressed(`Escape`)&&(L?(L=!1,P(`ATTACK MOVE CANCELLED`,r)):I?(I=null,P(`SUMMONING CANCELLED`,r)):x.size>0||F!==null?(x.clear(),F=null):me()),t&&b.wasPressed(`KeyP`)&&(Re=!0),t&&b.wasPressed(`KeyI`)&&O.toggle(),t&&b.wasPressed(`KeyY`)&&d(),t&&b.wasPressed(`BracketLeft`)&&c(-1),t&&b.wasPressed(`BracketRight`)&&c(1),b.orderAt&&!n&&x.size>0){let t=x.list(),n=Ee(b.orderAt),i=t.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),a=Ol(y.camera,e.crowds.all,b.orderAt),o=Te(b.orderAt);if(n!==void 0){let r=e.army.get(n);r&&S({kind:`attack`,unitIds:t,targetId:r.id,x:r.x,z:r.z})}else if(i.length>0&&a!==void 0)S({kind:`harvest`,unitIds:i,crowdId:a}),P(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,r);else if(i.length>0&&o!==void 0)S({kind:`harvest`,unitIds:i,buildingId:o}),P(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,r);else{let e=kl(y.camera,b.orderAt);e&&S({kind:`move`,unitIds:t,x:e.x,z:e.z})}}if(t&&b.wasPressed(`KeyO`)){let t=b.pressModifiers(`KeyO`)?.shift?e.playerFaction===`machines`?`ancients`:`machines`:e.playerFaction,n=e.controllers[t]===`ai`?`human`:`ai`;e.enqueue(`debug`,{kind:`setController`,faction:t,controller:n}),n===`ai`&&t===e.playerFaction&&x.clear()}if(t&&b.wasPressed(`KeyF`)&&(ae=(ae+1)%Tm.length,P(`${Tm[ae]??1}× SPEED`,r)),b.wasPressed(`KeyA`)&&x.size>0&&(L=!0,I=null,P(`ATTACK MOVE · PICK A POINT`,r)),b.wasPressed(`KeyQ`)&&x.size>0&&S({kind:`stop`,unitIds:x.list()}),t&&b.wasPressed(`KeyX`)){let t=Om(e.city,y.focus.x,y.focus.z);t!==void 0&&e.enqueue(`debug`,{kind:`damage`,buildingId:t})}if(t&&b.wasPressed(`KeyZ`)&&e.enqueue(`debug`,{kind:`raze`,x:y.focus.x,z:y.focus.z,radius:Sm}),t&&b.wasPressed(`KeyB`)){De=(De+1)%qi.length;let t=qi[De];e.enqueue(`debug`,{kind:`setAllStates`,state:t})}if(t&&b.wasPressed(`KeyH`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:Em,charge:0}),t&&b.wasPressed(`KeyJ`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:0,charge:Dm}),t&&b.wasPressed(`KeyE`)&&x.size>0){let t=Om(e.city,y.focus.x,y.focus.z);t!==void 0&&jo(e.city.get(t),e.population)&&(S({kind:`harvest`,unitIds:x.list(),buildingId:t}),P(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,r))}if(t&&b.wasPressed(`KeyR`)&&x.size>0&&S({kind:`deploy`,unitIds:x.list()}),t&&b.wasPressed(`KeyT`)&&S({kind:`unlockTier2`}),t&&(b.wasPressed(`KeyF`)||b.wasPressed(`KeyG`))){let t=e.army.units.find(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).producesUnits&&t.deployed&&t.deployTimer===0),n=e.playerFaction===`machines`?`machine-infantry`:`ancient-infantry`,i=e.playerFaction===`machines`?`machine-construct`:`ancient-support`;t?S({kind:`produce`,producer:{kind:`unit`,id:t.id},typeId:b.wasPressed(`KeyG`)?i:n}):P(`NO DEPLOYED FACTORY`,r)}if(t&&b.wasPressed(`KeyV`)){let t=x.primary()===void 0?void 0:e.army.get(x.primary());t&&e.army.typeOf(t).canDeploy&&S({kind:`deploy`,unitIds:[t.id]})}if(b.wasPressed(`F5`)&&o&&e.outcome)P(`MATCH OVER · NOT SAVED`,r);else if(b.wasPressed(`F5`)&&o){let t=Sc(e);P(`SAVING`,r),o.put(t,Date.now()).then(()=>{P(`SAVED · STEP ${t.tick}`,performance.now()),ue=`step ${t.tick}`}).catch(e=>{console.error(`save failed`,e),P(`SAVE FAILED`,performance.now())})}b.wasPressed(`F9`)&&s()}if(t.domElement.style.cursor=L?`crosshair`:I?`copy`:``,b.dragRect&&!pe){let e=b.dragRect;a.style.display=`block`,a.style.left=`${(e.x0+1)/2*100}%`,a.style.top=`${(1-e.y1)/2*100}%`,a.style.width=`${(e.x1-e.x0)/2*100}%`,a.style.height=`${(e.y1-e.y0)/2*100}%`}else a.style.display=`none`;b.consume();let l=performance.now(),u=m.advance(pe?0:i*(Tm[ae]??1)),p=e.drainChangedBuildings();if(p.length>0)if(H=performance.now()-l,Re=!0,p.length>8)h.city.refreshAll();else for(let e of p)h.city.refresh(e);xe();let g=e.drainEvents();e.outcome&&!he&&ge(e.outcome);let _=g.some(e=>e.kind===`combatHit`||e.kind===`unitDown`);h.combat.sync(g,r),h.units.syncDefeats(g,r);for(let t of g){if(t.kind===`playerFactionChanged`){Se();continue}let n=`faction`in t?t.faction:void 0;if(t.kind!==`matchResolved`&&n!==void 0&&n!==e.playerFaction)continue;let i=Am(t);i&&(P(i,r),jm.has(t.kind)&&(ce=i,le=r+wm))}x.prune(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});let v=x.list(),ne=`${F??``}|${v.join(`,`)}`,oe=ne!==Le;Le=ne;let z=y.camera,fe=de||Math.abs(z.position.x-W)>.01||Math.abs(z.position.y-G)>.01||Math.abs(z.position.z-K)>.01;de=!1,W=z.position.x,G=z.position.y,K=z.position.z;let B=e.tick!==U;U=e.tick;let _e=p.length>0||B&&e.army.units.some(gs),ve=Ee(b.pointer);h.units.sync(e.army,u,t=>{let n=e.army.get(t);if(t===ve)return`attack`;if((x.has(t)||t===F)&&n)return`selected`},e=>h.combat.meleePose(e,r),r),k.sync({army:e.army,camera:z,nowMs:r,cameraDirty:fe,stateDirty:_,selectionDirty:oe,selectedIds:v,inspectedEnemyId:F}),(B||p.length>0)&&h.shadows.sync(e.city,e.army),j.sync(e.crowds.all,u,e.tick,e.army);let ye=v.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),be=ye.flatMap(t=>{let n=e.army.get(t);return n?[n]:[]});O.setSelectionEnabled(!1),O.sync({camera:z,zoomFraction:y.zoomFraction,nowMs:r,cameraDirty:fe,populationDirty:_e}),ee.sync(be,e.crowds.all,u,_e,p.length>0);let Ce=ye.length>0?Te(b.pointer):void 0;A.sync(e.tick,ye.length>0,Ce);let Me=I?kl(y.camera,b.pointer):void 0,He=I!==null&&Me!==void 0&&e.constructionPlacement(I.builderId,I.structureTypeId,Me.x,Me.z)!==void 0;if(M.sync(I&&Me?{structureTypeId:I.structureTypeId,x:Me.x,z:Me.z}:void 0,He,e.constructionSites,r),h.updateShadowCoverage(y.focus,y.zoomFraction),h.city.setOutlineZoom(y.zoomFraction),h.units.setOutlineZoom(y.zoomFraction),h.unitOcclusion.captureOccluderDepth(t,h.scene,y.camera),n.render(h.scene,y.camera),h.unitOcclusion.render(t,y.camera),h.selectionSilhouette.render(t,y.camera,A.selectionSource()),F!==null&&e.army.get(F)===void 0&&(F=null),ie+=i,ie>=Cm){ie=0,N!==null&&r>te&&(N=null),ce!==null&&r>le&&(ce=null),re.render(Uu({world:e,selected:x.size,banner:N})),R.render(qu(e,x,F===null?void 0:e.army.get(F)));let t=x.primary()===void 0?void 0:e.army.get(x.primary());se.render(Yu(e,t,ce))}if(V+=i,V>=1e3&&(Ae=(m.stepCount-ke)/V*1e3,ke=m.stepCount,V=0),E.add(e.tick,e.resources.humans),D.add(e.tick,e.resources.charge),je+=i,je>=xm){if(je=0,Re){Re=!1;let t=e.city.startAnchors[0];if(t){let n={x:y.focus.x,z:y.focus.z},r=e.nav.onShardCells,i=e.nav.flood(t.x,t.z,`small`,n),a=e.nav.flood(t.x,t.z,`large`,n);Ne=i.count/r,Pe=a.count/r,Fe=i.reachedTarget,Ie=a.reachedTarget}}let[n,r,i]=e.destructionCounts();C.render({faction:wo[e.playerFaction].name,battlefield:e.battlefield,seed:e.seed,fps:w.fps,simHz:Ae,stepCount:e.tick,droppedMs:m.droppedMs,alpha:u,zoomFraction:y.zoomFraction,pitchDeg:y.pitchDeg,distance:y.camera.position.distanceTo(y.focus),focusX:y.focus.x,focusZ:y.focus.z,cityBuildings:e.city.buildings.length,cityIntact:n??0,cityDamaged:r??0,cityRubble:i??0,populationLabels:O.enabled,units:e.army.units.length,unitsMoving:e.army.countMoving(),unitsBlocked:e.army.countBlocked(),unitsUnreached:e.army.countUnreached(),unitsStalled:e.army.countStalled(),selected:x.size,groups:x.occupiedGroups(),pathsQueued:e.army.pending,pathsTotal:e.army.pathsTotal,navCells:e.nav.cellCount,navRebuilds:e.nav.rebuildCount,navLastRebuildCells:e.nav.lastRebuildCells,navRebuildMs:H,smallPassable:e.nav.passableFraction(`small`),largePassable:e.nav.passableFraction(`large`),reachSmall:Ne,reachLarge:Pe,atFocusSmall:Fe,atFocusLarge:Ie,humans:e.resources.humans,humansCap:e.resources.humansCap,charge:e.resources.charge,chargeCap:e.resources.chargeCap,chargeSegments:e.resources.segmentsReady,techTier:e.techTier,humansPerMinute:E.perMinute,chargePerMinute:D.perMinute,cargoInTransit:e.cargoInTransit(),populationRemaining:e.remainingPopulation(),populationTotal:e.populationCapacity.reduce((e,t)=>e+t,0),structures:e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).role===`structure`).length,queued:e.queuedProduction(),civilianCrowds:e.crowds.all.length,civilianHumans:e.crowds.totalHumans(),harvesting:e.army.units.filter(gs).length,harvestIdle:e.harvestersIdle(),unitsDeployed:e.army.countDeployed(),unitsDeploying:e.army.countDeploying(),...T?{detailed:{drawCalls:t.info.render.calls,triangles:t.info.render.triangles,units:h.units.detailedPerformanceStats()??{loadedModels:0,loadingModels:0,failedModels:0,fallbacks:0,visible:0,selection:0,occlusion:0}}}:{}},w)}ze=requestAnimationFrame(Ve)};return ze=requestAnimationFrame(Ve),{dispose(){Be=!0,cancelAnimationFrame(ze),window.removeEventListener(`resize`,Ce),b.dispose(),_e.remove(),ve.remove(),he?.dispose(),re.dispose(),R.dispose(),se.dispose(),B(),h.dispose(),T&&(t.info.autoReset=!0),O.dispose(),ee.dispose(),k.dispose(),A.dispose(),j.dispose(),M.dispose(),a.style.display=`none`}}}async function Nm(){let e=window.location.pathname.endsWith(`/battle.html`),t=document.getElementById(`overlay`),n=document.getElementById(`overlay-content`),r=document.getElementById(`overlay-toggle`),i=document.getElementById(`selectbox`);if(!t||!n||!(r instanceof HTMLButtonElement)||!i)throw Error(`overlay controls or #selectbox missing from the page shell`);r.addEventListener(`click`,()=>{let e=t.classList.toggle(`minimized`);r.textContent=e?`+`:`−`,r.title=e?`Restore developer panel`:`Minimize developer panel`,r.setAttribute(`aria-expanded`,String(!e))});let a=new Ei({antialias:!0,powerPreference:`high-performance`});a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.shadowMap.enabled=!0,a.shadowMap.type=1,a.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(a.domElement);let o=new Di(a,{defaultThickness:.0022,defaultColor:[0,0,0],defaultAlpha:.68}),s=Ac.available?new Ac:null;s||console.warn(`IndexedDB unavailable; saving is disabled for this session`);let c=mm(),l=ym(window.location.search),u={standardMatch:!0,...l?{controllers:l}:{}},d=new URLSearchParams(window.location.search),f=d.get(`detailedPerf`)===`1`,p=d.get(`stress`)===`detailed`;ct(`machines`,c.colourVariant.machines),ct(`ancients`,c.colourVariant.ancients);let m=()=>{t.style.display=c.overlayVisible?``:`none`};m();let h=null,g=null,_=e=>{g?.dispose(),g=e},v=e=>{_(null),h?.dispose(),a.shadowMap.enabled=c.enhancedShadows,h=Mm({world:e,renderer:a,toonEffect:o,renderSettings:c,overlayEl:n,boxEl:i,store:s,onLoadRequested:y,onSeedStepRequested:t=>{let n=e.seed+t>>>0;queueMicrotask(()=>v(e.battlefield?new bc(n,e.playerFaction,{battlefield:!0,...u,...p?{battlefieldUnitsPerType:8}:{}}):new bc(n,e.playerFaction,u)))},onExitToTitle:()=>{h?.dispose(),h=null,b()},onPlayAgainRequested:()=>{queueMicrotask(()=>v(e.battlefield?new bc(e.seed,e.playerFaction,{battlefield:!0,...u,...p?{battlefieldUnitsPerType:8}:{}}):new bc(e.seed,e.playerFaction,u)))},onPlayerFactionCycleRequested:()=>{let t=e.playerFaction===`machines`?`ancients`:`machines`;e.enqueue(`debug`,{kind:`setPlayerFaction`,faction:t})},diagnosticsEnabled:()=>c.overlayVisible,detailedPerformance:f})},y=e=>{s&&s.get(e).then(e=>{if(!e){console.warn(s.lastRejection??`no save to load`);return}v(Cc(e.envelope))}).catch(e=>console.error(`load failed`,e))},b=async()=>{let e=s?await s.get().catch(()=>void 0):void 0,t=s?await s.list().catch(()=>[]):[];_(new ed(document.body,{saved:e&&{faction:e.envelope.playerFaction,tick:e.envelope.tick,clock:Vu(e.envelope.tick)},slotCount:t.length,onStart:e=>v(new bc(bm,e,u)),onResume:()=>y(),onSelectSave:()=>void S(),onSettings:()=>x()}))},x=()=>{_(new ud(document.body,c,{onColourVariant:(e,t)=>{c.colourVariant[e]=t,ct(e,t),hm(c),x()},onToggleOverlay:e=>{c.overlayVisible=e,hm(c),m(),x()},onToggleCityLighting:e=>{c.cityLighting=e,hm(c),x()},onToggleEnhancedShadows:e=>{c.enhancedShadows=e,a.shadowMap.enabled=e,hm(c),x()},onToggleAmbientOcclusion:e=>{c.ambientOcclusion=e,hm(c),x()},onModelMode:e=>{c.modelMode=e,hm(c),x()},onBack:()=>void b()}))},S=async()=>{let e=s?await s.list().catch(()=>[]):[];_(new dd(document.body,e.map(e=>({slot:e.slot,faction:e.readable?e.envelope.playerFaction:void 0,clock:Vu(e.envelope.tick??0),tick:e.envelope.tick??0,savedAtMs:e.savedAtMs,readable:e.readable})),{onLoad:e=>y(e),onDelete:e=>{s&&s.delete(e).then(()=>S()).catch(e=>console.error(`delete failed`,e))},onBack:()=>void b()}))},C=new URLSearchParams(window.location.search).get(`faction`);if(e){v(new bc(bm,C===`ancients`?`ancients`:`machines`,{battlefield:!0,...u,...p?{battlefieldUnitsPerType:8}:{}}));return}if(C===`machines`||C===`ancients`){v(new bc(bm,C,u));return}await b()}Nm();
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <path d="M15 6 L23 13 L15 24 L7 13 Z" fill="#f0f070" stroke="var(--outline)"
        stroke-width="1.6"/>`}}},dp=1920,fp=5,pp=4,mp=30,hp=class{onCommand;root;onResize;skin;humansTrough;meterTroughs;divider;clockEl;alertEl;bannerEl;buttons=new Map;lastClock=``;lastBanner=null;lastAlert=null;constructor(e,t,n){this.onCommand=n,this.skin=up[t.faction],kp(),this.root=_p(`div`,`hud`),this.root.dataset.faction=t.faction,this.root.style.setProperty(`--line`,this.skin.line),this.root.style.setProperty(`--chrome`,this.skin.chrome),this.root.style.setProperty(`--plate`,this.skin.plate),this.root.style.setProperty(`--on-plate`,this.skin.onPlate),this.root.style.setProperty(`--pip-on`,this.skin.pipOn),this.root.style.setProperty(`--pip-gap`,this.skin.pipGap),this.root.style.setProperty(`--pip-off`,this.skin.pipOff),this.root.style.setProperty(`--pip-off-gap`,this.skin.pipOffGap),this.root.style.setProperty(`--accent`,this.skin.accent),this.root.style.setProperty(`--label`,this.skin.label),this.root.style.setProperty(`--warn`,this.skin.warn),this.root.style.setProperty(`--go`,this.skin.go),this.root.style.setProperty(`--icon-stroke`,this.skin.outline??`transparent`),this.root.style.setProperty(`--hud-font`,this.skin.font),this.root.style.setProperty(`--band`,this.skin.band),this.root.style.setProperty(`--on-band`,this.skin.onBand),this.root.style.setProperty(`--rail`,`${this.skin.railPx}px`),this.root.style.setProperty(`--divider`,this.skin.divider),this.root.style.setProperty(`--radius`,this.skin.radius),this.root.style.setProperty(`--outline`,this.skin.outline??this.skin.line),this.root.style.setProperty(`--chamfer`,this.skin.chamferPx>0?`polygon(${this.skin.chamferPx}px 0, calc(100% - ${this.skin.chamferPx}px) 0, 100% 100%, 0 100%)`:`none`);let r=_p(`div`,`hud-band`);r.append(Sp(this.skin,`left`));let i=_p(`div`,`hud-meters`),a=_p(`div`,`hud-meter`);a.append(vp(`HUMANS`)),this.humansTrough=yp(t.humans.trough.pips),a.append(this.humansTrough.el),i.append(a);let o=_p(`div`,`hud-meter`);o.append(vp(t.meter.label)),this.divider=_p(`div`,`hud-divider`);let s=[];t.meter.troughs.forEach((e,t)=>{t>0&&o.append(this.divider);let n=yp(e.pips);s.push(n),o.append(n.el)}),this.meterTroughs=s,i.append(o),r.append(i,Sp(this.skin,`right`)),this.root.append(r);let c=_p(`div`,`hud-island`);c.append(Cp(wp())),this.alertEl=Cp(Tp()),this.alertEl.classList.add(`hud-alert`),c.append(this.alertEl),this.clockEl=_p(`div`,`hud-time`),c.append(this.clockEl),this.root.append(c),this.bannerEl=_p(`div`,`hud-banner`),this.root.append(this.bannerEl);let l=_p(`div`,`hud-column`),u=_p(`div`,`hud-collapse`);u.append(xp(this.skin.badge)),l.append(u,_p(`div`,`hud-spine`));let d=_p(`div`,`hud-cluster`);for(let e of t.commands){let t=document.createElement(`button`);t.className=`hud-button`,t.type=`button`,t.title=e.label,t.setAttribute(`aria-label`,e.label),t.innerHTML=Ep(e.id,this.skin),t.addEventListener(`click`,()=>this.onCommand(e.id)),this.buttons.set(e.id,t),d.append(t)}l.append(d),this.root.append(l),e.append(this.root),this.rescale(),this.onResize=()=>this.rescale(),window.addEventListener(`resize`,this.onResize),this.render(t)}dispose(){window.removeEventListener(`resize`,this.onResize),this.root.remove()}rescale(){let e=Math.max(.7,Math.min(1,window.innerWidth/dp));this.root.style.setProperty(`--hud-scale`,String(e))}render(e){gp(this.humansTrough,e.humans.trough),e.meter.troughs.forEach((e,t)=>{let n=this.meterTroughs[t];n&&gp(n,e)}),this.divider.classList.toggle(`lit`,e.meter.dividerLit),e.clock!==this.lastClock&&(this.clockEl.textContent=e.clock,this.lastClock=e.clock),e.alert!==this.lastAlert&&(this.alertEl.classList.toggle(`on`,e.alert),this.lastAlert=e.alert),e.banner!==this.lastBanner&&(this.bannerEl.textContent=e.banner??``,this.bannerEl.classList.toggle(`shown`,e.banner!==null),this.lastBanner=e.banner);for(let t of e.commands){let e=this.buttons.get(t.id);e&&(e.disabled=!t.enabled)}}};function gp(e,t){e.pips.forEach((e,n)=>{let r=n<t.filled;e.classList.toggle(`on`,r),e.classList.toggle(`accent`,r&&t.accent)})}function _p(e,t){let n=document.createElement(e);return n.className=t,n}function vp(e){let t=_p(`div`,`hud-label`);return t.textContent=e,t}function yp(e){let t=_p(`div`,`hud-trough`),n=[];for(let r=0;r<e;r++){let e=_p(`i`,`hud-pip`);n.push(e),t.append(e)}return{el:t,pips:n}}function bp(e,t,n){let r=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return r.setAttribute(`viewBox`,`0 0 ${e} ${t}`),r.setAttribute(`width`,String(e)),r.setAttribute(`height`,String(t)),r.innerHTML=n,r}function xp(e){return bp(e.width,e.height,e.inner)}function Sp(e,t){let n=xp(e.cap);return n.classList.add(`hud-cap`,t),n}function Cp(e){let t=_p(`div`,`hud-plate`);return t.append(e),t}function wp(){return bp(22,22,`<circle cx="11" cy="11" r="8" fill="none" stroke="var(--on-plate)" stroke-width="2"/>
     <path d="M11 11 V5 A6 6 0 0 1 17 11 Z" fill="var(--on-plate)"/>`)}function Tp(){return bp(22,22,`<rect x="9" y="4" width="4" height="9" rx="1.4" fill="currentColor"/>
     <rect x="8.5" y="15" width="5" height="3.2" rx="1" fill="currentColor"/>`)}function Ep(e,t){switch(e){case`primary`:return`<svg viewBox="0 0 ${t.primaryIcon.width} ${t.primaryIcon.height}"
        width="${mp}" height="${mp}">${t.primaryIcon.inner}</svg>`;case`regroup`:return Dp(`M12 11 L8.5 6.5 H10.8 V3 H13.2 V6.5 H15.5 Z`,`var(--warn)`,45);case`scatter`:return Dp(`M12 3 L15.5 7.5 H13.2 V11 H10.8 V7.5 H8.5 Z`,`var(--go)`,0);case`cancel`:return`<svg viewBox="0 0 24 24" width="${mp}" height="${mp}">
      ...
      </svg>`}}function Dp(e,t,n){return`<svg viewBox="0 0 24 24" width="${mp}" height="${mp}">
  ...
  </svg>`}var Op=!1;function kp(){if(Op)return;Op=!0;let e=document.createElement(`style`);e.textContent=Ap,document.head.append(e)}var Ap=`
.hud {
  --hud-scale: 1;
  position: fixed;
  inset: 0;
...
`;function jp(e,t,n){if(!(t>0)||n<=0||e<=0)return 0;if(e>=t)return n;let r=Math.floor(e/t*n);return Math.min(Math.max(r,1),n-1)}function Mp(e){let t=Math.floor(e/30),n=Math.floor(t/60),r=t%60;return`${n}:${String(r).padStart(2,`0`)}`}function Np(e){let{segments:t,pipsPerSegment:n}=gf,r=[];for(let i=0;i<t;i++){let t=e-i*n;r.push({pips:n,filled:Math.min(Math.max(Math.floor(t),0),n),accent:i>0})}return r}function Pp({world:e,selected:t,banner:n}){let r=_f[e.playerFaction],{humans:i,humansCap:a,charge:o,chargeCap:s}=e.resources,c=t>0;return{faction:r.id,factionName:r.name,humans:{value:i,cap:a,trough:{pips:gf.humansPips,filled:jp(i,a,gf.humansPips),accent:!1}},meter:{label:r.meterLabel,value:o,cap:s,segmentsReady:e.resources.segmentsReady,troughs:Np(o),dividerLit:o>gf.pipsPerSegment},clock:Mp(e.tick),alert:e.army.countBlocked()>0,selected:t,commands:[{id:`primary`,label:r.primaryOrder,enabled:r.id===`machines`&&c},{id:`regroup`,label:`Regroup — unresolved reading`,enabled:!1},{id:`scatter`,label:`Scatter — unresolved reading`,enabled:!1},{id:`cancel`,label:`Stop`,enabled:c}],banner:n}}var Fp={machines:`Harvesters carry humans back to a Processing Node. Income arrives in spikes, and every route matters.`,ancients:`Harvesters consume humans where they stand. Income is continuous, and it rewards pressing forward.`},Ip={machines:`Banks ENERGY for Harbinger superpowers.`,ancients:`Banks INSANITY for Harbinger superpowers.`},Lp=class{root;constructor(e,t){Bp(),this.root=document.createElement(`div`),this.root.className=`menu`;let n=document.createElement(`div`);n.className=`menu-skyline`,n.innerHTML=Rp(),this.root.append(n);let r=document.createElement(`div`);r.className=`menu-panel`;let i=document.createElement(`h1`);i.className=`menu-title`,i.textContent=`HUMAN RESOURCES`,r.append(i);let a=document.createElement(`p`);a.className=`menu-tagline`,a.textContent=`Choose your apocalypse`,r.append(a);let o=document.createElement(`div`);o.className=`menu-cards`;for(let e of[`machines`,`ancients`])o.append(this.buildCard(e,t.onStart));if(r.append(o),t.saved){let e=document.createElement(`button`);e.className=`menu-resume`,e.type=`button`,e.textContent=`Resume — ${_f[t.saved.faction].name} at ${t.saved.clock}`,e.addEventListener(`click`,()=>t.onResume()),r.append(e)}else{let e=document.createElement(`p`);e.className=`menu-note`,e.textContent=`No saved match`,r.append(e)}this.root.append(r),e.append(this.root)}buildCard(e,t){let n=_f[e],r=up[e],i=document.createElement(`button`);i.className=`menu-card`,i.type=`button`,i.dataset.faction=e,i.style.setProperty(`--card-line`,r.line),i.style.setProperty(`--card-ink`,r.label),i.style.setProperty(`--card-font`,r.font);let a=document.createElement(`span`);a.className=`menu-card-name`,a.textContent=n.name;let o=document.createElement(`span`);o.className=`menu-card-copy`,o.textContent=Fp[e];let s=document.createElement(`span`);return s.className=`menu-card-meter`,s.textContent=Ip[e],i.append(a,o,s),i.addEventListener(`click`,()=>t(e)),i}dispose(){this.root.remove()}};function Rp(){let e=[34,52,41,68,47,82,58,39,71,50,88,44,63,36,76,55,42,66,48,80],t=100/e.length;return`<svg viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
    <g fill="#160b04">${e.map((e,n)=>`<rect x="${n*t}" y="${100-e}" width="${t+.3}" height="${e}"/>`).join(``)}</g>
  </svg>`}var zp=!1;function Bp(){if(zp)return;zp=!0;let e=document.createElement(`style`);e.textContent=Vp,document.head.append(e)}var Vp=`
.menu {
  position: fixed;
  inset: 0;
  z-index: 40;
...
.population-label {
...
}`,document.head.append(e)}var Yp=[8944022,15239272],Xp={machines:0,ancients:1},Zp={machines:15398636,ancients:14467232},Qp={machines:6865096,ancients:15786104};function $p(e){return Yp[Xp[e]]??Yp[0]}function em(e){return Zp[e]}function tm(e){return Qp[e]}var nm=.6,rm=1.8,im=2696995,am=Nu+rm/2;function om(){return new vi(nm,rm,nm)}function sm(){return new Ya({color:im,flatShading:!0})}var cm=8,lm=96,um=class{city;army;population;capacity;group=new xn;highlights;civilians;tooltip;matrix=new Kt;point=new K;colour=new Y;scale=new K;constructor(e,t,n,r,i,a){this.city=t,this.army=n,this.population=r,this.capacity=i;let o=a===`machines`?$p(`machines`):16754176;this.highlights=new ai(new vi(1,1,1),new Ya({color:o,flatShading:!0,transparent:!0,opacity:.2,depthWrite:!1}),t.buildings.length),this.highlights.frustumCulled=!1,this.highlights.renderOrder=7,this.group.add(this.highlights),this.civilians=new ai(om(),sm(),lm),this.civilians.frustumCulled=!1,this.group.add(this.civilians),fm(),this.tooltip=document.createElement(`div`),this.tooltip.className=`harvest-tooltip`,e.append(this.tooltip)}sync(e,t,n,r){let i=new Set;for(let e of this.army.units)e.harvestingBuildingId!==null&&i.add(e.harvestingBuildingId);let a=0;if(n)for(let e of this.city.buildings){if(!Bd(e,this.population))continue;let t=i.has(e.id)||r===e.id,n=e.state===`damaged`?e.height*.55:e.height;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(e.width+(t?3:1.5),n+2,e.depth+(t?3:1.5)),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,n/2+.8,e.z),this.highlights.setMatrixAt(a,this.matrix),this.colour.setHex(t?16777215:12105912),this.highlights.setColorAt(a,this.colour),a++}for(let e=a;e<this.highlights.count;e++)this.highlights.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.highlights.instanceMatrix.needsUpdate=!0,this.highlights.instanceColor&&(this.highlights.instanceColor.needsUpdate=!0);let o=0;for(let e of this.army.units){let n=e.harvestingBuildingId,r=n===null?void 0:this.city.get(n);if(!Bd(r,this.population)||Vd(e.x,e.z,r)>22**2)continue;let i=e.x-r.x,a=e.z-r.z,s=Math.max(Math.hypot(i,a),1),c=hu({x:i/s,z:a/s},-(r.rotation??0)),l=Math.min(Math.abs(c.x)>.001?r.width/2/Math.abs(c.x):1/0,Math.abs(c.z)>.001?r.depth/2/Math.abs(c.z):1/0),u=r.x+i/s*l,d=r.z+a/s*l;for(let n=0;n<cm&&o<lm;n++){let r=(t+n*5+e.id*11)%30/30,c=(n%3-1)*1.7,l=u+(e.x-u)*r-a/s*c,f=d+(e.z-d)*r+i/s*c;this.matrix.makeTranslation(l,am,f),this.civilians.setMatrixAt(o++,this.matrix)}}for(let e=o;e<this.civilians.count;e++)this.civilians.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.civilians.instanceMatrix.needsUpdate=!0;let s=r===void 0?void 0:this.city.get(r),c=Bd(s,this.population)?s:void 0;if(this.tooltip.classList.toggle(`shown`,n&&c!==void 0),n&&c){let t=Math.ceil(this.population[c.id]??0),n=this.capacity[c.id]??0;this.tooltip.textContent=n<=0?`HUMANS  NONE`:t>0?`HUMANS  ${t}/${n}`:`HUMANS  DEPLETED · 0/${n}`,this.point.set(c.x,c.height+6,c.z).project(e),this.tooltip.style.left=`${(this.point.x*.5+.5)*100}%`,this.tooltip.style.top=`${(-this.point.y*.5+.5)*100}%`}}dispose(){this.highlights.geometry.dispose(),this.civilians.geometry.dispose(),this.highlights.material.dispose(),this.civilians.material.dispose(),this.tooltip.remove()}},dm=!1;function fm(){if(dm)return;dm=!0;let e=document.createElement(`style`);e.textContent=`.harvest-tooltip {
  ...
  }.harvest-tooltip.shown { display: block; }`,document.head.append(e)}var pm=2,mm=32,hm=640,gm=5,_m=1.6,vm=8,ym=class{group=new xn;figures;matrix=new Kt;constructor(){this.figures=new ai(om(),sm(),hm),this.figures.frustumCulled=!1,this.group.add(this.figures)}sync(e,t,n,r){let i=0;for(let a of e){let e=a.prevX+(a.x-a.prevX)*t,o=a.prevZ+(a.z-a.prevZ)*t,s=a.trailDirX,c=a.trailDirZ,l=Math.min(Math.max(1,Math.ceil(a.humans/pm)),mm),u=2.4+Math.sqrt(l)*1.5,d=r.units.filter(e=>e.harvestingCrowdId===a.id&&zd(e.x,e.z,a.x,a.z)<=22**2),f=Math.min(l,d.length*vm);for(let r=0;r<l&&!(i>=hm);r++){let l=(bm(a.id*31+r*7+1)*2-1)*u,p=(bm(a.id*17+r*13+2)*2-1)*u,m=r%gm*_m*a.trailStrength,h=e+l-s*m,g=o+p-c*m;if(r<f){let e=d[r%d.length],i=e.prevX+(e.x-e.prevX)*t,a=e.prevZ+(e.z-e.prevZ)*t,o=(n+r*5+e.id*11)%30/30;this.matrix.makeTranslation(h+(i-h)*o,am,g+(a-g)*o)}else this.matrix.makeTranslation(h,am,g);this.figures.setMatrixAt(i++,this.matrix)}if(i>=hm)break}for(let e=i;e<this.figures.count;e++)this.figures.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.figures.instanceMatrix.needsUpdate=!0}dispose(){this.figures.geometry.dispose(),this.figures.material.dispose()}};function bm(e){let t=Math.sin(e*127.1)*43758.5453;return t-Math.floor(t)}function Q(e,t,n=0){let r=[];for(let i=0;i<e;i++){let a=n+i/e*Math.PI*2;r.push([Math.cos(a)*t,Math.sin(a)*t])}return r}function xm(e,t=0){return Q(6,e,t)}function Sm(e,t){let n=e/2,r=t/2;return[[n,r],[-n,r],[-n,-r],[n,-r]]}function $(e,t,n){let r=e/2,i=t/2,a=Math.min(n,Math.min(r,i)*.9);return[[r,i-a],[r-a,i],[-(r-a),i],[-r,i-a],[-r,-(i-a)],[-(r-a),-i],[r-a,-i],[r,-(i-a)]]}function Cm(e){let t=[],n=new Kt,r=new Kt,i=new K,a=new K,o=new K,s=new K,c=new K;for(let l of e){let e=l.profile.length;if(e<3)continue;let u=l.taper??1,d=l.pivot??`base`,f=d===`base`?0:d===`centre`?-l.height/2:-l.height,p=f+l.height,m=l.shearX??0,h=l.shearZ??0;n.makeRotationY(l.rotY??0),l.tilt&&n.multiply(r.makeRotationX(l.tilt)),l.roll&&n.multiply(r.makeRotationZ(l.roll)),n.setPosition(l.x,l.y,l.z);let g=[],_=[];i.set(0,0,0);for(let e of l.profile){let t=e[0],r=e[1];g.push(new K(t,f,r).applyMatrix4(n)),_.push(new K(t*u+m,p,r*u+h).applyMatrix4(n))}for(let e of g)i.add(e);for(let e of _)i.add(e);i.multiplyScalar(1/(e*2));let v=(e,n,r)=>{a.subVectors(n,e),o.subVectors(r,e),s.crossVectors(a,o),c.copy(e).add(n).add(r).multiplyScalar(1/3).sub(i);let[l,u]=s.dot(c)<0?[r,n]:[n,r];t.push(e.x,e.y,e.z,l.x,l.y,l.z,u.x,u.y,u.z)};for(let t=1;t<e-1;t++){let e=g[0],n=g[t],r=g[t+1],i=_[0],a=_[t],o=_[t+1];e&&n&&r&&v(e,n,r),i&&a&&o&&v(i,a,o)}for(let t=0;t<e;t++){let n=(t+1)%e,r=g[t],i=g[n],a=_[t],o=_[n];!r||!i||!a||!o||(v(r,i,o),v(r,o,a))}}let l=new wr;return l.setAttribute(`position`,new lr(new Float32Array(t),3)),l.computeVertexNormals(),l}var wm=-Math.PI/2,Tm=(e,t,n=9)=>Q(n,1).map(([n,r])=>[n*e,r*t]);function Em(e,t){let n=e,r=t,i=[],a=[];i.push({profile:Tm(n*.18,n*.18),height:n*.72,x:0,y:r*.48,z:0,roll:wm}),i.push({profile:Tm(n*.16,n*.14),height:n*.28,x:n*.42,y:r*.58,z:0,roll:wm});for(let e of[-1,1])i.push({profile:$(n*.08,n*.9,n*.02),height:n*.42,taper:.55,x:n*.02,y:r*.6,z:e*n*.36,roll:-Math.PI/2,rotY:e*-.3});i.push({profile:Q(5,n*.06),height:n*.72,taper:.15,x:-n*.48,y:r*.5,z:0,roll:wm});for(let e of[-n*.16,n*.16])a.push({profile:Q(6,n*.055),height:n*.03,x:n*.5,y:r*.6,z:e,roll:wm});return{parts:i,accents:a}}function Dm(e,t){let n=e,r=t,i=[],a=[],o=[],s=-Math.PI/2,c=(e,t=0)=>({roll:s+t,rotY:-e}),l=(e,t)=>Sm(e*2,t*2),u=(e,t,n=9)=>Q(n,1).map(([n,r])=>[n*e,r*t]),d=(e,t,n,r,i=6,a=1)=>{let o=Math.hypot(t.x-e.x,t.z-e.z),s=t.y-e.y;return{profile:Q(i,n),height:Math.hypot(o,s)*a,taper:r/n,x:e.x,y:e.y,z:e.z,...c(Math.atan2(t.z-e.z,t.x-e.x),Math.atan2(s,o))}},f=(e,t)=>({x:e.x,y:e.y,z:t*e.z}),p=[{x:n*.11,base:r*.6,top:r*.839,halfLength:n*.17,halfWidth:n*.26},{x:-n*.06,base:r*.489,top:r*.828,halfLength:n*.18,halfWidth:n*.324},{x:-n*.24,base:r*.344,top:r*.794,halfLength:n*.18,halfWidth:n*.34},{x:-n*.41,base:r*.233,top:r*.7,halfLength:n*.17,halfWidth:n*.31},{x:-n*.55,base:r*.144,top:r*.544,halfLength:n*.13,halfWidth:n*.24}];for(let e of p)i.push({profile:u(e.halfLength,e.halfWidth),height:e.top-e.base,taper:.66,x:e.x,y:e.base,z:0});let m=e=>{let t=p[0],n=p[p.length-1];if(!t||!n)return r*.8;if(e>=t.x)return t.top;if(e<=n.x)return n.top;for(let t=0;t<p.length-1;t++){let n=p[t],r=p[t+1];if(!n||!r||e>n.x||e<r.x)continue;let i=(n.x-e)/(n.x-r.x);return n.top+(r.top-n.top)*i}return n.top},h=n*.22,g=n*.36,_=[[r*.144,.3,n*.03],[r*.211,.58,n*.08],[r*.3,.84,n*.14],[r*.383,.98,n*.17],[r*.467,1,n*.19],[r*.544,.86,n*.215],[r*.628,.68,n*.235],[r*.706,.55,n*.25]];for(let e=0;e<_.length-1;e++){let t=_[e],n=_[e+1];!t||!n||a.push({profile:u(h*t[1],g*t[1]),height:n[0]-t[0],taper:n[1]/t[1],shearX:n[2]-t[2],x:t[2],y:t[0],z:0})}let v=r*.783,y=r*.689;i.push({profile:$(n*.3,n*.54,n*.07),height:r*.139,taper:.74,x:n*.21,y:r*.811,z:0}),i.push({profile:$(n*.24,n*.46,n*.06),height:r*.1,taper:.88,shearX:-n*.05,x:n*.3,y:v,z:0}),i.push({profile:l(r*.018,n*.05),height:n*.16,taper:.25,x:n*.3,y:r*.933,z:0,...c(Math.PI,.55)}),i.push({profile:$(n*.19,n*.5,n*.05),height:r*.072,taper:.82,x:n*.27,y:r*.855,z:0});let b=n*.25,x=r*.878,S=(e,t)=>({x:b,y:x,z:e*t,...c(Math.PI/2*e)});for(let e of[1,-1])i.push({profile:Q(8,n*.105),height:n*.045,taper:.86,...S(e,n*.175)}),o.push({profile:Q(8,n*.05),height:n*.075,taper:1.7,...S(e,n*.2)}),o.push({profile:Q(8,n*.085),height:n*.075,taper:.53,...S(e,n*.275)}),i.push({profile:l(n*.013,n*.058),height:n*.022,...S(e,n*.338)});i.push({profile:$(n*.2,n*.44,n*.05),height:r*.05,taper:.9,x:n*.16,y:r*.639,z:0});let C=[[n*.33,n*.06,r*.069],[n*.3,n*.15,r*.06],[n*.24,n*.21,r*.044]],w=[[n*.3,n*.1,r*.044],[n*.24,n*.19,r*.033]];for(let e of[1,-1]){for(let[t,r,i]of C)a.push({profile:Q(3,n*.012),height:i,taper:2.8,pivot:`top`,x:t,y:v,z:e*r});for(let[t,i,o]of w)a.push({profile:Q(3,n*.03,Math.PI),height:o,taper:.3,x:t,y:y-r*.006,z:e*i})}let T=n*.03,E=.16,D=[{x:n*.15,sink:r*.06,rootZ:n*.19,length:n*.26,elevation:-.16,chord:n*.15,sweep:n*.06,chevron:0},{x:-n*.03,sink:r*.028,rootZ:n*.07,length:n*.376,reaches:r,elevation:1.25,chord:n*.15,sweep:n*.07,chevron:.5},{x:-n*.17,sink:r*.024,rootZ:n*.08,length:n*.37,elevation:1.18,chord:n*.15,sweep:n*.07,chevron:.52},{x:-n*.31,sink:r*.024,rootZ:n*.084,length:n*.35,elevation:1.12,chord:n*.14,sweep:n*.07,chevron:.52},{x:-n*.44,sink:r*.024,rootZ:n*.084,length:n*.35,elevation:1.05,chord:n*.13,sweep:n*.06,chevron:.5},{x:-n*.55,sink:r*.024,rootZ:n*.076,length:n*.32,elevation:.98,chord:n*.11,sweep:n*.06,chevron:.48}];for(let e of D){let t=m(e.x)-e.sink,n=e.reaches===void 0?e.length:(e.reaches-T*E*Math.cos(e.elevation)-t)/Math.sin(e.elevation);for(let r of[1,-1])i.push({profile:l(T,e.chord),height:n,taper:E,shearZ:r*e.sweep,x:e.x,y:t,z:r*e.rootZ,...c(Math.PI/2*r,e.elevation)});e.chevron!==0&&a.push({profile:Sm(e.chord*1.7,e.rootZ*1.5),height:n*e.chevron,taper:.14,shearX:-e.sweep,x:e.x,y:t-r*.004,z:0})}let O=[{x:-n*.49,y:r*.283,z:0},{x:-n*.64,y:r*.211,z:0},{x:-n*.75,y:r*.158,z:0},{x:-n*.81,y:r*.131,z:0}],k=[n*.19,n*.13,n*.07,n*.02];for(let e=0;e<O.length-1;e++){let t=O[e],r=O[e+1];!t||!r||i.push(d(t,r,k[e]??n*.1,k[e+1]??n*.05,6,e===O.length-2?1:1.12))}let A=[[-n*.65,r*.217,n*.05,n*.19],[-n*.74,r*.161,n*.036,n*.13]];for(let[e,t,o,s]of A){for(let r of[1,-1])i.push({profile:l(n*.018,n*.075),height:s,taper:.18,shearZ:r*n*.04,x:e,y:t,z:r*o,...c(Math.PI/2*r,.9)});a.push({profile:Sm(n*.16,o*2.3),height:s*.5,taper:.22,shearX:-n*.03,x:e,y:t+r*.004,z:0})}let j={x:-n*.05,y:r*.433,z:n*.31},M={x:-n*.01,y:r*.244,z:n*.28},N={x:-n*.07,y:r*.111,z:n*.264};for(let e of[1,-1]){i.push(d(f(j,e),f(M,e),n*.144,n*.124,7,1.1)),i.push(d(f(M,e),f(N,e),n*.124,n*.11,7,1.1)),i.push({profile:$(n*.35,n*.23,n*.05),height:r*.1,taper:.86,x:-n*.07,y:0,z:e*N.z});for(let t of[-1,0,1]){let i={x:n*.08,y:r*.038,z:e*(N.z+t*n*.085)},o={x:n*.28,y:r*.013,z:e*(N.z+t*n*.125)};a.push(d(i,o,n*.036,n*.012,4))}i.push({profile:Q(8,n*.062),height:n*.022,taper:.8,x:n*.03,y:r*.333,z:e*n*.3,...c(e*1)})}let P={x:-n*.15,y:r*.594,z:n*.37},F={x:n*.05,y:r*.433,z:n*.47},I={x:n*.23,y:r*.283,z:n*.52},ee=[[{x:n*.24,y:r*.267,z:n*.46},{x:n*.39,y:r*.172,z:n*.44}],[{x:n*.24,y:r*.267,z:n*.52},{x:n*.37,y:r*.161,z:n*.54}],[{x:n*.23,y:r*.267,z:n*.58},{x:n*.32,y:r*.167,z:n*.63}]];for(let e of[1,-1]){i.push(d(f(P,e),f(F,e),n*.13,n*.115,7,1.1)),i.push(d(f(F,e),f(I,e),n*.115,n*.095,7,1.08)),i.push({profile:$(n*.15,n*.19,n*.04),height:r*.045,taper:.9,pivot:`top`,x:n*.24,y:r*.29,z:e*I.z});for(let[t,r]of ee)a.push(d(f(t,e),f(r,e),n*.038,n*.012,4))}let te=n*.86,ne=e=>{let t=Math.hypot(e.x,e.z);if(t<=te)return e;let n=te/t;return{x:e.x*n,y:e.y,z:e.z*n}},re=[{x:n*.31,y:r*.761,z:n*.04},{x:n*.52,y:r*.765,z:n*.1},{x:n*.68,y:r*.717,z:n*.22},{x:n*.75,y:r*.622,z:n*.35},{x:n*.72,y:r*.539,z:n*.42},{x:n*.61,y:r*.478,z:n*.44},{x:n*.49,y:r*.45,z:n*.34}].map(ne),ie=[n*.065,n*.062,n*.058,n*.055,n*.05,n*.045,n*.034];for(let e=0;e<re.length-1;e++){let t=re[e],r=re[e+1];!t||!r||a.push(d(t,r,ie[e]??n*.04,ie[e+1]??n*.03,5,e===re.length-2?1:1.12))}let ae=re[4]??{x:0,y:r*.5,z:0},oe=n*.105;for(let e=0;e<7;e++){let t=e/7*Math.PI*2,r=Math.sin(e*1.7)*.55,i=ne({x:ae.x+Math.cos(t)*Math.cos(r)*oe,y:ae.y+Math.sin(r)*oe,z:ae.z+Math.sin(t)*Math.cos(r)*oe});a.push(d(ae,i,n*.042,n*.008,4))}return{parts:i,secondary:a,accents:o}}function Om(e,t){let n=e,r=t,i=[],a=[],o=[],s=(e,t,n=9)=>Q(n,1).map(([n,r])=>[n*e,r*t]),c=-Math.PI/2,l=Math.PI/10,u=e=>e*Math.cos(l),d=n*.39,f=d*.86,p=r*.145;for(let e=0;e<6;e++){let t=(e+.5)/6*Math.PI*2,n=Math.cos(t),r=Math.sin(t);a.push({profile:Q(7,d*.44),height:p*(e%2?.84:1),taper:.66,x:n*f,y:0,z:r*f,rotY:-t}),a.push({profile:Q(6,d*.28),height:p*.62,taper:.7,x:n*(f+d*.24),y:0,z:r*(f+d*.24),rotY:-t})}let m=r*.52,h=d*.5,g=[[r*.045,d*.68,!0],[r*.095,d*.85,!0],[r*.145,d*.94,!0],[r*.2,d*.99,!0],[r*.255,d,!0],[r*.315,d*.97,!0],[r*.365,d*.9,!1],[r*.415,d*.8,!1],[r*.455,d*.68,!1],[r*.49,d*.58,!1]];g.forEach(([e,t,n],r)=>{let o=g[r+1],s=o?o[0]:m,c=o?o[1]:h;(n?a:i).push({profile:Q(10,t,l),height:(s-e)*1.3,taper:c/t,x:0,y:e,z:0})}),i.push({profile:s(r*.105,d*.12),height:d*.2,x:u(d*.95),y:r*.2,z:0,roll:c});for(let e of[-1,1])i.push({profile:s(r*.128,d*.11),height:d*.2,x:u(d*.93),y:r*.232,z:e*d*.3,roll:c,tilt:-e*.52});for(let[e,t,n]of[[r*.25,d*.46,d*.12],[r*.25,-d*.46,d*.12],[r*.15,d*.32,d*.088],[r*.15,-d*.32,d*.088]])i.push({profile:Q(6,n),height:d*.13,taper:.68,x:u(d*.95)-d*.04,y:e,z:t,roll:c});let _=u(d*.9);i.push({profile:s(r*.075,d*.62),height:d*.28,taper:.82,x:_,y:r*.43,z:0,roll:c});let v=_+d*.22,y=[[0,r*.447,d*.2,v],[-d*.38,r*.422,d*.16,v-d*.08],[d*.38,r*.422,d*.16,v-d*.08]];for(let[e,t,n,r]of y)i.push({profile:Q(8,n*1.45),height:d*.11,x:r,y:t,z:e,roll:c}),o.push({profile:Q(8,n),height:d*.17,taper:.5,x:r+d*.09,y:t,z:e,roll:c});for(let[e,t]of[[0,.115],[-d*.2,.085],[d*.2,.085],[-d*.58,.07],[d*.58,.07]])a.push({profile:Q(4,d*.115,Math.PI/4),height:r*t,taper:.1,shearX:-d*.11,x:_+d*.11,y:r*.41,z:e,roll:Math.PI});let b=r*.47;for(let e=0;e<7;e++){let t=e/7*Math.PI*2,n=d*(.25+e%3*.1);i.push({profile:Q(6,d*.165),height:r*(.2+e%4*.06),taper:.66,shearX:Math.cos(t)*d*.08,shearZ:Math.sin(t)*d*.08,x:Math.cos(t)*n,y:b,z:Math.sin(t)*n,rotY:-t})}[[r*.46,r*.72,d*.2,-d*.05,d*.05],[r*.7,r*.89,d*.165,0,d*.12],[r*.88,r,d*.13,d*.11,d*.18]].forEach(([e,t,n,r,a])=>{i.push({profile:Q(6,n),height:t-e,taper:.86,shearX:a,x:r,y:e,z:0})});let x=[[d*.55,r*.395],[d*.95,r*.46],[n*.57,r*.475],[n*.72,r*.44],[n*.84,r*.35],[n*.9,r*.2]],S=[d*.34,d*.31,d*.27,d*.21,d*.125],C=[.7,1.31,2.06,2.79];for(let e=0;e<C.length*2;e++){let t=e>=C.length,n=(C[e%C.length]??0)*(t?-1:1),r=Math.cos(n),o=Math.sin(n);for(let e=0;e<x.length-1;e++){let t=x[e],s=x[e+1];if(!t||!s)continue;let l=s[0]-t[0],u=s[1]-t[1],f=S[e]??d*.15,p=S[e+1]??f*.7;(e%2?a:i).push({profile:Q(7,f),height:Math.hypot(l,u)*1.12,taper:p/f,x:r*t[0],y:t[1],z:o*t[0],roll:c+Math.atan2(u,l),rotY:-n})}for(let e of[2,3,4]){let t=x[e];if(!t)continue;let s=S[e]??d*.15;(e%2?i:a).push({profile:Q(5,s*.6),height:s*.8,taper:.5,x:r*t[0],y:t[1]-s*.75,z:o*t[0],roll:Math.PI,rotY:-n})}}for(let e of[-d*.28,0,d*.28])a.push({profile:Q(4,d*.092,Math.PI/4),height:r*.1,taper:.14,x:u(d*.9),y:r*.135,z:e,roll:Math.PI});return{parts:i,secondary:a,accents:o}}function km(e,t){let n=e,r=t,i=[],a=[],o=(e,t,n=10)=>Q(n,1).map(([n,r])=>[n*e,r*t]),s=(e,t,n=8)=>Q(n,1).map(([n,r])=>[n*e,r*t]),c=-Math.PI/2,l=(e,t)=>({roll:c+t,rotY:-e}),u=-n*.35,d=n*.52,f=n*.475,p=r*.46,m=n*.105,h=.76,g=r-m*h,_=1.25,v=[[0,.7],[.1,.9],[.22,1],[.4,.99],[.58,.9],[.74,.72],[.88,.46]],y=g-p,b=e=>{let t=v[0]?.[1]??1;for(let[n,r]of v)e>=n&&(t=r);return t};v.forEach(([e,t],n)=>{let r=v[n+1];i.push({profile:o(d*t,f*t),height:((r?r[0]:1)-e)*y*(r?_:1),taper:(r?r[1]:.16)/t,x:u,y:p+e*y,z:0})});let x=Math.PI*(3-Math.sqrt(5));for(let e=0;e<46;e++){let t=(e+.5)/46,n=.08+t*.84+Math.sin(e*2.9)*.035,r=Math.PI/2*t**1.5,a=e*x,o=Math.cos(a),s=Math.sin(a),c=b(n),g=m*(1.7-.5*t)*(e%3==0?.86:1),_=m*h;i.push({profile:Q(5,g),height:m,taper:.8,x:u+d*c*o-Math.cos(r)*o*_,y:p+n*y-Math.sin(r)*_,z:f*c*s-Math.cos(r)*s*_,...l(a,r)})}i.push({profile:Q(6,m*1.25),height:m,taper:.55,x:u,y:r-m,z:0});let S=r*.355,C=r*.5,w=.92,T=n*.05;for(let e=0;e<16;e++){let t=(e+.5)/16*Math.PI*2;a.push({profile:Sm(n*.075,2*Math.PI*f*w/16*1.1),height:C-S,taper:.92,shearX:T,x:u+d*(w+e%2*.04)*Math.cos(t),y:S,z:f*(w+e%2*.04)*Math.sin(t),rotY:-t})}let E=-n*.3,D=r*.29,O=r*.47,k=[[0,.8],[.45,1]];k.forEach(([e,t],r)=>{let i=k[r+1],s=O-D;a.push({profile:o(n*.37*t,n*.34*t,9),height:((i?i[0]:1)-e)*s*_,taper:(i?i[1]:.9)/t,x:E,y:D+e*s,z:0})});let A=r*.115,j=n*.165,M=r*.345,N=.45,P=n*.235,F=n*.345,I=n*.075;for(let e of[1,-1])for(let t of[-1,1]){let r=e>0?n*.19:-n*.48,o=r+e*I,s=t*P,c=t*F,l=o+(r-o)*N,u=c+(s-c)*N,d=A+(M-A)*N;i.push({profile:Q(7,j),height:A,taper:.88,x:o,y:0,z:c,rotY:-Math.atan2(c,o)}),a.push({profile:Q(6,n*.095),height:d-A*.75,taper:1.14,shearX:l-o,shearZ:u-c,x:o,y:A*.75,z:c}),a.push({profile:Q(6,n*.115),height:M-d,taper:1.12,shearX:r-l,shearZ:s-u,x:l,y:d,z:u})}a.push({profile:o(n*.23,n*.29,9),height:r*.3,taper:.86,x:n*.19,y:r*.29,z:0});let ee=n*.5,te=n*.22,ne=n*.235,re=r*.265,ie=r*.66,ae=-.04,oe=[[0,.58,-.012],[.2,.9,0],[.44,1,.012],[.68,.96,.004],[.86,.86,-.022]],L=ie-re;oe.forEach(([e,t,r],i)=>{let s=oe[i+1];a.push({profile:o(te*t,ne*t),height:((s?s[0]:1)-e)*L*(s?_:1),taper:(s?s[1]:.72)/t,shearX:((s?s[2]:ae)-r)*n,x:ee+r*n,y:re+e*L,z:0})});let se=ee+ae*n,ce=n*.21,le=r*.028;for(let e=0;e<7;e++){let t=(e+.5)/7*Math.PI*2,n=Math.abs(Math.abs(Math.sin(t))-1)<.2&&Math.cos(t)<.4,r=n?3.4:Math.cos(t)<-.5?1.5:1;a.push({profile:Q(5,ce*(n?.5:.36)),height:le*r,taper:r>1?.32:.7,shearX:ce*.1*r-(n?ce*.5:0),x:se+ce*Math.cos(t),y:ie,z:ce*Math.sin(t),rotY:-t})}a.push({profile:o(ce*.72,ce*.72,8),height:r*.014,x:se,y:ie-r*.005,z:0});for(let e=0;e<4;e++){let t=(e+.5)/4*Math.PI*2;a.push({profile:Q(4,ce*.16,Math.PI/4),height:le,taper:.22,x:se+ce*.5*Math.cos(t),y:ie,z:ce*.5*Math.sin(t)})}let ue=ee+te*.92,de=r*.46;a.push({profile:s(r*.062,ne*.68),height:n*.055,taper:.86,x:ue,y:de,z:0,roll:c});let fe=de-r*.016;a.push({profile:s(r*.024,n*.058),height:n*.045,taper:.8,x:ue+n*.04,y:fe,z:0,roll:c});let pe=n*.115;for(let e=0;e<5;e++){let t=Math.PI*(e+.4)/5.8;i.push({profile:Q(6,n*.022),height:n*.032,x:ue+n*.035,y:fe+Math.sin(t)*pe*.62,z:Math.cos(t)*pe,roll:c})}let me=n*.3,he=n*.15,ge=n*.36,_e=r*.43,ve=r*.18;for(let e=0;e<11;e++){let t=(e+.5)/11*Math.PI*2,n=ge-he;i.push({profile:Sm(r*.03,2*Math.PI*ge/11*.9),height:Math.hypot(n,ve),taper:1.24,x:me+he*Math.cos(t),y:_e,z:he*Math.sin(t),...l(t,-Math.atan2(ve,n))})}let ye=n*.88,be=n*.2125,xe=r*.5,Se=[.79,1.16,1.53,1.98],Ce=[[0,-.06],[.3,-.14],[.58,-.05],[.82,.36],[1,1]],we=[.075,.066,.052,.036,.018],Te=e=>{let t=Math.cos(e);return-me*t+Math.sqrt(me*me*(t*t-1)+ye*ye)};for(let e=0;e<Se.length*2;e++){let t=e%Se.length,a=e>=Se.length,o=(Se[t]??0)*(a?-1:1),s=Te(o*1.22),c=r*(.2+.14*(t/(Se.length-1))),u=e=>o*(1+.22*e),d=e=>Math.min(be+e*(s-be),Te(u(e))),f=e=>xe+e*(c-xe),p=(e,t)=>{let n=u(e),r=d(e);return{x:me+Math.cos(n)*r,y:f(t),z:Math.sin(n)*r}};for(let e=0;e<Ce.length-1;e++){let t=Ce[e],r=Ce[e+1];if(!t||!r)continue;let a=p(t[0],t[1]),o=p(r[0],r[1]),s=Math.hypot(o.x-a.x,o.z-a.z),c=o.y-a.y,u=(we[e]??.02)*n,d=(we[e+1]??.01)*n;i.push({profile:Q(5,u),height:Math.hypot(s,c)*(e===Ce.length-2?1:1.1),taper:d/u,x:a.x,y:a.y,z:a.z,...l(Math.atan2(o.z-a.z,o.x-a.x),Math.atan2(c,s))})}}return{parts:i,secondary:a}}function Am(e,t){let n=e,r=t,i=[],a=[],o=(e,t,n=8)=>Q(n,1).map(([n,r])=>[n*e,r*t]),s=-Math.PI/2,c=1.16,l=(e,t,n,r,i=6)=>{for(let a=0;a<t.length-1;a++){let l=t[a],u=t[a+1];if(!l||!u)continue;let d=u[0]-l[0],f=u[1]-l[1],p=u[2]-l[2],m=Math.hypot(d,p),h=n[a]??1,g=n[a+1]??h*.4;e.push({profile:o(h*r,h,i),height:Math.hypot(m,f)*c,taper:g/h,x:l[0],y:l[1],z:l[2],roll:s+Math.atan2(f,m),rotY:-Math.atan2(p,d)})}},u=[[-n*.7,r*.46,r*.15,n*.24],[-n*.42,r*.55,r*.24,n*.36],[-n*.1,r*.62,r*.28,n*.43],[n*.22,r*.6,r*.26,n*.44],[n*.5,r*.52,r*.22,n*.45]],d=n*.18,f=.84;for(let e=0;e<u.length-1;e++){let t=u[e],n=u[e+1];!t||!n||i.push({profile:o(t[2]*f,t[3]*f,6),height:(n[0]-t[0])*c,taper:n[2]/t[2],x:t[0],y:t[1],z:0,roll:s})}for(let e of[-1,1])for(let t=0;t<6;t++){let r=t/5,o=r*1.9,s=u.length-1,c=u.map(([t,n,i,a],c)=>[t+(c===s?r*d:0),n+i*Math.cos(o),e*a*Math.sin(o)]),f=n*(.17-.025*r);l(t%2==0?a:i,c,[f*.72,f*.92,f,f*.96,f*.58],.9,6)}i.push({profile:o(r*.125,n*.3),height:n*.3,x:n*.3,y:r*.71,z:0,roll:s});let p=n*.54,m=r*.855,h=n*.32;a.push({profile:o(r*.042,h),height:n*.3,taper:.78,shearX:r*.032,x:p,y:m,z:0,roll:s});for(let e=0;e<6;e++){let t=e/5*2-1;a.push({profile:Q(4,n*.036,Math.PI/4),height:r*.045,taper:.16,shearX:-n*.024,x:p+n*.26-Math.abs(t)*n*.038,y:m-r*.016,z:t*h*.78,roll:Math.PI,rotY:t*.3})}for(let e=0;e<6;e++){let t=e/5;i.push({profile:Q(5,n*(.044-.014*t)),height:r*(.038-.014*t),taper:.2,shearX:-n*.022,x:n*(.42-.56*t),y:r*(.89+.024*t),z:0})}for(let e of[-1,1]){let t=e*n*.1;a.push({profile:Q(6,n*.085),height:r*.075,taper:.74,shearX:-n*.038,shearZ:e*n*.024,x:n*.42,y:r*.85,z:t}),i.push({profile:Q(6,n*.063),height:r*.075,taper:.14,shearX:-n*.042,shearZ:e*n*.03,x:n*.382,y:r*.925,z:t*1.24})}let g=[[n*.56,n*.28,r*.8,r*.045,n*.28,6,-1],[n*.56,n*.26,r*.705,r*.04,n*.265,5,-1],[n*.54,n*.26,r*.635,r*.05,n*.25,4,1]];for(let[e,t,c,l,u,d,f]of g){i.push({profile:o(l,u,6),height:t,x:e,y:c,z:0,roll:s});for(let i=0;i<d;i++){let o=i/(d-1)*2-1;a.push({profile:Q(4,n*.032,Math.PI/4),height:r*.036,taper:.14,x:e+t*.82,y:c+f*l*.5,z:o*u*.76,roll:f<0?Math.PI:0})}}for(let e of[-1,1])for(let t=0;t<4;t++){let i=t/3,o=n*(.8+.04*i),s=r*(.63-.13*i),c=e*n*(.26-.05*i),u=[[n*.64,r*(.78-.11*i),e*n*(.23-.03*i)],[o,s,c],[n*(.86-.12*i),r*(.41-.11*i),e*n*(.28-.09*i)]],d=n*(.06-.012*i);l(a,u,[d,d*.82,d*.1],.5,5),a.push({profile:Q(5,d*.5),height:d*.85,taper:.5,x:o,y:s-d*.6,z:c,roll:Math.PI})}l(i,[[n*.66,r*.675,0],[n*.8,r*.668,0],[n*.9,r*.648,0],[n*.95,r*.612,0]],[n*.062,n*.056,n*.05,n*.044],1,6),i.push({profile:Q(6,n*.054),height:n*.07,taper:.72,x:n*.94,y:r*.613,z:0,roll:s-.4}),a.push({profile:Q(4,n*.03,Math.PI/4),height:n*.07,taper:.12,x:n*.965,y:r*.602,z:0,roll:s-.5});for(let[e,t]of[[n*.74,r*.681],[n*.85,r*.664]])i.push({profile:Q(4,n*.019),height:n*.058,taper:.18,shearX:n*.024,x:e,y:t,z:0});let _=[[n*.44,n*.42,r*.52,n*.3,n*.3,n*.19,4],[-n*.6,n*.32,r*.48,n*.28,-n*.16,n*.13,3]];for(let[e,t,n,r,c,l,u]of _)for(let d of[-1,1]){let f=d*t;i.push({profile:Q(8,r),height:n,taper:.4,shearX:-c,shearZ:-d*l,x:e,y:0,z:f}),a.push({profile:o(r*.36,r*.3,6),height:n*.6,taper:.46,shearX:-c*.6,x:e+r*.1,y:n*.05,z:f+d*r*.6}),a.push({profile:Q(6,r*.82),height:r*.3,taper:1.06,x:e,y:0,z:f});for(let t=0;t<u;t++){let a=(t+.5)/u,o=d*(.5+a*2.4),p=r*(1-a*.5);i.push({profile:Q(5,r*(.32-a*.11)),height:r*(.55-a*.18),taper:.24,x:e-c*a+Math.cos(o)*p*.82,y:n*(.18+a*.5),z:f-d*l*a+Math.sin(o)*p*.82,roll:s+1.1,rotY:-o})}let p=-Math.sign(e);for(let t=0;t<3;t++){let n=.4+t*.5;i.push({profile:Q(4,r*.1),height:r*.75,taper:.3,x:e+p*Math.cos(n)*r*.6,y:r*.34,z:f+d*Math.sin(n)*r*.42,roll:s-.16,rotY:-p*d*.55})}}i.push({profile:o(r*.13,n*.22,6),height:n*.12,taper:.66,x:-n*.7,y:r*.45,z:0,roll:s+Math.PI});for(let e of[-1,.4,-.4,1])i.push({profile:Q(5,n*.045),height:n*.13,taper:.24,x:-n*.74,y:r*(.4+Math.abs(e)*.06),z:e*n*.14,roll:s+Math.PI+.3,rotY:e*.5});return{parts:i,secondary:a,accents:[]}}function jm(e,t,n){let r=Math.cos(n),i=Math.sin(n);return[e*r-t*i,e*i+t*r]}function Mm(e,t){let n=e,r=t,i=[],a=[],o=n*.05,s=r*.28,c=n*.22,l=n*.56;for(let e of[55,125,-125,-55]){let t=e*Math.PI/180,i=Math.cos(t)*l,u=Math.sin(t)*l,d=Math.cos(t)*c,f=Math.sin(t)*c,p=-t,[m,h]=jm(d-i,f-u,p);a.push({profile:$(n*.34,n*.38,o*1.4),height:s,taper:.8,shearX:m,shearZ:h,x:i,y:0,z:u,rotY:p}),a.push({profile:xm(n*.2),height:r*.028,x:i,y:0,z:u,rotY:p}),a.push({profile:$(n*.28,n*.32,o),height:r*.055,x:i*.72+d*.28,y:s*.44,z:u*.72+f*.28,rotY:p})}a.push({profile:$(n*.44,n*.44,o),height:r*.1,taper:1.08,x:0,y:r*.24,z:0}),a.push({profile:xm(n*.2),height:r*.07,x:0,y:r*.33,z:0}),i.push({profile:xm(n*.24,Math.PI/6),height:r*.09,taper:1.75,x:0,y:r*.37,z:0}),i.push({profile:xm(n*.42,Math.PI/6),height:r*.09,taper:.99,x:n*.01,y:r*.46,z:0}),i.push({profile:xm(n*.41),height:r*.045,taper:.86,x:0,y:r*.55,z:0}),a.push({profile:xm(n*.19),height:n*.06,x:n*.35,y:r*.495,z:0,roll:-Math.PI/2});for(let e of[-1,1])i.push({profile:xm(n*.16),height:n*.05,x:n*.02,y:r*.5,z:e*n*.37,rotY:e*-Math.PI/2,roll:-Math.PI/2});i.push({profile:$(n*.36,n*.66,o),height:r*.06,taper:.94,x:-n*.04,y:r*.545,z:0});for(let e of[-1,1]){let t=e*n*.24,s=e*n*.012;[[r*.575,r*.16,n*.26,.95],[r*.75,r*.15,n*.24,.94],[r*.91,r*.09,n*.205,.88]].forEach(([e,r,a,c],l)=>{i.push({profile:$(a,a*1.1,o),height:r,taper:c,shearX:-n*.012,shearZ:s,x:-n*.02-l*n*.012,y:e,z:t+l*s*1.6})});for(let[e,a]of[[r*.725,n*.28],[r*.888,n*.26]])i.push({profile:$(a,a*1.12,o),height:r*.03,x:-n*.03,y:e,z:t+s*1.2});a.push({profile:Sm(n*.19,n*.035),height:r*.15,x:-n*.02,y:r*.59,z:t-e*n*.13})}for(let e of[-1,1])i.push({profile:$(n*.19,n*.38,o),height:n*.36,taper:.88,shearX:-n*.18,x:n*.05,y:r*.47,z:e*n*.3,rotY:e*-Math.PI/2,roll:-Math.PI/2}),i.push({profile:xm(n*.17),height:r*.07,x:n*.07,y:r*.51,z:e*n*.68}),i.push({profile:$(n*.2,n*.22,o*1.2),height:r*.29,taper:.95,shearX:-n*.03,shearZ:e*n*.16,x:n*.1,y:r*.24,z:e*n*.52}),i.push({profile:$(n*.19,n*.18,o),height:r*.06,taper:.86,x:n*.1,y:r*.21,z:e*n*.52});for(let e of[-1,1]){let t=n*.58,a=e*n*.26;i.push({profile:$(n*.17,n*.15,o),height:r*.26,taper:1.1,shearX:-n*.34,shearZ:e*n*.02,x:t,y:r*.11,z:a}),i.push({profile:$(n*.18,n*.17,o),height:r*.07,x:t+n*.03,y:r*.085,z:a});for(let e of[-1,1])i.push({profile:Sm(n*.075,n*.07),height:n*.2,taper:.35,x:t+n*.04,y:r*.12+e*r*.026,z:a,roll:-Math.PI/2})}let u=[];for(let e of[-1,1])a.push({profile:Sm(n*.12,n*.03),height:r*.095,x:n*.23,y:r*.45,z:e*n*.4}),u.push({profile:Sm(n*.065,n*.045),height:r*.07,x:n*.23,y:r*.463,z:e*n*.403});return{parts:i,secondary:a,accents:u}}function Nm(e,t){let n=e,r=t,i=[],a=[],o=[],s=-Math.PI/2,c=(e,t=0)=>({roll:s+t,rotY:-e}),l=(e,t,n=0)=>n>0?$(e*2,t*2,n):Sm(e*2,t*2),u=n*.25,d=r*.392,f=n*.64,p=r*.455,m=n*.885,h=r*.034,g=.38,_=1.06,v=f-u,y=p-d,b=Math.hypot(v,y),x=Math.atan2(y,v),S=m-f,C=h-p,w=Math.hypot(S,C),T=Math.atan2(C,S);for(let e of[1,-1])for(let t of[1,-1]){let s=Math.atan2(t,e),v=Math.cos(s),y=Math.sin(s),E=(e,t)=>({x:v*e,y:t,z:y*e}),D=e=>E(f+S*e,p+C*e),O=E(u,d),k=E(f,p),A=E(m,h),j=D(g);a.push({profile:l(r*.028,n*.05,n*.022),height:b*_,taper:.92,...O,...c(s,x)}),o.push({profile:l(r*.031,n*.056,n*.024),height:r*.075,taper:.94,...D(-.03),...c(s,T)}),a.push({profile:l(r*.024,n*.044,n*.02),height:w*g*_,taper:.95,...k,...c(s,T)}),i.push({profile:l(r*.0225,n*.04,n*.018),height:w*.62,taper:.9,...j,...c(s,T)}),o.push({profile:$(n*.125,n*.095,n*.026),height:h,taper:1.06,x:A.x,y:0,z:A.z,rotY:-s})}let E=r*.152,D=r*.428,O=n*.3;o.push({profile:$(O*2,O*2,O*.62),height:D-E,x:0,y:E,z:0});let k=(E+D)/2;for(let e=0;e<4;e++){let t=e*Math.PI/2,s=Math.cos(t),l=Math.sin(t),u=e=>({x:s*e,y:k,z:l*e,...c(t)});i.push({profile:Q(8,n*.29,Math.PI/8),height:n*.075,...u(O-n*.02)}),a.push({profile:Q(8,n*.245,Math.PI/8),height:n*.055,...u(O+n*.02)}),o.push({profile:Sm(r*.036,n*.024),height:n*.03,...u(O+n*.075)})}i.push({profile:Q(8,n*.315,Math.PI/8),height:r*.042,taper:.88,x:0,y:D,z:0}),o.push({profile:Sm(n*.06,n*.055),height:r*.074,x:n*.09,y:r*.088,z:0});let A=r*.462,j=r*.695,M=r*.895,N=n*.312,P=n*.362,F=n*.036,I=.965;a.push({profile:$(N,P,F),height:j-A,x:0,y:A,z:0}),a.push({profile:$(N*I,P*I,F*I),height:M-j,taper:I,x:0,y:j,z:0});let ee=A+r*.046;i.push({profile:$(N*1.075,P*1.075,F),height:ee-A,taper:.965,x:0,y:A,z:0});let te=Math.PI/4,ne=e=>({x:N*e/2-F*e/2,z:-(P*e/2-F*e/2)}),re=ne(1),ie=ne(I);i.push({profile:Sm(n*.03,n*.085),height:j-ee,x:re.x,y:ee,z:re.z,rotY:te}),i.push({profile:Sm(n*.03,n*.082),height:M-j-r*.008,shearX:-ie.x*.03500000000000003,x:ie.x,y:j,z:ie.z,rotY:te}),a.push({profile:Sm(n*.022,n*.022),height:r-M,taper:.85,x:n*.028,y:M,z:0});let ae=P*.5,oe=ae+n*.065,L=r*.03,se=n*.085;for(let[e,t]of[[r*.812,n*.505],[r*.672,n*.425]]){o.push({profile:Q(10,n*.112),height:n*.062,x:n*.03,y:e,z:ae-n*.02,...c(Math.PI/2)}),a.push({profile:Q(10,n*.135),height:n*.086,taper:.94,x:n*.03,y:e,z:ae+n*.03,...c(Math.PI/2)});let s=n*.075;for(let r of[L,-L])a.push({profile:$(n*.042,n*.042,n*.012),height:t,x:s,y:e+r,z:oe,...c(0)}),i.push({profile:$(n*.044,n*.044,n*.013),height:se,x:s+t-se,y:e+r,z:oe,...c(0)});o.push({profile:Sm(n*.018,n*.058),height:t*.78,x:s+n*.02,y:e-r*.049,z:oe,...c(0)})}return{parts:i,secondary:a,accents:o}}function Pm(e,t){let n=e*.82,r=t,i=[],a=[];i.push({profile:$(n*1.18,n*.9,n*.08),height:r*.42,x:0,y:r*.42,z:0}),i.push({profile:$(n*.34,n*.42,n*.04),height:r*.18,x:n*.48,y:r*.49,z:0});for(let e=0;e<4;e++)i.push({profile:Sm(n*.12,n*.5),height:r*.08,x:-n*.33+e*n*.22,y:r*.86,z:0});for(let e of[-1,1])for(let t of[-1,1]){let a=e*n*.7,o=t*n*.54;i.push({profile:$(n*.16,n*.12,n*.025),height:r*.42,taper:.72,shearX:-e*n*.28,shearZ:-t*n*.18,x:a,y:0,z:o,rotY:Math.atan2(t,e)}),i.push({profile:$(n*.25,n*.18,n*.025),height:r*.04,x:a,y:0,z:o,rotY:Math.atan2(t,e)})}return a.push({profile:Sm(n*.08,n*.54),height:n*.03,x:n*.32,y:r*.62,z:0,roll:-Math.PI/2}),{parts:i,accents:a}}function Fm(e,t){let n=e,r=t,i=[],a=[];for(let e of[-1,1])for(let t of[-1,1]){let a=e*n*.48,o=t*n*.44;i.push({profile:$(n*.3,n*.24,n*.04),height:r*.35,taper:.7,shearX:-e*n*.22,shearZ:-t*n*.18,x:a,y:0,z:o,rotY:Math.atan2(t,e)}),i.push({profile:$(n*.32,n*.24,n*.04),height:r*.035,x:a,y:0,z:o,rotY:Math.atan2(t,e)})}i.push({profile:$(n*.82,n*.68,n*.08),height:r*.18,taper:1.08,x:0,y:r*.32,z:0}),i.push({profile:$(n*.7,n*.56,n*.08),height:r*.2,taper:.9,x:n*.02,y:r*.5,z:0}),i.push({profile:xm(n*.28,Math.PI/6),height:r*.11,taper:.82,x:n*.06,y:r*.7,z:0});for(let e of[-n*.26,n*.26])i.push({profile:xm(n*.13),height:n*.32,x:n*.26,y:r*.8,z:e,roll:-Math.PI/2});return a.push({profile:xm(n*.11),height:n*.035,x:n*.28,y:r*.58,z:0,roll:-Math.PI/2}),{parts:i,accents:a}}var Im={"machine-infantry":3091507},Lm=.5,Rm=1.6,zm=1.8,Bm=64,Vm={"machine-harbinger":Fm(Zd.large.radius,34),"machine-harvester":Pm(Zd.medium.radius,25),"machine-infantry":Nm(Zd.small.radius,10),"machine-construct":{...Mm(28,70),allowsFootprintOverflow:!0},"ancient-harbinger":Om(Zd.large.radius,30),"ancient-harvester":km(Zd.medium.radius,20),"ancient-infantry":Dm(Zd.small.radius,9),"ancient-support":Em(Zd.small.radius,9),"ancient-nug":{...Am(28,70),allowsFootprintOverflow:!0}},Hm=new Map;function Um(e){let t=Vm[e];if(!t)throw Error(`unit type ${e} has no reference silhouette`);return t}function Wm(e){return Im[e]??tm(Tf(e).faction)}function Gm(e){let t=Hm.get(e);if(t)return t;let n=Um(e),r=Cm([...n.parts,...n.secondary??[],...n.accents??[]]),i=r.getAttribute(`position`),a=0,o=1/0,s=-1/0;for(let e=0;e<i.count;e++)a=Math.max(a,Math.hypot(i.getX(e),i.getZ(e))),o=Math.min(o,i.getY(e)),s=Math.max(s,i.getY(e));r.dispose();let c={radius:a,minY:o,maxY:s,height:s-o};return Hm.set(e,c),c}function Km(e,t,n){let r=t-e;for(;r>Math.PI;)r-=Math.PI*2;for(;r<-Math.PI;)r+=Math.PI*2;return e+r*n}var qm=class{group=new xn;meshes=new Map;matrix=new Kt;rotation=new Kt;colour=new Y;used=new Map;drawn=0;constructor(e){for(let t of Cf){let n=Vm[t.id];if(!n)throw Error(`unit type ${t.id} has no reference silhouette`);let r=e.units.filter(e=>e.typeId===t.id).length,i=Math.max(r+Bm,4),a=new ai(Cm(n.parts),new Ya({color:16777215,flatShading:!0}),i);a.frustumCulled=!1;let o=new ai(Cm([...n.parts,...n.secondary??[]]),new Ya({color:16777215,flatShading:!0,transparent:!0,opacity:Lm,depthWrite:!1}),i);o.frustumCulled=!1,o.renderOrder=10;let s;n.secondary&&n.secondary.length>0&&(s=new ai(Cm(n.secondary),new Ya({color:16777215,flatShading:!0}),i),s.frustumCulled=!1);let c;n.accents&&n.accents.length>0&&(c=new ai(Cm(n.accents),new Ya({color:Wm(t.id),flatShading:!0}),i),c.frustumCulled=!1);let l=1+zm/Ef(t);this.meshes.set(t.id,{type:t,body:a,shell:o,secondary:s,accent:c,shellScale:new K(l,l,l)}),this.group.add(a,o),s&&this.group.add(s),c&&this.group.add(c)}}static layersOf(e){let t=Vm[e];if(!t)throw Error(`unit type ${e} has no reference silhouette`);let n=2;return t.secondary&&t.secondary.length>0&&n++,t.accents&&t.accents.length>0&&n++,n}sync(e,t,n){this.used.clear(),this.drawn=0;for(let r of e.units){let e=this.meshes.get(r.typeId);if(!e)continue;let i=this.used.get(r.typeId)??0;if(i>=e.body.count)continue;this.used.set(r.typeId,i+1);let a=r.prevX+(r.x-r.prevX)*t,o=r.prevZ+(r.z-r.prevZ)*t;this.rotation.makeRotationY(-Km(r.prevHeading,r.heading,t)),this.matrix.copy(this.rotation),this.matrix.setPosition(a,Nu,o),e.body.setMatrixAt(i,this.matrix),e.secondary?.setMatrixAt(i,this.matrix),e.accent?.setMatrixAt(i,this.matrix);let s=$p(e.type.faction),c=1;if(r.deployTimer>0){let e=1-r.deployTimer/Fd,t=r.deployTarget?1:.72;c=t+((r.deployTarget?.72:1)-t)*e}else r.deployed&&(c=.72);this.colour.setHex(s).multiplyScalar(c),e.body.setColorAt(i,this.colour),e.secondary&&(this.colour.setHex(em(e.type.faction)).multiplyScalar(c),e.secondary.setColorAt(i,this.colour)),n(r.id)?(this.matrix.copy(this.rotation),this.matrix.scale(e.shellScale),this.matrix.setPosition(a,Nu,o),e.shell.setMatrixAt(i,this.matrix),this.colour.setHex(s).multiplyScalar(Rm),e.shell.setColorAt(i,this.colour)):(this.matrix.makeScale(0,0,0),this.matrix.setPosition(a,Nu,o),e.shell.setMatrixAt(i,this.matrix)),this.drawn++}for(let e of this.meshes.values()){for(let t=this.used.get(e.type.id)??0;t<e.body.count;t++)this.matrix.makeScale(0,0,0),e.body.setMatrixAt(t,this.matrix),e.shell.setMatrixAt(t,this.matrix),e.secondary?.setMatrixAt(t,this.matrix),e.accent?.setMatrixAt(t,this.matrix);e.body.instanceMatrix.needsUpdate=!0,e.shell.instanceMatrix.needsUpdate=!0,e.secondary&&(e.secondary.instanceMatrix.needsUpdate=!0),e.accent&&(e.accent.instanceMatrix.needsUpdate=!0),e.body.instanceColor&&(e.body.instanceColor.needsUpdate=!0),e.shell.instanceColor&&(e.shell.instanceColor.needsUpdate=!0),e.secondary?.instanceColor&&(e.secondary.instanceColor.needsUpdate=!0)}}static measure(e){let{radius:t,height:n}=Gm(e);return{radius:t,height:n}}static footprintOf(e){return Ef(e)}dispose(){for(let e of this.meshes.values())e.body.geometry.dispose(),Jm(e.body.material),e.shell.geometry.dispose(),Jm(e.shell.material),e.secondary&&(e.secondary.geometry.dispose(),Jm(e.secondary.material)),e.accent&&(e.accent.geometry.dispose(),Jm(e.accent.material))}};function Jm(e){Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}var Ym=new K,Xm=1.5;function Zm(e,t,n){let r=Qm(e,n);if(!r)return;let i,a=1/0;for(let e of t){let t=(e.x-r.x)**2+(e.z-r.z)**2;t>196||t>=a||(i=e,a=t)}return i?.id}function Qm(e,t,n=Nu){Ym.set(t.x,t.y,.5).unproject(e);let r=e.position,i=Ym.sub(r);if(Math.abs(i.y)<1e-6)return;let a=(n-r.y)/i.y;if(!(a<0))return new K(r.x+i.x*a,n,r.z+i.z*a)}function $m(e,t,n){Ym.set(n.x,n.y,.5).unproject(e);let r=e.position,i=Ym.x-r.x,a=Ym.y-r.y,o=Ym.z-r.z,s=Math.hypot(i,a,o);if(s<1e-9)return;let c=i/s,l=a/s,u=o/s,d,f=1/0;for(let e of t.units){let t=Gm(e.typeId),n=eh(r.x,r.y,r.z,c,l,u,e.x,e.z,t.radius+Xm,Nu+t.minY-Xm,Nu+t.maxY+Xm);n===void 0||n>=f||n<f&&(f=n,d=e.id)}return d}function eh(e,t,n,r,i,a,o,s,c,l,u){let d=e-o,f=n-s,p=1/0,m=r*r+a*a;if(m>1e-9){let e=2*(d*r+f*a),n=d*d+f*f-c*c,o=e*e-4*m*n;if(o>=0){let n=Math.sqrt(o);for(let r of[(-e-n)/(2*m),(-e+n)/(2*m)]){let e=t+i*r;r>=0&&e>=l&&e<=u&&(p=Math.min(p,r))}}}if(Math.abs(i)>1e-9)for(let d of[l,u]){let l=(d-t)/i,u=e+r*l-o,f=n+a*l-s;l>=0&&u*u+f*f<=c*c&&(p=Math.min(p,l))}return Number.isFinite(p)?p:void 0}function th(e,t,n){Ym.set(n.x,n.y,.5).unproject(e);let r=e.position,i=Ym.x-r.x,a=Ym.y-r.y,o=Ym.z-r.z,s,c=1/0;for(let e of t.buildings){let t=e.state===`intact`?e.height:e.state===`damaged`?e.height*.55:3,n=e.rotation??0,l=hu({x:r.x-e.x,z:r.z-e.z},-n),u=hu({x:i,z:o},-n),d=nh(l.x,r.y,l.z,u.x,a,u.z,-e.width/2,0,-e.depth/2,e.width/2,t,e.depth/2);d!==void 0&&d<c&&(c=d,s=e.id)}return s}function nh(e,t,n,r,i,a,o,s,c,l,u,d){let f=0,p=1/0;for(let[m,h,g,_]of[[e,r,o,l],[t,i,s,u],[n,a,c,d]]){if(Math.abs(h)<1e-9){if(m<g||m>_)return;continue}let e=(g-m)/h,t=(_-m)/h;if(e>t&&([e,t]=[t,e]),f=Math.max(f,e),p=Math.min(p,t),f>p)return}return p>=0?f:void 0}function rh(e,t,n){let r=[];for(let i of t.units)ih(e,i,n)&&r.push(i.id);return r.sort((e,t)=>e-t)}function ih(e,t,n){return Ym.set(t.x,Nu,t.z).project(e),Ym.z<-1||Ym.z>1?!1:Ym.x>=n.x0&&Ym.x<=n.x1&&Ym.y>=n.y0&&Ym.y<=n.y1}var ah=[13215870,13215870,13215870,11570272,11570272,10580815,10580815,14208942,13878668,9408867,6317130],oh=[11028540,3493995,14209990,7307086,9072296,4145992],sh={sky:14145730,shardTop:10323041,cliff:[11100220,9260336,7289894],road:10659477,sidewalk:13027512,parking:10132878,laneMarking:14205527,crosswalk:14672082,park:8362574,tree:5204788,rubble:12892060,greeble:11118485},ch={intact:1,damaged:.54,rubble:.06},lh=.8,uh=3;function dh(e,t={}){return new Ya({color:e,flatShading:!0,...t})}function fh(e){let t=new vi(1,1,1,1,e,1).toNonIndexed(),n=t.getAttribute(`position`),r=new Float32Array(n.count*3);for(let t=0;t<n.count;t+=3){let i=(n.getY(t)+n.getY(t+1)+n.getY(t+2))/3,a=Math.floor((i+.5)*e)%2==0?1:lh;for(let e=0;e<3;e++)r[(t+e)*3]=a,r[(t+e)*3+1]=a,r[(t+e)*3+2]=a}return t.setAttribute(`color`,new lr(r,3)),t}var ph=class{city;group=new xn;buildingMeshList=[];slots=new Map;greebles;greebleStart=new Map;debris;matrix=new Kt;color=new Y;scale=new K;clipped;clippedState=``;constructor(e){this.city=e;for(let e of this.buildShardTops())this.group.add(e);for(let e of this.buildCliffBands())this.group.add(e);this.group.add(this.buildPads(`built`,sh.sidewalk,Nu)),this.group.add(this.buildPads(`parking`,sh.parking,Nu)),this.group.add(this.buildPads(`park`,sh.park,Nu+.1)),this.group.add(this.buildRoads());for(let e of this.buildFragmentOverlays())this.group.add(e);this.group.add(this.buildStripes(this.city.centreLines,sh.laneMarking,1.1)),this.group.add(this.buildStripes(this.city.crosswalks,sh.crosswalk,1.1)),this.group.add(this.buildTrees()),this.group.add(this.buildCars()),this.group.add(this.buildEdgeRubble());let t=new Map;for(let e of this.city.buildings){if(e.clip)continue;let n=Eu(e.height,e.district),r=t.get(n);r?r.push(e):t.set(n,[e])}for(let[e,n]of t){let t=new ai(fh(e),dh(16777215,{vertexColors:!0}),n.length);t.frustumCulled=!1,t.userData.storeys=e,this.buildingMeshList.push(t),this.group.add(t),n.forEach((e,n)=>this.slots.set(e.id,{mesh:t,index:n}))}let n=0;for(let t of e.buildings)this.greebleStart.set(t.id,n),n+=t.greebles;this.greebles=new ai(new vi(1,1,1),dh(sh.greeble),Math.max(n,1)),this.greebles.frustumCulled=!1,this.group.add(this.greebles),this.debris=new ai(new vi(1,1,1),dh(sh.rubble),Math.max(e.buildings.length*uh,1)),this.debris.frustumCulled=!1,this.group.add(this.debris),this.refreshAll()}buildShardTops(){return[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)].map((e,t)=>{let n=e[0];if(!n)throw Error(`city boundary is empty`);let r=new Qi;r.moveTo(n.x,-n.z);for(let t=1;t<e.length;t++){let n=e[t];n&&r.lineTo(n.x,-n.z)}r.closePath();let i=new qr(new La(r),dh(sh.shardTop));return i.rotation.x=-Math.PI/2,i.name=t<this.city.surfaces.length?`shard-top-${t}`:`shard-chip-top-${t}`,i})}buildCliffBands(){let e=[...this.city.surfaces.map(e=>({points:e,depth:340,chip:!1})),...this.city.decorativeFragments.map(e=>({points:e.boundary,depth:e.depth,chip:!0}))],t=[0,.28,.62,1],n=[];for(let r=0;r<3;r++){let i=sh.cliff[r];if(i===void 0)continue;let a=[];for(let n of e){if(n.chip&&r>0)continue;let e=n.points,i=n.chip?0:-(t[r]??0)*n.depth,o=n.chip?-n.depth:-(t[r+1]??1)*n.depth,s=this.polygonCentre(e),c=[1,.995,.985,.97][r]??1,l=[1,.995,.985,.97][r+1]??.97;for(let t=0;t<e.length;t++){let n=e[t],r=e[(t+1)%e.length];if(!n||!r)continue;let u=this.scaleFrom(n,s,c),d=this.scaleFrom(r,s,c),f=this.scaleFrom(r,s,l),p=this.scaleFrom(n,s,l);a.push(u.x,i,u.z,d.x,i,d.z,f.x,o,f.z,u.x,i,u.z,f.x,o,f.z,p.x,o,p.z)}}let o=new wr;o.setAttribute(`position`,new lr(new Float32Array(a),3)),o.computeVertexNormals();let s=new qr(o,dh(i,{side:2}));s.name=`cliff-band-${r}`,n.push(s)}return n}polygonCentre(e){let t=0,n=0;for(let r of e)t+=r.x,n+=r.z;return{x:t/e.length,z:n/e.length}}scaleFrom(e,t,n){return{x:t.x+(e.x-t.x)*n,z:t.z+(e.z-t.z)*n}}buildPads(e,t,n){let r=this.city.blocks.filter(t=>t.kind===e),i=new qr(this.polygonsGeometry(r.map(e=>e.clip??this.rectPoints(e)),0,n),dh(t));return i.name=`${e}-pads`,i}buildRoads(){let e=[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)],t=new qr(this.polygonsGeometry(e,0,1),dh(sh.road));return t.name=`roads`,t}buildFragmentOverlays(){return[{kind:`built`,colour:sh.sidewalk,top:Nu},{kind:`parking`,colour:sh.parking,top:Nu},{kind:`park`,colour:sh.park,top:Nu+.1}].map(e=>{let t=this.city.decorativeFragments.flatMap(t=>t.overlays.filter(t=>t.kind===e.kind).map(e=>e.polygon)),n=new qr(this.polygonsGeometry(t,0,e.top),dh(e.colour));return n.name=`chip-${e.kind}`,n})}rectPoints(e){return[{x:e.x0,z:e.z0},{x:e.x1,z:e.z0},{x:e.x1,z:e.z1},{x:e.x0,z:e.z1}]}appendPrism(e,t,n,r,i=!0){if(t.length<3)return;let a=t.reduce((e,n,r)=>{let i=t[(r+1)%t.length];return i?e+n.x*i.z-i.x*n.z:e},0)>=0?[...t]:[...t].reverse(),o=Na.triangulateShape(a.map(e=>new G(e.x,e.z)),[]);for(let t of o){let n=t[0],i=t[1],o=t[2];if(n===void 0||i===void 0||o===void 0)continue;let s=a[n],c=a[i],l=a[o];!s||!c||!l||((c.x-s.x)*(l.z-s.z)-(c.z-s.z)*(l.x-s.x)>0?e.push(s.x,r,s.z,l.x,r,l.z,c.x,r,c.z):e.push(s.x,r,s.z,c.x,r,c.z,l.x,r,l.z))}if(i)for(let t=0;t<a.length;t++){let i=a[t],o=a[(t+1)%a.length];!i||!o||e.push(i.x,n,i.z,i.x,r,i.z,o.x,n,o.z,o.x,n,o.z,i.x,r,i.z,o.x,r,o.z)}}appendBandedPrism(e,t,n,r,i,a,o){if(n.length<3)return;let s=e.length/3;this.appendPrism(e,n,r,i,!1);for(let n=s;n<e.length/3;n++)t.push(o.r,o.g,o.b);let c=Math.max(1,Math.round(a));for(let a=0;a<c;a++){let s=r+(i-r)*a/c,l=r+(i-r)*(a+1)/c,u=a%2==0?1:lh,d=e.length/3;for(let t=0;t<n.length;t++){let r=n[t],i=n[(t+1)%n.length];!r||!i||e.push(r.x,s,r.z,r.x,l,r.z,i.x,s,i.z,i.x,s,i.z,r.x,l,r.z,i.x,l,i.z)}for(let n=d;n<e.length/3;n++)t.push(o.r*u,o.g*u,o.b*u)}}polygonsGeometry(e,t,n){let r=[];for(let i of e)this.appendPrism(r,i,t,n);let i=new wr;return i.setAttribute(`position`,new lr(new Float32Array(r),3)),i.computeVertexNormals(),i}buildEdgeRubble(){let e=this.city.decorativeFragments.flatMap(e=>e.rubble),t=new qr(this.polygonsGeometry(e,Nu,Nu+2.2),dh(sh.rubble));return t.name=`edge-rubble`,t}buildClipped(){let e=[],t=[];for(let n of this.city.buildings){if(!n.clip||n.clip.length<3)continue;let r=Math.max(n.height*ch[n.state],2.2);if(n.state===`rubble`?this.color.setHex(sh.rubble):(this.color.setHex(ah[n.paletteIndex%ah.length]??16777215),n.state===`damaged`&&this.color.multiplyScalar(.76)),n.state===`rubble`){let i=e.length/3;this.appendPrism(e,n.clip,Nu,Nu+r);for(let n=i;n<e.length/3;n++)t.push(this.color.r,this.color.g,this.color.b)}else{let i=Eu(r,n.district);this.appendBandedPrism(e,t,n.clip,Nu,Nu+r,i,this.color)}}let n=new wr;n.setAttribute(`position`,new lr(new Float32Array(e),3)),n.setAttribute(`color`,new lr(new Float32Array(t),3)),n.computeVertexNormals();let r=new qr(n,dh(16777215,{vertexColors:!0}));return r.name=`clipped-buildings`,r}clippedSignature(){let e=``;for(let t of this.city.buildings)t.clip&&(e+=t.state[0]);return e}rebuildClipped(){let e=this.clippedSignature();if(e===this.clippedState)return;this.clippedState=e;let t=this.buildClipped();if(this.clipped){this.group.remove(this.clipped),this.clipped.geometry.dispose();let e=this.clipped.material;Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}this.clipped=t,this.group.add(t)}buildStripes(e,t,n){let r=new ai(new vi(1,1,1),dh(t),Math.max(e.length,1));return r.frustumCulled=!1,e.forEach((e,t)=>{this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(e.width,.3,e.depth),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,n,e.z),r.setMatrixAt(t,this.matrix)}),r.instanceMatrix.needsUpdate=!0,r}buildTrees(){let e=new ai(new xi(4.5,14,5),dh(sh.tree),Math.max(this.city.trees.length,1));return e.frustumCulled=!1,this.city.trees.forEach((t,n)=>{this.matrix.makeScale(t.scale,t.scale,t.scale),this.matrix.setPosition(t.x,Nu+7*t.scale,t.z),e.setMatrixAt(n,this.matrix)}),e.instanceMatrix.needsUpdate=!0,e}buildCars(){let e=new ai(new vi(1,1,1),dh(16777215),Math.max(this.city.cars.length,1));return e.frustumCulled=!1,this.city.cars.forEach((t,n)=>{let r=5.4,i=2.4;this.matrix.makeRotationY(-(t.rotation??0)),this.scale.set(t.alongX?r:i,2,t.alongX?i:r),this.matrix.scale(this.scale),this.matrix.setPosition(t.x,(t.parked?Nu:1)+1,t.z),e.setMatrixAt(n,this.matrix),this.color.setHex(oh[t.paletteIndex%oh.length]??16777215),e.setColorAt(n,this.color)}),e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0),e}refresh(e){let t=this.city.get(e);t&&(this.writeBuilding(t),this.flush(this.slots.get(e)?.mesh),this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,t.clip&&this.rebuildClipped())}refreshAll(){for(let e of this.city.buildings)this.writeBuilding(e);for(let e of this.buildingMeshList)this.flush(e);this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,this.rebuildClipped()}flush(e){e&&(e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0))}writeBuilding(e){let t=this.slots.get(e.id);if(!t)return;let n=Ou[e.state],r=Math.max(e.height*ch[e.state],2.2),i=e.width*n,a=e.depth*n;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(i,r,a),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,Nu+r/2,e.z),t.mesh.setMatrixAt(t.index,this.matrix);let o=ah[e.paletteIndex%ah.length]??16777215;e.state===`rubble`?this.color.setHex(sh.rubble):(this.color.setHex(o),e.state===`damaged`&&this.color.multiplyScalar(.76)),t.mesh.setColorAt(t.index,this.color),this.writeGreebles(e,Nu+r),this.writeDebris(e)}writeGreebles(e,t){let n=this.greebleStart.get(e.id);if(n===void 0)return;let r=e.state===`intact`;for(let i=0;i<e.greebles;i++){if(!r){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,t,e.z),this.greebles.setMatrixAt(n+i,this.matrix);continue}let a=hu({x:((i+1)/(e.greebles+1)-.5)*e.width*.55,z:((e.id+i)%5/5-.5)*e.depth*.55},e.rotation??0),o=Math.min(e.width,e.depth)*.16,s=o*(.7+(e.id+i)%3*.35);this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(o,s,o),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+a.x,t+s/2,e.z+a.z),this.greebles.setMatrixAt(n+i,this.matrix)}}writeDebris(e){let t=e.id*uh;if(t+uh>this.debris.count)return;let n=e.state===`rubble`;for(let r=0;r<uh;r++){if(!n){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,Nu,e.z),this.debris.setMatrixAt(t+r,this.matrix);continue}let i=e.id*3+r,a=hu({x:(i*37%100/100-.5)*(e.width+16),z:(i*61%100/100-.5)*(e.depth+16)},e.rotation??0),o=Math.min(e.width,e.depth)*(.14+i%4/4*.16);this.matrix.makeScale(o,o*.5,o),this.matrix.setPosition(e.x+a.x,Nu+o*.25,e.z+a.z),this.debris.setMatrixAt(t+r,this.matrix)}}get meshCount(){return this.group.children.length}get buildingMeshes(){return this.buildingMeshList}renderedStoreysOf(e){let t=this.slots.get(e);return typeof t?.mesh.userData.storeys==`number`?t.mesh.userData.storeys:void 0}renderedHeightOf(e){if(this.city.get(e)?.clip)return 2.2;let t=this.slots.get(e);if(t)return t.mesh.getMatrixAt(t.index,this.matrix),this.matrix.elements[5]}dispose(){for(let e of this.group.children)if(e instanceof qr){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}}};function mh(e,t){let n=Math.min(e,t)/2,r=[],i=[];r.push({profile:xm(n*.98,Math.PI/6),height:1.2,x:0,y:0,z:0}),r.push({profile:xm(n*.72),height:5.4,taper:.78,x:0,y:1.2,z:0}),r.push({profile:xm(n*.58,Math.PI/6),height:1.2,taper:1.05,x:0,y:6.6,z:0}),[n*.5,n*.34,n*.18].forEach((e,t)=>{let a=t===0?12:t===1?6:1;for(let o=0;o<a;o++){let s=o/a*Math.PI*2+t%2*Math.PI/6,c={profile:xm(t===2?n*.18:n*.115,Math.PI/6),height:.34,x:Math.cos(s)*e,y:7.72+t*.22,z:Math.sin(s)*e};t%2==0?i.push(c):r.push(c)}});for(let e of[Math.PI/6,Math.PI/2,Math.PI*5/6,Math.PI*7/6,Math.PI*3/2,Math.PI*11/6])r.push({profile:$(n*.34,n*.44,n*.05),height:1.6,x:Math.cos(e)*n*.72,y:0,z:Math.sin(e)*n*.72,rotY:-e});return{parts:r,secondary:i}}function hh(e,t,n){let r=Math.min(e,t)/2,i=[],a=[],o=n?4:8.2,s=n?4.2:6.4;i.push({profile:$(e*.44,t*.52,r*.08),height:s,taper:.92,x:0,y:o,z:0}),i.push({profile:xm(r*.32),height:1.2,x:e*.12,y:o+s,z:0}),i.push({profile:$(e*.18,t*.28,r*.05),height:1.1,x:e*.28,y:o+s*.42,z:0});for(let n of[-1,1])for(let i of[-1,1]){let s=n*e*.38,c=i*t*.36,l=n*e*.18,u=i*t*.2,d=Math.atan2(i,n),f=l-s,p=u-c;a.push({profile:$(r*.34,r*.22,r*.04),height:o,taper:.72,shearX:f*Math.cos(d)-p*Math.sin(d),shearZ:f*Math.sin(d)+p*Math.cos(d),x:s,y:0,z:c,rotY:d}),a.push({profile:$(r*.46,r*.28,r*.04),height:.5,x:s,y:0,z:c,rotY:d})}if(n){let n=e*.22,r=.26,i=n/2+.2;for(let o=0;o<8;o++){let s=o/8*Math.PI*2,c=Math.cos(s)*e*.25,l=Math.sin(s)*t*.25,u=(e,t,n)=>Math.abs(t)<1e-6?1/0:(Math.sign(t)*n-e)/t,d=r/2,f=Math.min(u(c,Math.cos(s),e/2-d*Math.abs(Math.sin(s))),u(l,Math.sin(s),t/2-d*Math.abs(Math.cos(s))));a.push({profile:Sm(n,r),height:f,x:c,y:i,z:l,roll:-Math.PI/2,rotY:-s})}}else for(let n of[-r*.28,r*.28])a.push({profile:$(e*.1,t*.18,r*.03),height:2.4,x:-e*.12,y:o+s,z:n});return{parts:i,secondary:a}}function gh(e,t){let n=Math.min(e,t)/2,r=[],i=[],a=[];i.push({profile:Q(12,n),height:1,x:0,y:0,z:0}),i.push({profile:Q(12,n*.78),height:1,x:0,y:1,z:0}),i.push({profile:Q(12,n*.58),height:2.2,taper:.92,x:0,y:2,z:0}),a.push({profile:Q(16,n*.34),height:.16,x:0,y:4.24,z:0});for(let e=0;e<4;e++){let t=Math.PI/4+e*Math.PI/2,r=Math.cos(t)*n*.68,o=Math.sin(t)*n*.68;i.push({profile:xm(n*.12),height:5.6,taper:.8,x:r,y:2.2,z:o}),i.push({profile:Q(7,n*.2),height:.6,x:r,y:7.8,z:o}),a.push({profile:Q(5,n*.16),height:1.2,taper:.1,x:r,y:8.4,z:o})}for(let e=0;e<8;e++){let t=e/8*Math.PI*2;i.push({profile:$(n*.16,n*.3,n*.04),height:n*.42,x:Math.cos(t)*n*.46,y:3,z:Math.sin(t)*n*.46,roll:-Math.PI/2,rotY:-t})}return{parts:r,secondary:i,accents:a}}function _h(e,t){let n=[],r=[],i=[],a=(e,t,n=10,r=0)=>Q(n,1,r).map(([n,r])=>[n*e,r*t]),o=(e,t,n=9)=>a(e,t,n),s=-Math.PI/2,c=Math.min(e,t)*.967,l=c/2,u=c*.913,d=c*.254/9,f=e=>l+(c*.207-l)*e/8,p=e=>{let t=0;for(let n=0;n<9;n++)e<=f(n)&&(t=(n+1)*d);return t};for(let e=0;e<9;e++){let t=f(e);r.push({profile:Sm(t*2,t*2),height:d*1.02,x:0,y:e*d,z:0})}r.push({profile:Sm(c*.098,c*.175),height:c*.105,x:l-c*.054,y:0,z:0}),r.push({profile:Sm(c*.108,c*.205),height:c*.024,x:l-c*.056,y:c*.105,z:0}),r.push({profile:Sm(c*.0048,c*.083),height:c*.083,x:l-c*.0024,y:0,z:0});let m=c*.428;for(let e of[-1,1])for(let t of[-1,1]){let n=p(m),i=e*m,o=t*m,s=-Math.atan2(t,e);r.push({profile:Sm(c*.138,c*.138),height:c*.062,x:i,y:n,z:o}),r.push({profile:a(c*.052,c*.048,7),height:c*.11,taper:.9,x:i,y:n+c*.062,z:o,rotY:s}),r.push({profile:a(c*.04,c*.038,6),height:c*.055,taper:.84,x:i,y:n+c*.172,z:o,rotY:s})}let h=c*.362,g=[];for(let e of[-1,1]){for(let t of[-c*.15,0,c*.15])g.push([t,e*h]);for(let t of[-c*.15,c*.15])g.push([e*h,t])}for(let[e,t]of g){let n=p(Math.max(Math.abs(e),Math.abs(t)));r.push({profile:Sm(c*.038,c*.038),height:c*.066,x:e,y:n,z:t}),r.push({profile:Sm(c*.052,c*.052),height:c*.016,x:e,y:n+c*.066,z:t}),i.push({profile:a(c*.024,c*.024,4,Math.PI/4),height:c*.045,taper:.08,x:e,y:n+c*.082,z:t})}let _=Math.PI/10,v=c*.238,y=c*.224,b=c*.231,x=[[.299,.52],[.348,.72],[.4,.86],[.455,.95],[.514,1],[.572,1],[.627,.95],[.676,.84],[.716,.66]],S=c*.731;x.forEach(([e,t],r)=>{let i=x[r+1],o=i?i[0]*c:S,s=i?i[1]:.48;n.push({profile:a(v*t,y*t,10,_),height:(o-e*c)*1.25,taper:s/t,x:0,y:e*c,z:0})});for(let[e,t,r]of[[.9,.53,.036],[-1.15,.6,.03],[2.1,.56,.033],[-2.35,.5,.028],[1.7,.66,.026],[-.55,.44,.031]])n.push({profile:a(c*r,c*r*.85,6),height:c*r*1.3,taper:.6,x:Math.cos(e)*b*.9,y:t*c,z:Math.sin(e)*b*.9,roll:s,rotY:-e});let C=c*.585,w=v*.9;n.push({profile:o(c*.186,c*.179),height:c*.083,taper:.88,x:w,y:C,z:0,roll:s}),n.push({profile:o(c*.157,c*.152),height:c*.04,taper:.82,x:w+c*.072,y:C,z:0,roll:s}),i.push({profile:a(c*.0925,c*.0925,8,Math.PI/8),height:c*.024,taper:.97,x:w+c*.101,y:C,z:0,roll:s}),i.push({profile:a(c*.068,c*.068,8,Math.PI/8),height:c*.012,taper:.95,x:w+c*.122,y:C,z:0,roll:s}),n.push({profile:a(c*.019,c*.019,7),height:c*.01,x:w+c*.131,y:C+c*.019,z:0,roll:s}),n.push({profile:o(c*.031,c*.01),height:c*.01,x:w+c*.131,y:C-c*.017,z:0,roll:s});let T=c*.44,E=c*.306,D=(T+E)/2;n.push({profile:o(c*.093,c*.159),height:c*.079,taper:.92,x:c*.176,y:D,z:0,roll:s}),n.push({profile:o(c*.069,c*.148),height:c*.045,taper:.95,x:c*.25,y:D,z:0,roll:s}),n.push({profile:o(c*.021,c*.155),height:c*.048,taper:.95,x:c*.252,y:T,z:0,roll:s}),n.push({profile:o(c*.019,c*.15),height:c*.046,taper:.95,x:c*.252,y:E,z:0,roll:s});for(let e=0;e<7;e++)r.push({profile:Q(3,c*.019,Math.PI/2),height:c*.052,taper:.12,x:c*.291,y:T-c*.005,z:(e-3)*c*.038,roll:Math.PI});for(let e=0;e<6;e++)r.push({profile:Q(3,c*.017,-Math.PI/2),height:c*.045,taper:.14,x:c*.291,y:E+c*.005,z:(e-2.5)*c*.038});let O=[[.4,.128,-.08,.52],[.82,.14,.1,.555],[1.2,.128,.26,.6],[1.55,.145,.05,.535],[2.05,.118,.3,.575],[2.6,.098,.22,.62]];for(let e=0;e<O.length*2;e++){let t=O[e%O.length];if(!t)continue;let[n,i,a,l]=t,u=n*(e>=O.length?-1:1),d=c*i,f=Math.cos(u),p=Math.sin(u),m=[c*.042,c*.028,c*.003],h=b*.93,g=l*c;for(let e=0;e<2;e++){let t=d*(e===0?.55:.5),n=a+e*.14,i=m[e]??c*.01,l=m[e+1]??i*.4;r.push({profile:o(i*.72,i,6),height:t*1.08,taper:l/i,x:f*h,y:g,z:p*h,roll:s+n,rotY:-u}),h+=t*Math.cos(n),g+=t*Math.sin(n)}}for(let[e,t]of[[.62,.6],[-.62,.6],[1.42,.68],[-1.42,.68],[2.3,.64],[-2.3,.64]])r.push({profile:o(c*.011,c*.014,5),height:c*.036,taper:.1,x:Math.cos(e)*b*.95,y:t*c,z:Math.sin(e)*b*.95,roll:s+.35,rotY:-e});[.8,.836,.862,.878,.885,.878,.862,.836,.8].forEach((e,t)=>{let r=-1.9+t*.475,i=Math.cos(r),o=Math.sin(r),l=[[b*.72,c*.672],[b*.82,c*(.672+(e-.672)*.55)],[b*.88,c*e]],u=[c*.0155,c*.0097,c*.0017];for(let e=0;e<2;e++){let t=l[e],d=l[e+1];if(!t||!d)continue;let f=d[0]-t[0],p=d[1]-t[1],m=u[e]??c*.008,h=u[e+1]??m*.4;n.push({profile:a(m,m,5),height:Math.hypot(f,p)*1.08,taper:h/m,x:i*t[0],y:t[1],z:o*t[0],roll:s+Math.atan2(p,f),rotY:-r})}});let k=-c*.055,A=c*.203,j=c*.197,M=[[.6345,.733],[.6655,.858],[.6966,.943],[.7241,.987],[.7517,1],[.7862,.977],[.8207,.907],[.8517,.792],[.8793,.622],[.8965,.45],[.9069,.28]];M.forEach(([e,t],n)=>{let i=M[n+1],o=i?i[0]*c:u,s=i?i[1]:.06;r.push({profile:a(A*t,j*t,10),height:(o-e*c)*(i?1.2:1),taper:s/t,x:k,y:e*c,z:0})});let N=e=>{let t=M[0]?.[1]??1;for(let[n,r]of M)e>=n&&(t=r);return t};for(let[e,t]of[[.745,1],[.8,.97],[.858,.79]])n.push({profile:a(A*t*1.03,j*t*1.03,10),height:c*.011,x:k,y:e*c,z:0});for(let e=0;e<8;e++){let t=(e+.5)/8*Math.PI*2,r=Math.cos(t),i=Math.sin(t);for(let[e,t]of[[.672,.752],[.752,.878]]){let o=N(e)*1.02,s=N(t)*1.02,l=r*A*o,u=i*j*o;n.push({profile:a(c*.0097,c*.0097,4),height:(t-e)*c,shearX:r*A*s-l,shearZ:i*j*s-u,x:k+l,y:e*c,z:u})}}let P=[c*.038,c*.033,c*.027,c*.02];for(let e=0;e<10;e++){let t=(e+.5)/10*Math.PI*2,r=Math.cos(t),i=Math.sin(t),o=c*(.28+e%3*.035),l=[[c*.134,c*.366],[c*.214,c*.328],[c*.262,c*.252],[o,p(o)]];for(let e=0;e<l.length-1;e++){let o=l[e],u=l[e+1];if(!o||!u)continue;let d=u[0]-o[0],f=u[1]-o[1],p=P[e]??c*.02,m=P[e+1]??p*.8;n.push({profile:a(p,p,5),height:Math.hypot(d,f)*1.06,taper:m/p,x:r*o[0],y:o[1],z:i*o[0],roll:s+Math.atan2(f,d),rotY:-t})}}return{parts:n,secondary:r,accents:i}}function vh(e,t,n,r){switch(e){case`processing-node`:return mh(t,n);case`mobile-factory`:return hh(t,n,r);case`slime-temple`:return gh(t,n);case`ancient-deity-structure`:return _h(t,n)}}var yh=[`processing-node`,`mobile-factory`,`slime-temple`,`ancient-deity-structure`],bh={"processing-node":`machines`,"mobile-factory":`machines`,"slime-temple":`ancients`,"ancient-deity-structure":`ancients`},xh={"slime-temple":6877280},Sh=[!1,!0];function Ch(e){return xh[e]??tm(bh[e])}var wh=class{group=new xn;meshes=[];matrix=new Kt;colour=new Y;constructor(e){for(let t of yh){let n=Id[t];for(let r of Sh){let i=vh(t,n.width,n.depth,r),a=Math.max(8,e.filter(e=>e.kind===t&&e.deployed===r).length+8),o=new ai(Cm(i.parts),new Ya({color:16777215,flatShading:!0}),a);o.frustumCulled=!1;let s;i.secondary&&i.secondary.length>0&&(s=new ai(Cm(i.secondary),new Ya({color:16777215,flatShading:!0}),a),s.frustumCulled=!1);let c;i.accents&&i.accents.length>0&&(c=new ai(Cm(i.accents),new Ya({color:Ch(t),flatShading:!0}),a),c.frustumCulled=!1),this.meshes.push({kind:t,deployed:r,body:o,secondary:s,accent:c}),this.group.add(o),s&&this.group.add(s),c&&this.group.add(c)}}this.sync(e)}sync(e){for(let t of this.meshes){let n=e.filter(e=>e.kind===t.kind&&e.deployed===t.deployed),r=bh[t.kind];for(let e=0;e<t.body.count;e++){let i=n[e];if(!i)this.matrix.makeScale(0,0,0);else{this.matrix.identity(),this.matrix.setPosition(i.x,Nu,i.z);let n=i.deployed?1:.7;this.colour.setHex($p(r)).multiplyScalar(n),t.body.setColorAt(e,this.colour),t.secondary&&(this.colour.setHex(em(r)).multiplyScalar(n),t.secondary.setColorAt(e,this.colour))}t.body.setMatrixAt(e,this.matrix),t.secondary?.setMatrixAt(e,this.matrix),t.accent?.setMatrixAt(e,this.matrix)}t.body.instanceMatrix.needsUpdate=!0,t.body.instanceColor&&(t.body.instanceColor.needsUpdate=!0),t.secondary&&(t.secondary.instanceMatrix.needsUpdate=!0,t.secondary.instanceColor&&(t.secondary.instanceColor.needsUpdate=!0)),t.accent&&(t.accent.instanceMatrix.needsUpdate=!0,t.accent.instanceColor&&(t.accent.instanceColor.needsUpdate=!0))}}dispose(){for(let e of this.meshes)e.body.geometry.dispose(),Th(e.body.material),e.secondary&&(e.secondary.geometry.dispose(),Th(e.secondary.material)),e.accent&&(e.accent.geometry.dispose(),Th(e.accent.material))}};function Th(e){Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}var Eh=256,Dh=32,Oh=Nu+.12,kh=.79,Ah=.61,jh=class{group=new xn;buildings;units;structures;matrix=new Kt;scale=new K;constructor(e,t,n){let r=()=>new Ya({color:1512978,flatShading:!0,transparent:!0,opacity:.24,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1});this.buildings=new ai(new vi(1,.12,1),r(),Math.max(e.buildings.length,1)),this.units=new ai(new yi(1,12),r(),Eh),this.structures=new ai(new vi(1,.12,1),r(),Dh);for(let e of[this.buildings,this.units,this.structures])e.frustumCulled=!1;this.group.add(this.buildings,this.units,this.structures),this.sync(e,t,n)}sync(e,t,n){e.buildings.forEach((e,t)=>{let n=e.state===`intact`?e.height:e.state===`damaged`?e.height*.55:0;if(n<=0)this.matrix.makeScale(0,0,0);else{let t=n*.48,r=e.rotation??0,i=hu({x:kh,z:Ah},-r),a=hu({x:i.x*t*.5,z:i.z*t*.5},r);this.matrix.makeRotationY(-r),this.scale.set(e.width+Math.abs(i.x)*t,.12,e.depth+Math.abs(i.z)*t),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+a.x,Oh,e.z+a.z)}this.buildings.setMatrixAt(t,this.matrix)}),this.buildings.instanceMatrix.needsUpdate=!0;let r=0;for(let e of t.units){if(r>=this.units.count)break;let n=Ef(t.typeOf(e));this.matrix.makeRotationX(-Math.PI/2),this.scale.set(n*.9,n*.62,1),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+n*.22,Oh+.03,e.z+n*.16),this.units.setMatrixAt(r++,this.matrix)}for(let e=r;e<this.units.count;e++)this.units.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.units.instanceMatrix.needsUpdate=!0;let i=0;for(let e of n){if(i>=this.structures.count)break;let t=Id[e.kind],n=(e.kind===`slime-temple`?22:14)*.48;this.matrix.makeScale(t.width+kh*n,.12,t.depth+Ah*n),this.matrix.setPosition(e.x+kh*n*.5,Oh+.02,e.z+Ah*n*.5),this.structures.setMatrixAt(i++,this.matrix)}for(let e=i;e<this.structures.count;e++)this.structures.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.structures.instanceMatrix.needsUpdate=!0}dispose(){for(let e of[this.buildings,this.units,this.structures])e.geometry.dispose(),e.material.dispose()}},Mh=2400,Nh=7e3,Ph=class{scene=new An;city;units;structures;shadows;constructor(e,t,n=[]){this.scene.background=new Y(sh.sky),this.scene.fog=new kn(sh.sky,Mh,Nh),this.shadows=new jh(e,t,n),this.scene.add(this.shadows.group),this.city=new ph(e),this.scene.add(this.city.group),this.units=new qm(t),this.scene.add(this.units.group),this.structures=new wh(n),this.scene.add(this.structures.group);let r=new ko(16774102,2.05);r.position.set(-.45,1,-.35).normalize(),this.scene.add(r),this.scene.add(new mo(sh.sky,7236170,1))}dispose(){this.city.dispose(),this.units.dispose(),this.structures.dispose(),this.shadows.dispose(),this.scene.clear()}},Fh=[1,2,3,4,5,6,7,8,9,0],Ih=class{ids=[];groups=new Map;get size(){return this.ids.length}list(){return this.ids}has(e){return this.ids.includes(e)}primary(){return this.ids[0]}set(e){this.ids=[...new Set(e)].sort((e,t)=>e-t)}add(e){this.set([...this.ids,...e])}toggle(e){this.set(this.has(e)?this.ids.filter(t=>t!==e):[...this.ids,e])}clear(){this.ids=[]}assignGroup(e,t=this.ids){Fh.includes(e)&&this.groups.set(e,[...t])}recallGroup(e){let t=this.groups.get(e);return!t||t.length===0?!1:(this.set(t),!0)}groupSize(e){return this.groups.get(e)?.length??0}occupiedGroups(){return Fh.filter(e=>this.groupSize(e)>0)}prune(e){this.ids=this.ids.filter(e);for(let[t,n]of this.groups){let r=n.filter(e);r.length!==n.length&&(r.length===0?this.groups.delete(t):this.groups.set(t,r))}}},Lh=1213353265,Rh=250,zh=85,Bh=100,Vh=1800,Hh=80,Uh=3;function Wh(e,t,n){let r,i=1/0;for(let a of e.buildings){if(a.state===`rubble`)continue;let e=(a.x-t)**2+(a.z-n)**2;e<i&&(i=e,r=a.id)}return r}var Gh=class{windowTicks;ticks=[];earned=[];total=0;last=null;constructor(e=360){this.windowTicks=e}add(e,t){for(this.last!==null&&t>this.last&&(this.total+=t-this.last),this.last=t,this.ticks.push(e),this.earned.push(this.total);this.ticks.length>1&&e-(this.ticks[0]??e)>this.windowTicks;)this.ticks.shift(),this.earned.shift()}get perMinute(){if(this.ticks.length<2)return 0;let e=(this.ticks.at(-1)??0)-(this.ticks[0]??0);return e<=0?0:((this.earned.at(-1)??0)-(this.earned[0]??0))/e*30*60}};function Kh(e){switch(e.kind){case`produced`:return`${(e.subject??`UNIT`).toUpperCase()} READY`;case`productionQueued`:return`BUILDING ${(e.subject??`UNIT`).toUpperCase()}`;case`productionRefused`:return`INSUFFICIENT HUMANS`;case`built`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`buildRefused`:return`CANNOT BUILD HERE`;case`tier2`:return`TIER 2 UNLOCKED`;case`tier2Refused`:return`TIER 2 UNAVAILABLE`;case`structureDown`:return`STRUCTURE DOWN`;case`civiliansDisplaced`:return`${e.count??0} HUMANS DISPLACED`;case`deposited`:return null}}function qh({world:e,renderer:t,overlayEl:n,boxEl:r,store:i,onLoadRequested:a,onSeedStepRequested:o}){let s=new Pd(e),c=new Ph(e.city,e.army,e.structures),l=e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction),u=e.city.startAnchors[e.playerFaction===`machines`?0:1]??{x:0,z:0},d=l.length>0?{x:l.reduce((e,t)=>e+t.x,0)/l.length,z:l.reduce((e,t)=>e+t.z,0)/l.length}:u,f=new lp(window.innerWidth/window.innerHeight,d),p=new pu(t.domElement),m=new Ih,h=new Wp(n),g=new Hp,_=new Gh,v=new Gh,y=new Kp(document.body,e.city,e.population,e.populationCapacity),b=new um(document.body,e.city,e.army,e.population,e.populationCapacity,e.playerFaction);c.scene.add(b.group);let x=new ym;c.scene.add(x.group);let S=null,C=0,w=(e,t)=>{S=e,C=t+Vh},T=new hp(document.body,Pp({world:e,selected:0,banner:null}),t=>{t===`cancel`&&m.size>0?e.enqueue({kind:`stop`,unitIds:m.list()}):t===`primary`&&m.size>0&&e.playerFaction===`machines`&&e.enqueue({kind:`deploy`,unitIds:m.list()})}),E=Bh,D=()=>{t.setSize(window.innerWidth,window.innerHeight),f.setAspect(window.innerWidth/window.innerHeight)};window.addEventListener(`resize`,D);let O=new G,k=t=>{let n=th(f.camera,e.city,t);return Bd(n===void 0?void 0:e.city.get(n),e.population)?n:void 0},A=0,j=null,M=0,N=0,P=30,F=Rh,I=0,ee=0,te=0,ne=!1,re=!1,ie=!0,ae=0,oe=!1,L=n=>{if(oe)return;let l=j===null?1e3/60:n-j;j=n,g.add(l),p.sample(),f.update(p,l/1e3);let u=p.selectGesture;if(u)if(u.isBox){let t=rh(f.camera,e.army,u.rect).filter(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});u.additive?m.add(t):m.set(t)}else{O.set((u.rect.x0+u.rect.x1)/2,(u.rect.y0+u.rect.y1)/2);let t=$m(f.camera,e.army,O),r=t===void 0?void 0:e.army.get(t),i=r&&e.army.typeOf(r).faction===e.playerFaction?t:void 0;if(r&&i===void 0)u.additive||m.clear();else if(i===void 0){let t=m.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),r=Zm(f.camera,e.crowds.all,O),i=k(O);t.length>0&&r!==void 0?(e.enqueue({kind:`harvest`,unitIds:t,crowdId:r}),w(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):t.length>0&&i!==void 0?(e.enqueue({kind:`harvest`,unitIds:t,buildingId:i}),w(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):u.additive||m.clear()}else u.additive?m.toggle(i):m.set([i])}for(let e of Fh){let t=p.pressModifiers(`Digit${e}`);t&&(t.shift?m.assignGroup(e):m.recallGroup(e))}if(p.wasPressed(`Escape`)&&m.clear(),p.wasPressed(`KeyP`)&&(ie=!0),p.wasPressed(`KeyU`)&&y.toggle(),p.wasPressed(`BracketLeft`)&&o(-1),p.wasPressed(`BracketRight`)&&o(1),p.orderAt&&m.size>0){let t=m.list(),r=t.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),i=Zm(f.camera,e.crowds.all,p.orderAt),a=k(p.orderAt);if(r.length>0&&i!==void 0)e.enqueue({kind:`harvest`,unitIds:r,crowdId:i}),w(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else if(r.length>0&&a!==void 0)e.enqueue({kind:`harvest`,unitIds:r,buildingId:a}),w(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else{let n=Qm(f.camera,p.orderAt);n&&e.enqueue({kind:`move`,unitIds:t,x:n.x,z:n.z})}}if(p.wasPressed(`KeyQ`)&&m.size>0&&e.enqueue({kind:`stop`,unitIds:m.list()}),p.wasPressed(`KeyX`)){let t=Wh(e.city,f.focus.x,f.focus.z);t!==void 0&&e.enqueue({kind:`damage`,buildingId:t})}if(p.wasPressed(`KeyZ`)&&e.enqueue({kind:`raze`,x:f.focus.x,z:f.focus.z,radius:zh}),p.wasPressed(`KeyB`)){A=(A+1)%Du.length;let t=Du[A];e.enqueue({kind:`setAllStates`,state:t})}if(p.wasPressed(`KeyH`)&&e.enqueue({kind:`debugResources`,humans:Hh,charge:0}),p.wasPressed(`KeyJ`)&&e.enqueue({kind:`debugResources`,humans:0,charge:Uh}),p.wasPressed(`KeyE`)&&m.size>0){let t=Wh(e.city,f.focus.x,f.focus.z);t!==void 0&&Bd(e.city.get(t),e.population)&&(e.enqueue({kind:`harvest`,unitIds:m.list(),buildingId:t}),w(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n))}if(p.wasPressed(`KeyR`)&&m.size>0&&e.enqueue({kind:`deploy`,unitIds:m.list()}),p.wasPressed(`KeyT`)&&e.enqueue({kind:`unlockTier2`}),p.wasPressed(`KeyF`)||p.wasPressed(`KeyG`)){let t=e.structures.find(t=>t.faction===e.playerFaction&&t.deployed&&(t.kind===`mobile-factory`||t.kind===`slime-temple`)),r=e.playerFaction===`machines`?`machine-infantry`:`ancient-infantry`,i=e.playerFaction===`machines`?`machine-construct`:`ancient-support`;t?e.enqueue({kind:`produce`,structureId:t.id,typeId:p.wasPressed(`KeyG`)?i:r}):w(`NO DEPLOYED FACTORY`,n)}if(p.wasPressed(`KeyC`)||p.wasPressed(`KeyM`)){let t=e.playerFaction===`ancients`?`slime-temple`:p.wasPressed(`KeyM`)?`mobile-factory`:`processing-node`;e.enqueue({kind:`build`,structure:t,x:f.focus.x,z:f.focus.z})}if(p.wasPressed(`KeyV`)){let t=e.structures.find(t=>t.faction===e.playerFaction&&t.kind===`mobile-factory`);t&&e.enqueue({kind:`deployStructure`,structureId:t.id})}if(p.wasPressed(`F5`)&&i){let t=Qf(e);w(`SAVING`,n),i.put(t,Date.now()).then(()=>w(`SAVED · STEP ${t.tick}`,performance.now())).catch(e=>{console.error(`save failed`,e),w(`SAVE FAILED`,performance.now())})}if(p.wasPressed(`F9`)&&a(),p.dragRect){let e=p.dragRect;r.style.display=`block`,r.style.left=`${(e.x0+1)/2*100}%`,r.style.top=`${(1-e.y1)/2*100}%`,r.style.width=`${(e.x1-e.x0)/2*100}%`,r.style.height=`${(e.y1-e.y0)/2*100}%`}else r.style.display=`none`;p.consume();let d=performance.now(),D=s.advance(l),se=e.drainChangedBuildings();if(se.length>0)if(I=performance.now()-d,ie=!0,se.length>8)c.city.refreshAll();else for(let e of se)c.city.refresh(e);for(let t of e.drainEvents()){let e=Kh(t);e&&w(e,n)}m.prune(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction}),c.units.sync(e.army,D,e=>m.has(e)),c.structures.sync(e.structures),c.shadows.sync(e.city,e.army,e.structures),x.sync(e.crowds.all,D,e.tick,e.army),y.sync(f.camera);let ce=m.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),le=ce.length>0?k(p.pointer):void 0;if(b.sync(f.camera,e.tick,ce.length>0,le),t.render(c.scene,f.camera),E+=l,E>=Bh&&(E=0,S!==null&&n>C&&(S=null),T.render(Pp({world:e,selected:m.size,banner:S}))),N+=l,N>=1e3&&(P=(s.stepCount-M)/N*1e3,M=s.stepCount,N=0),_.add(e.tick,e.resources.humans),v.add(e.tick,e.resources.charge),F+=l,F>=Rh){if(F=0,ie){ie=!1;let t=e.city.startAnchors[0];if(t){let n={x:f.focus.x,z:f.focus.z},r=e.nav.onShardCells,i=e.nav.flood(t.x,t.z,`small`,n),a=e.nav.flood(t.x,t.z,`large`,n);ee=i.count/r,te=a.count/r,ne=i.reachedTarget,re=a.reachedTarget}}let[t,n,r]=e.destructionCounts();h.render({faction:_f[e.playerFaction].name,seed:e.seed,fps:g.fps,simHz:P,stepCount:e.tick,droppedMs:s.droppedMs,alpha:D,hash:e.hash(),zoomFraction:f.zoomFraction,pitchDeg:f.pitchDeg,distance:f.camera.position.distanceTo(f.focus),focusX:f.focus.x,focusZ:f.focus.z,cityBuildings:e.city.buildings.length,cityIntact:t??0,cityDamaged:n??0,cityRubble:r??0,cityHash:e.city.hash(),populationLabels:y.enabled,units:e.army.units.length,unitsMoving:e.army.countMoving(),unitsBlocked:e.army.countBlocked(),unitsUnreached:e.army.countUnreached(),unitsStalled:e.army.countStalled(),selected:m.size,groups:m.occupiedGroups(),pathsQueued:e.army.pending,pathsTotal:e.army.pathsTotal,navCells:e.nav.cellCount,navRebuilds:e.nav.rebuildCount,navLastRebuildCells:e.nav.lastRebuildCells,navRebuildMs:I,smallPassable:e.nav.passableFraction(`small`),largePassable:e.nav.passableFraction(`large`),reachSmall:ee,reachLarge:te,atFocusSmall:ne,atFocusLarge:re,humans:e.resources.humans,humansCap:e.resources.humansCap,charge:e.resources.charge,chargeCap:e.resources.chargeCap,chargeSegments:e.resources.segmentsReady,techTier:e.techTier,humansPerMinute:_.perMinute,chargePerMinute:v.perMinute,cargoInTransit:e.cargoInTransit(),populationRemaining:e.remainingPopulation(),populationTotal:e.populationCapacity.reduce((e,t)=>e+t,0),structures:e.structures.filter(t=>t.faction===e.playerFaction).length,queued:e.queuedProduction(),civilianCrowds:e.crowds.all.length,civilianHumans:e.crowds.totalHumans(),harvesting:e.army.units.filter(Of).length,harvestIdle:e.harvestersIdle(),unitsDeployed:e.army.countDeployed(),unitsDeploying:e.army.countDeploying()},g)}ae=requestAnimationFrame(L)};return ae=requestAnimationFrame(L),{dispose(){oe=!0,cancelAnimationFrame(ae),window.removeEventListener(`resize`,D),p.dispose(),T.dispose(),c.dispose(),y.dispose(),b.dispose(),x.dispose(),r.style.display=`none`}}}async function Jh(){let e=document.getElementById(`overlay`),t=document.getElementById(`overlay-content`),n=document.getElementById(`overlay-toggle`),r=document.getElementById(`selectbox`);if(!e||!t||!(n instanceof HTMLButtonElement)||!r)throw Error(`overlay controls or #selectbox missing from index.html`);n.addEventListener(`click`,()=>{let t=e.classList.toggle(`minimized`);n.textContent=t?`+`:`−`,n.title=t?`Restore developer panel`:`Minimize developer panel`,n.setAttribute(`aria-expanded`,String(!t))});let i=new lu({antialias:!0,powerPreference:`high-performance`});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(i.domElement);let a=op.available?new op:null;a||console.warn(`IndexedDB unavailable; saving is disabled for this session`);let o=null,s=e=>{o?.dispose(),o=qh({world:e,renderer:i,overlayEl:t,boxEl:r,store:a,onLoadRequested:c,onSeedStepRequested:t=>{let n=e.seed+t>>>0;queueMicrotask(()=>s(new Xf(n,e.playerFaction)))}})},c=()=>{a&&a.get().then(e=>{if(!e){console.warn(a.lastRejection??`no save to load`);return}s($f(e.envelope))}).catch(e=>console.error(`load failed`,e))},l=new URLSearchParams(window.location.search).get(`faction`);if(l===`machines`||l===`ancients`){s(new Xf(Lh,l));return}let u=a?await a.get().catch(()=>void 0):void 0,d=new Lp(document.body,{saved:u&&{faction:u.envelope.playerFaction,tick:u.envelope.tick,clock:Mp(u.envelope.tick)},onStart:e=>{d.dispose(),s(new Xf(Lh,e))},onResume:()=>{d.dispose(),c()}})}Jh();
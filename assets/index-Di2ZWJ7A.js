...
`,document.head.append(e)}var Mg=.6,Ng=1.8,Pg=2696995,Fg=Ru+Ng/2;function Ig(){return new bi(Mg,Ng,Mg)}function Lg(){return new $a({color:Pg,flatShading:!0})}var Rg=8,zg=96;function Bg(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var Vg=class{city;army;population;group=new Sn;highlight;civilians;matrix=new qt;highlightGeometry=new Map;constructor(e,t,n){this.city=e,this.army=t,this.population=n,this.highlight=new Jr(new Tr,new $a({color:16719904,flatShading:!0,transparent:!0,opacity:.32,depthWrite:!1,side:2})),this.highlight.visible=!1,this.highlight.renderOrder=7,this.group.add(this.highlight),this.civilians=new oi(Ig(),Lg(),zg),this.civilians.instanceMatrix.setUsage(Be),this.civilians.count=0,this.civilians.frustumCulled=!1,this.group.add(this.civilians)}sync(e,t,n){let r=0,i=!1;for(let t of this.army.units){let n=t.harvestingBuildingId,a=n===null?void 0:this.city.get(n);if(!Wd(a,this.population)||Gd(t.x,t.z,a)>22**2)continue;let o=t.x-a.x,s=t.z-a.z,c=Math.max(Math.hypot(o,s),1),l=yu({x:o/c,z:s/c},-(a.rotation??0)),u=Math.min(Math.abs(l.x)>.001?a.width/2/Math.abs(l.x):1/0,Math.abs(l.z)>.001?a.depth/2/Math.abs(l.z):1/0),d=a.x+o/c*u,f=a.z+s/c*u;for(let n=0;n<Rg&&r<zg;n++){let a=(e+n*5+t.id*11)%30/30,l=(n%3-1)*1.7,u=d+(t.x-d)*a-s/c*l,p=f+(t.z-f)*a+o/c*l;this.matrix.makeTranslation(u,Fg,p),i=Bg(this.civilians,r++,this.matrix)||i}}this.civilians.count=r,i&&(this.civilians.instanceMatrix.needsUpdate=!0);let a=n===void 0?void 0:this.city.get(n),o=Wd(a,this.population)?a:void 0;this.highlight.visible=t&&o!==void 0,t&&o&&(this.highlight.geometry=this.geometryFor(o))}dispose(){for(let e of this.highlightGeometry.values())e.dispose();this.highlight.material.dispose(),this.civilians.geometry.dispose(),this.civilians.material.dispose()}geometryFor(e){let t=`${e.id}:${e.state}`,n=this.highlightGeometry.get(t);if(n)return n;let r=Math.max(e.height*(e.state===`intact`?1:e.state===`damaged`?.54:.06),2.2),i=Ug(Hg(e.clip??this.rectangleFootprint(e),1.02),Ru+.15,Ru+r);return this.highlightGeometry.set(t,i),i}rectangleFootprint(e){let t=e.width/2,n=e.depth/2;return[{x:-t,z:-n},{x:t,z:-n},{x:t,z:n},{x:-t,z:n}].map(t=>{let n=yu(t,e.rotation??0);return{x:e.x+n.x,z:e.z+n.z}})}};function Hg(e,t){let n=0,r=0;for(let t of e)n+=t.x,r+=t.z;return n/=e.length,r/=e.length,e.map(e=>({x:n+(e.x-n)*t,z:r+(e.z-r)*t}))}function Ug(e,t,n){let r=[],i=e.map(e=>new G(e.x,e.z));for(let e of Fa.triangulateShape(i,[])){let a=i[e[0]??-1],o=i[e[1]??-1],s=i[e[2]??-1];!a||!o||!s||(r.push(a.x,n,a.y,o.x,n,o.y,s.x,n,s.y),r.push(s.x,t,s.y,o.x,t,o.y,a.x,t,a.y))}for(let e=0;e<i.length;e++){let a=i[e],o=i[(e+1)%i.length];a&&o&&r.push(a.x,t,a.y,a.x,n,a.y,o.x,t,o.y,o.x,t,o.y,a.x,n,a.y,o.x,n,o.y)}let a=new Tr;return a.setAttribute(`position`,new ur(new Float32Array(r),3)),a.computeVertexNormals(),a}var Wg=2,Gg=32,Kg=640,qg=5,Jg=1.6,Yg=8;function Xg(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var Zg=class{group=new Sn;figures;matrix=new qt;constructor(){this.figures=new oi(Ig(),Lg(),Kg),this.figures.instanceMatrix.setUsage(Be),this.figures.count=0,this.figures.frustumCulled=!1,this.group.add(this.figures)}sync(e,t,n,r){let i=0,a=!1,o=new Map;for(let e of r.units){if(e.harvestingCrowdId===null)continue;let t=o.get(e.harvestingCrowdId);t?t.push(e):o.set(e.harvestingCrowdId,[e])}for(let r of e){let e=r.prevX+(r.x-r.prevX)*t,s=r.prevZ+(r.z-r.prevZ)*t,c=r.trailDirX,l=r.trailDirZ,u=Math.min(Math.max(1,Math.ceil(r.humans/Wg)),Gg),d=2.4+Math.sqrt(u)*1.5,f=(o.get(r.id)??[]).filter(e=>Ud(e.x,e.z,r.x,r.z)<=22**2),p=Math.min(u,f.length*Yg);for(let o=0;o<u&&!(i>=Kg);o++){let u=(Qg(r.id*31+o*7+1)*2-1)*d,m=(Qg(r.id*17+o*13+2)*2-1)*d,h=o%qg*Jg*r.trailStrength,g=e+u-c*h,_=s+m-l*h;if(o<p){let e=f[o%f.length],r=e.prevX+(e.x-e.prevX)*t,i=e.prevZ+(e.z-e.prevZ)*t,a=(n+o*5+e.id*11)%30/30;this.matrix.makeTranslation(g+(r-g)*a,Fg,_+(i-_)*a)}else this.matrix.makeTranslation(g,Fg,_);a=Xg(this.figures,i++,this.matrix)||a}if(i>=Kg)break}this.figures.count=i,a&&(this.figures.instanceMatrix.needsUpdate=!0)}dispose(){this.figures.geometry.dispose(),this.figures.material.dispose()}};function Qg(e){let t=Math.sin(e*127.1)*43758.5453;return t-Math.floor(t)}var $g=48,e_=class{group=new Sn;preview=new Sn;previewTypeId=null;sites=new Map;constructor(){this.group.add(this.preview)}sync(e,t,n,r){e?(this.previewTypeId!==e.structureTypeId&&this.replacePreview(e.structureTypeId),this.preview.visible=!0,this.preview.position.set(e.x,.1,e.z),this.tint(this.preview,t?7729818:15749714,.48)):this.preview.visible=!1;let i=new Set(n.map(e=>e.builderId));for(let[e,t]of this.sites)i.has(e)||(this.group.remove(t.group),i_(t.group),this.sites.delete(e));for(let e of n){let t=this.sites.get(e.builderId);t||(t=this.siteGroup(e),this.sites.set(e.builderId,t),this.group.add(t.group)),t.group.position.set(e.x,.12,e.z);let n=r_(e.summoning?1-e.remainingSteps/Math.max(Sf(e.structureTypeId).constructionSteps??1,1):0,0,1);this.animateSite(t,n,r)}}dispose(){i_(this.group),this.sites.clear()}replacePreview(e){i_(this.preview),this.preview.clear(),this.preview.add(n_(e).group),this.previewTypeId=e}siteGroup(e){let t=Sf(e.structureTypeId).anchoredFootprint,n=Math.hypot((t?.width??18)/2,(t?.depth??18)/2)+2,r=new Sn,i=t_(n),a=n_(e.structureTypeId),o=bm(e.structureTypeId);return i.group.position.y=o.minY+o.height*.5,r.add(i.group,a.group),{group:r,circle:i.group,circleMaterials:i.materials,progressGeometry:i.progressGeometry,progressMaterial:i.progressMaterial,ghostMaterial:a.material}}animateSite(e,t,n){let r=n*.0024+e.group.id*.73,i=.16+t*.68,a=Math.sin(r)*(.13-t*.05);e.ghostMaterial.opacity=r_(i+a,.06,.92);let o=.27+t*.22+Math.sin(r*1.4)*.08;for(let t of e.circleMaterials)t.opacity=r_(o,.12,.62);e.progressMaterial.opacity=r_(o+.2,.3,.82),e.progressGeometry.setDrawRange(0,Math.round(t*$g)*6);let s=1+Math.sin(r*1.4)*.035;e.circle.scale.setScalar(s),e.circle.rotation.y=r*.15}tint(e,t,n){e.traverse(e=>{!(e instanceof Jr)||!(e.material instanceof $a)||(e.material.color.setHex(t),e.material.opacity=n)})}};function t_(e){let t=new Sn,n=[],r=e=>{let t=new $a({color:15786104,flatShading:!0,transparent:!0,opacity:e,depthWrite:!1,side:2});return n.push(t),t},i=(e,t,n)=>{let i=new Jr(new Ba(e,t,48),r(n));return i.rotation.x=-Math.PI/2,i.renderOrder=12,i};t.add(i(e-.62,e,.48),i(e*.56,e*.68,.38));let a=new Ba(e*.3,e*.42,$g);a.setDrawRange(0,0);let o=new $a({color:15786104,flatShading:!0,transparent:!0,opacity:.72,depthWrite:!1,side:2}),s=new Jr(a,o);s.rotation.x=-Math.PI/2,s.renderOrder=14,t.add(s);for(let n=0;n<8;n++){let i=n/8*Math.PI*2,a=new Jr(new bi(.36,.08,e*.18),r(.42));a.position.set(Math.sin(i)*e*.79,.03,Math.cos(i)*e*.79),a.rotation.y=i,a.renderOrder=13,t.add(a)}return{group:t,materials:n,progressGeometry:a,progressMaterial:o}}function n_(e){let t=_m(e),n=new Sn,r=new $a({color:14263807,flatShading:!0,transparent:!0,opacity:.48,depthWrite:!1});return n.add(new Jr(Gp([...t.parts??[],...t.secondary??[],...t.accents??[]]),r)),{group:n,material:r}}function r_(e,t,n){return Math.max(t,Math.min(n,e))}function i_(e){e.traverse(e=>{e instanceof Jr&&(e.geometry.dispose(),e.material instanceof $a&&e.material.dispose())})}var a_=[13215870,13215870,13215870,11570272,11570272,10580815,10580815,14208942,13878668,9408867,6317130],o_=[11028540,3493995,14209990,7307086,9072296,4145992],s_={sky:12048612,skyHorizon:14872553,shardTop:10323041,cliff:[11100220,9260336,7289894],road:10659477,sidewalk:13027512,parking:10132878,laneMarking:14205527,crosswalk:14672082,park:8362574,tree:5204788,treeTrunk:7360569,rubble:12892060,greeble:11118485},c_={intact:1,damaged:.54,rubble:.06},l_=.8,u_=3;function d_(e,t={}){return new $a({color:e,flatShading:!0,...t})}function f_(e){let t=new bi(1,1,1,1,e,1).toNonIndexed(),n=t.getAttribute(`position`),r=new Float32Array(n.count*3);for(let t=0;t<n.count;t+=3){let i=(n.getY(t)+n.getY(t+1)+n.getY(t+2))/3,a=Math.floor((i+.5)*e)%2==0?1:l_;for(let e=0;e<3;e++)r[(t+e)*3]=a,r[(t+e)*3+1]=a,r[(t+e)*3+2]=a}return t.setAttribute(`color`,new ur(r,3)),t}var p_=class{city;group=new Sn;buildingMeshList=[];slots=new Map;greebles;greebleStart=new Map;debris;matrix=new qt;color=new Y;scale=new K;clipped;clippedState=``;constructor(e){this.city=e;for(let e of this.buildShardTops())this.group.add(e);for(let e of this.buildCliffBands())this.group.add(e);this.group.add(this.buildPads(`built`,s_.sidewalk,Ru)),this.group.add(this.buildPads(`parking`,s_.parking,Ru)),this.group.add(this.buildPads(`park`,s_.sidewalk,Ru)),this.group.add(this.buildParkland()),this.group.add(this.buildRoads());for(let e of this.buildFragmentOverlays())this.group.add(e);let t=this.buildStripes([...this.city.centreLines,...this.city.decorativeFragments.flatMap(e=>e.centreLines)],s_.laneMarking,1.1);t.name=`centre-lines`,this.group.add(t);let n=this.buildStripes(this.city.crosswalks,s_.crosswalk,1.1);n.name=`crosswalks`,this.group.add(n),this.group.add(this.buildTrees()),this.group.add(this.buildCars()),this.group.add(this.buildEdgeRubble());let r=new Map;for(let e of this.city.buildings){if(e.clip)continue;let t=ju(e.height,e.district),n=r.get(t);n?n.push(e):r.set(t,[e])}for(let[e,t]of r){let n=new oi(f_(e),d_(16777215,{vertexColors:!0}),t.length);n.frustumCulled=!1,n.userData.storeys=e,this.buildingMeshList.push(n),this.group.add(n),t.forEach((e,t)=>this.slots.set(e.id,{mesh:n,index:t}))}let i=0;for(let t of e.buildings)this.greebleStart.set(t.id,i),i+=t.greebles;this.greebles=new oi(new bi(1,1,1),d_(s_.greeble),Math.max(i,1)),this.greebles.frustumCulled=!1,this.group.add(this.greebles),this.debris=new oi(new bi(1,1,1),d_(s_.rubble),Math.max(e.buildings.length*u_,1)),this.debris.frustumCulled=!1,this.group.add(this.debris),this.refreshAll()}buildShardTops(){return[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)].map((e,t)=>{let n=e[0];if(!n)throw Error(`city boundary is empty`);let r=new ea;r.moveTo(n.x,-n.z);for(let t=1;t<e.length;t++){let n=e[t];n&&r.lineTo(n.x,-n.z)}r.closePath();let i=new Jr(new Va(r),d_(s_.shardTop));return i.rotation.x=-Math.PI/2,i.name=t<this.city.surfaces.length?`shard-top-${t}`:`shard-chip-top-${t}`,i})}buildCliffBands(){let e=[...this.city.surfaces.map(e=>({points:e,depth:340,chip:!1})),...this.city.decorativeFragments.map(e=>({points:e.boundary,depth:e.depth,chip:!0}))],t=[0,.28,.62,1],n=[];for(let r=0;r<3;r++){let i=s_.cliff[r];if(i===void 0)continue;let a=[];for(let n of e){if(n.chip&&r>0)continue;let e=n.points,i=n.chip?0:-(t[r]??0)*n.depth,o=n.chip?-n.depth:-(t[r+1]??1)*n.depth,s=this.polygonCentre(e),c=[1,.995,.985,.97][r]??1,l=[1,.995,.985,.97][r+1]??.97;for(let t=0;t<e.length;t++){let n=e[t],r=e[(t+1)%e.length];if(!n||!r)continue;let u=this.scaleFrom(n,s,c),d=this.scaleFrom(r,s,c),f=this.scaleFrom(r,s,l),p=this.scaleFrom(n,s,l);a.push(u.x,i,u.z,d.x,i,d.z,f.x,o,f.z,u.x,i,u.z,f.x,o,f.z,p.x,o,p.z)}}let o=new Tr;o.setAttribute(`position`,new ur(new Float32Array(a),3)),o.computeVertexNormals();let s=new Jr(o,d_(i,{side:2}));s.name=`cliff-band-${r}`,n.push(s)}return n}polygonCentre(e){let t=0,n=0;for(let r of e)t+=r.x,n+=r.z;return{x:t/e.length,z:n/e.length}}scaleFrom(e,t,n){return{x:t.x+(e.x-t.x)*n,z:t.z+(e.z-t.z)*n}}buildPads(e,t,n){let r=this.city.blocks.filter(t=>t.kind===e),i=r.map(e=>e.clip??this.rectPoints(e)),a=e===`park`?r.map(e=>{let t=this.parkGrassFootprint(e);return t.length>=3?[t]:[]}):void 0,o=new Jr(this.polygonsGeometry(i,0,n,a),d_(t));return o.name=`${e}-pads`,o}buildParkland(){let e=this.city.blocks.filter(e=>e.kind===`park`).map(e=>this.parkGrassFootprint(e)).filter(e=>e.length>=3),t=new Jr(this.polygonsGeometry(e,0,Ru),d_(s_.park));return t.name=`parkland`,t}parkGrassFootprint(e){let t=e.innerClip;if(!t||t.length<3)return[];let n=e.clip??[];if(!n.length||!t.some(e=>this.distanceToPolygonEdge(e,n)<=1e-4))return t;let r=this.polygonCentre(t),i=Math.max(...t.map(e=>Math.hypot(e.x-r.x,e.z-r.z)),1),a=1-Math.min(.02/i,.001);return t.map(e=>this.scaleFrom(e,r,a))}distanceToPolygonEdge(e,t){let n=1/0;for(let r=0;r<t.length;r++){let i=t[r],a=t[(r+1)%t.length];if(!i||!a)continue;let o=a.x-i.x,s=a.z-i.z,c=Math.max(0,Math.min(1,((e.x-i.x)*o+(e.z-i.z)*s)/Math.max(o*o+s*s,1e-9)));n=Math.min(n,Math.hypot(e.x-(i.x+o*c),e.z-(i.z+s*c)))}return n}buildRoads(){let e=[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)],t=new Jr(this.polygonsGeometry(e,0,1),d_(s_.road));return t.name=`roads`,t}buildFragmentOverlays(){return[{kind:`built`,colour:s_.sidewalk,top:Ru},{kind:`parking`,colour:s_.parking,top:Ru},{kind:`park`,colour:s_.park,top:Ru}].map(e=>{let t=this.city.decorativeFragments.flatMap(t=>t.overlays.filter(t=>t.kind===e.kind).map(e=>e.polygon)),n=new Jr(this.polygonsGeometry(t,0,e.top),d_(e.colour));return n.name=`chip-${e.kind}`,n})}rectPoints(e){return[{x:e.x0,z:e.z0},{x:e.x1,z:e.z0},{x:e.x1,z:e.z1},{x:e.x0,z:e.z1}]}appendPrism(e,t,n,r,i=!0,a=[]){if(t.length<3)return;let o=t.reduce((e,n,r)=>{let i=t[(r+1)%t.length];return i?e+n.x*i.z-i.x*n.z:e},0)>=0?[...t]:[...t].reverse(),s=o.map(e=>new G(e.x,e.z)),c=a.filter(e=>e.length>=3).map(e=>e.map(e=>new G(e.x,e.z))),l=[s,...c].flat(),u=Fa.triangulateShape(s,c);for(let t of u){let n=t[0],i=t[1],a=t[2];if(n===void 0||i===void 0||a===void 0)continue;let o=l[n],s=l[i],c=l[a];!o||!s||!c||((s.x-o.x)*(c.y-o.y)-(s.y-o.y)*(c.x-o.x)>0?e.push(o.x,r,o.y,c.x,r,c.y,s.x,r,s.y):e.push(o.x,r,o.y,s.x,r,s.y,c.x,r,c.y))}if(i)for(let t=0;t<o.length;t++){let i=o[t],a=o[(t+1)%o.length];!i||!a||e.push(i.x,n,i.z,i.x,r,i.z,a.x,n,a.z,a.x,n,a.z,i.x,r,i.z,a.x,r,a.z)}}appendBandedPrism(e,t,n,r,i,a,o){if(n.length<3)return;let s=e.length/3;this.appendPrism(e,n,r,i,!1);for(let n=s;n<e.length/3;n++)t.push(o.r,o.g,o.b);let c=Math.max(1,Math.round(a));for(let a=0;a<c;a++){let s=r+(i-r)*a/c,l=r+(i-r)*(a+1)/c,u=a%2==0?1:l_,d=e.length/3;for(let t=0;t<n.length;t++){let r=n[t],i=n[(t+1)%n.length];!r||!i||e.push(r.x,s,r.z,r.x,l,r.z,i.x,s,i.z,i.x,s,i.z,r.x,l,r.z,i.x,l,i.z)}for(let n=d;n<e.length/3;n++)t.push(o.r*u,o.g*u,o.b*u)}}polygonsGeometry(e,t,n,r){let i=[];e.forEach((e,a)=>this.appendPrism(i,e,t,n,!0,r?.[a]??[]));let a=new Tr;return a.setAttribute(`position`,new ur(new Float32Array(i),3)),a.computeVertexNormals(),a}buildEdgeRubble(){let e=this.city.decorativeFragments.flatMap(e=>e.rubble),t=new Jr(this.polygonsGeometry(e,Ru,Ru+2.2),d_(s_.rubble));return t.name=`edge-rubble`,t}buildClipped(){let e=[],t=[];for(let n of this.city.buildings){if(!n.clip||n.clip.length<3)continue;let r=Math.max(n.height*c_[n.state],2.2);if(n.state===`rubble`?this.color.setHex(s_.rubble):(this.color.setHex(a_[n.paletteIndex%a_.length]??16777215),n.state===`damaged`&&this.color.multiplyScalar(.76)),n.state===`rubble`){let i=e.length/3;this.appendPrism(e,n.clip,Ru,Ru+r);for(let n=i;n<e.length/3;n++)t.push(this.color.r,this.color.g,this.color.b)}else{let i=ju(r,n.district);this.appendBandedPrism(e,t,n.clip,Ru,Ru+r,i,this.color)}}let n=new Tr;n.setAttribute(`position`,new ur(new Float32Array(e),3)),n.setAttribute(`color`,new ur(new Float32Array(t),3)),n.computeVertexNormals();let r=new Jr(n,d_(16777215,{vertexColors:!0}));return r.name=`clipped-buildings`,r}clippedSignature(){let e=``;for(let t of this.city.buildings)t.clip&&(e+=t.state[0]);return e}rebuildClipped(){let e=this.clippedSignature();if(e===this.clippedState)return;this.clippedState=e;let t=this.buildClipped();if(this.clipped){this.group.remove(this.clipped),this.clipped.geometry.dispose();let e=this.clipped.material;Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}this.clipped=t,this.group.add(t)}buildStripes(e,t,n){let r=e.map(e=>e.clip??this.rectPoints({x0:e.x-e.width/2,z0:e.z-e.depth/2,x1:e.x+e.width/2,z1:e.z+e.depth/2})),i=new Jr(this.polygonsGeometry(r,0,n),d_(t));return i.frustumCulled=!1,i}buildTrees(){let e=new Sn;e.name=`trees`;let t=new oi(new Ra(2.75,2),d_(s_.tree),Math.max(this.city.trees.length,1));t.name=`tree-canopies`,t.frustumCulled=!1;let n=new oi(new Si(.55,.72,1.5,5),d_(s_.treeTrunk),Math.max(this.city.trees.length,1));return n.name=`tree-stumps`,n.frustumCulled=!1,this.city.trees.forEach((e,r)=>{this.matrix.makeScale(e.scale,e.scale,e.scale),this.matrix.setPosition(e.x,Ru+.75*e.scale,e.z),n.setMatrixAt(r,this.matrix),this.matrix.setPosition(e.x,Ru+3.5*e.scale,e.z),t.setMatrixAt(r,this.matrix)}),t.instanceMatrix.needsUpdate=!0,n.instanceMatrix.needsUpdate=!0,e.add(n,t),e}buildCars(){let e=[...this.city.cars,...this.city.decorativeFragments.flatMap(e=>e.parkedCars)],t=new oi(new bi(1,1,1),d_(16777215),Math.max(e.length,1));return t.name=`cars`,t.frustumCulled=!1,e.forEach((e,n)=>{let r=5.4,i=2.4;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(e.alongX?r:i,2,e.alongX?i:r),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,(e.parked?Ru:1)+1,e.z),t.setMatrixAt(n,this.matrix),this.color.setHex(o_[e.paletteIndex%o_.length]??16777215),t.setColorAt(n,this.color)}),t.instanceMatrix.needsUpdate=!0,t.instanceColor&&(t.instanceColor.needsUpdate=!0),t}refresh(e){let t=this.city.get(e);t&&(this.writeBuilding(t),this.flush(this.slots.get(e)?.mesh),this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,t.clip&&this.rebuildClipped())}refreshAll(){for(let e of this.city.buildings)this.writeBuilding(e);for(let e of this.buildingMeshList)this.flush(e);this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,this.rebuildClipped()}flush(e){e&&(e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0))}writeBuilding(e){let t=this.slots.get(e.id);if(!t)return;let n=Nu[e.state],r=Math.max(e.height*c_[e.state],2.2),i=e.width*n,a=e.depth*n;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(i,r,a),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,Ru+r/2,e.z),t.mesh.setMatrixAt(t.index,this.matrix);let o=a_[e.paletteIndex%a_.length]??16777215;e.state===`rubble`?this.color.setHex(s_.rubble):(this.color.setHex(o),e.state===`damaged`&&this.color.multiplyScalar(.76)),t.mesh.setColorAt(t.index,this.color),this.writeGreebles(e,Ru+r),this.writeDebris(e)}writeGreebles(e,t){let n=this.greebleStart.get(e.id);if(n===void 0)return;let r=e.state===`intact`;for(let i=0;i<e.greebles;i++){if(!r){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,t,e.z),this.greebles.setMatrixAt(n+i,this.matrix);continue}let a=yu({x:((i+1)/(e.greebles+1)-.5)*e.width*.55,z:((e.id+i)%5/5-.5)*e.depth*.55},e.rotation??0),o=Math.min(e.width,e.depth)*.16,s=o*(.7+(e.id+i)%3*.35);this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(o,s,o),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+a.x,t+s/2,e.z+a.z),this.greebles.setMatrixAt(n+i,this.matrix)}}writeDebris(e){let t=e.id*u_;if(t+u_>this.debris.count)return;let n=e.state===`rubble`;for(let r=0;r<u_;r++){if(!n){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,Ru,e.z),this.debris.setMatrixAt(t+r,this.matrix);continue}let i=e.id*3+r,a=yu({x:(i*37%100/100-.5)*(e.width+16),z:(i*61%100/100-.5)*(e.depth+16)},e.rotation??0),o=Math.min(e.width,e.depth)*(.14+i%4/4*.16);this.matrix.makeScale(o,o*.5,o),this.matrix.setPosition(e.x+a.x,Ru+o*.25,e.z+a.z),this.debris.setMatrixAt(t+r,this.matrix)}}get meshCount(){return this.group.children.length}get buildingMeshes(){return this.buildingMeshList}renderedStoreysOf(e){let t=this.slots.get(e);return typeof t?.mesh.userData.storeys==`number`?t.mesh.userData.storeys:void 0}renderedHeightOf(e){if(this.city.get(e)?.clip)return 2.2;let t=this.slots.get(e);if(t)return t.mesh.getMatrixAt(t.index,this.matrix),this.matrix.elements[5]}dispose(){for(let e of this.group.children)if(e instanceof Jr){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}}},m_=256,h_=180,g_=new K(0,1,0);function __(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}function v_(e,t,n){let r=e.instanceColor,i=t*3;if(r&&Math.fround(n.r)===r.array[i]&&Math.fround(n.g)===r.array[i+1]&&Math.fround(n.b)===r.array[i+2])return!1;e.setColorAt(t,n);let a=e.instanceColor;return a?(a.setUsage(Be),a.addUpdateRange(i,3),!0):!1}function y_(e,t,n){return Math.max(t,Math.min(n,e))}function b_(e){switch(e){case`machine-cannon`:return{colour:Hp(`machines`),width:.82,impact:3.1};case`machine-harbinger-laser`:return{colour:Hp(`machines`),width:.48,impact:2.3};case`machine-rifle`:return{colour:Hp(`machines`),width:.18,impact:1};case`ancient-acid`:return{colour:zp,width:.34,impact:1.7};case`ancient-bite`:return{colour:16760428,width:0,impact:1.8};default:return{colour:16777215,width:.25,impact:1.2}}}var x_=class{group=new Sn;beamsMesh;impactsMesh;matrix=new qt;position=new K;direction=new K;scale=new K;rotation=new Tt;colour=new Y;beams=[];impacts=[];melee=new Map;constructor(){this.beamsMesh=new oi(new Si(1,1,1,6),new Ir({color:16777215,transparent:!0,opacity:.9,depthWrite:!1}),m_),this.impactsMesh=new oi(new Ra(1,1),new Ir({color:16777215,transparent:!0,opacity:.85,depthWrite:!1}),m_);for(let e of[this.beamsMesh,this.impactsMesh])e.instanceMatrix.setUsage(Be),e.count=0;this.beamsMesh.frustumCulled=!1,this.impactsMesh.frustumCulled=!1,this.beamsMesh.renderOrder=20,this.impactsMesh.renderOrder=21,this.group.add(this.beamsMesh,this.impactsMesh)}sync(e,t){for(let n of e)n.kind===`combatHit`&&this.addHit(n,t);this.beams=this.beams.filter(e=>t<e.startedAt+e.duration),this.impacts=this.impacts.filter(e=>t<e.startedAt+e.duration);for(let[e,n]of this.melee)t>=n.startedAt+n.duration&&this.melee.delete(e);this.syncBeams(t),this.syncImpacts(t)}meleePose(e,t){let n=this.melee.get(e);if(!n)return;let r=y_((t-n.startedAt)/n.duration,0,1);if(r>=1)return;let i=Math.sin(r*Math.PI);return{forward:i*n.distance,yaw:i*.18}}addHit(e,t){let n=Gf(e.weaponId),r=b_(e.weaponId),i=bm(e.attackerTypeId),a=bm(e.targetTypeId),o=Math.max(1,i.radius*.48),s=(e.shotIndex-(e.shotCount-1)/2)*Math.max(.8,i.radius*.3),c=new K(e.sourceX+Math.cos(e.sourceHeading)*o-Math.sin(e.sourceHeading)*s,Ru+i.height*.58,e.sourceZ+Math.sin(e.sourceHeading)*o+Math.cos(e.sourceHeading)*s),l=new K(e.targetX,Ru+a.height*.56,e.targetZ);if(n.projectileSpeed===0){this.melee.set(e.attackerId,{startedAt:t,duration:h_,distance:Math.max(.6,i.radius*.1)}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t,duration:130});return}let u=y_(c.distanceTo(l)/n.projectileSpeed*250,65,180);this.pushBeam({start:c,end:l,colour:r.colour,width:r.width,startedAt:t,duration:u}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t+u*.72,duration:120})}pushBeam(e){this.beams.length>=m_&&this.beams.shift(),this.beams.push(e)}pushImpact(e){this.impacts.length>=m_&&this.impacts.shift(),this.impacts.push(e)}syncBeams(e){let t=0,n=!1,r=!1;for(let i of this.beams){let a=y_((e-i.startedAt)/i.duration,0,1);this.direction.subVectors(i.end,i.start).multiplyScalar(a);let o=this.direction.length();if(o<=1e-5)continue;this.direction.normalize(),this.position.copy(i.start).addScaledVector(this.direction,o/2),this.rotation.setFromUnitVectors(g_,this.direction);let s=1-a*.55;this.scale.set(i.width*s,o,i.width*s),this.matrix.compose(this.position,this.rotation,this.scale),n=__(this.beamsMesh,t,this.matrix)||n,this.colour.setHex(i.colour),r=v_(this.beamsMesh,t,this.colour)||r,t++}this.finish(this.beamsMesh,t,n,r)}syncImpacts(e){let t=0,n=!1,r=!1;for(let i of this.impacts){let a=(e-i.startedAt)/i.duration;if(a<0||a>=1)continue;let o=i.radius*(.45+Math.sin(a*Math.PI)*.9);this.matrix.makeScale(o,o,o),this.matrix.setPosition(i.position),n=__(this.impactsMesh,t,this.matrix)||n,this.colour.setHex(i.colour),r=v_(this.impactsMesh,t,this.colour)||r,t++}this.finish(this.impactsMesh,t,n,r)}finish(e,t,n,r){e.count=t,n&&(e.instanceMatrix.needsUpdate=!0),r&&e.instanceColor&&(e.instanceColor.needsUpdate=!0)}dispose(){this.beamsMesh.geometry.dispose(),this.beamsMesh.material.dispose(),this.impactsMesh.geometry.dispose(),this.impactsMesh.material.dispose()}},S_=[10800,-81e3,10800],C_=35e3,w_=[8433856,8433856,8958144,8960192,9484488],T_=[12636344,11585712,12112064,11585720,12636352,11059376],E_=40,D_=22;function O_(e,t){return(e*17+t*13)%19/18}function k_(e,t,n){let r=Math.atan2(n,e),i=Math.asin(t/Math.hypot(e,t,n)),a=Math.floor((r+Math.PI)/(Math.PI*2)*E_);return Math.floor((i+Math.PI/2)/Math.PI*D_)*E_+a}function A_(){let e=new Ra(C_,5).toNonIndexed(),t=e.getAttribute(`position`),n=new Float32Array(t.count*3),r=new Y;for(let e=0;e<t.count/3;e++){let i=e*3,a=((t.getX(i)??0)+(t.getX(i+1)??0)+(t.getX(i+2)??0))/3,o=((t.getY(i)??0)+(t.getY(i+1)??0)+(t.getY(i+2)??0))/3,s=((t.getZ(i)??0)+(t.getZ(i+1)??0)+(t.getZ(i+2)??0))/3,c=(a+s)*.6+o*.53,l=k_(a,o,s),u=c<C_*.35||O_(l,1)>.48?w_:T_,d=Math.min(u.length-1,Math.floor(O_(l,2)*u.length));r.setHex(u[d]);for(let e=0;e<3;e++){let t=(i+e)*3;n[t]=r.r,n[t+1]=r.g,n[t+2]=r.b}}e.setAttribute(`color`,new ur(n,3));let i=new Jr(e,new Ir({vertexColors:!0,fog:!1}));return i.position.set(S_[0],S_[1],S_[2]),i}var j_=class{group=new Sn;constructor(){this.group.add(A_())}dispose(){for(let e of this.group.children)e instanceof Jr&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose());this.group.clear()}},M_=256,N_=Ru+.12,P_=1,F_=0;function I_(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var L_=class{group=new Sn;buildings;units;matrix=new qt;scale=new K;buildingSignature=``;constructor(e,t){let n=()=>new $a({color:1512978,flatShading:!0,transparent:!0,opacity:.24,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1});this.buildings=new Jr(new Tr,n()),this.units=new oi(new xi(1,12),n(),M_),this.units.instanceMatrix.setUsage(Be),this.units.count=0;for(let e of[this.buildings,this.units])e.frustumCulled=!1;this.group.add(this.buildings,this.units),this.sync(e,t)}sync(e,t){let n=e.buildings.map(e=>e.state).join(``);n!==this.buildingSignature&&(this.buildingSignature=n,this.rebuildBuildingShadows(e));let r=0,i=!1;for(let e of t.units){if(r>=this.units.instanceMatrix.count)break;let n=Cf(t.typeOf(e));this.matrix.makeRotationX(-Math.PI/2),this.scale.set(n*.9,n*.62,1),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+n*.22,N_+.03,e.z+n*.16),i=I_(this.units,r++,this.matrix)||i}this.units.count=r,i&&(this.units.instanceMatrix.needsUpdate=!0)}rebuildBuildingShadows(e){let t=[];for(let n of e.buildings){let e=n.state===`intact`?n.height:n.state===`damaged`?n.height*.55:0;if(e<=0)continue;let r=e*.48,i=n.clip??Lu(n),a=R_([...i,...i.map(e=>({x:e.x+P_*r,z:e.z+F_*r}))]);for(let e=1;e<a.length-1;e++)this.appendTriangle(t,a[0],a[e+1],a[e])}let n=this.buildings.geometry,r=new Tr;r.setAttribute(`position`,new ur(new Float32Array(t),3)),r.computeVertexNormals(),this.buildings.geometry=r,n.dispose()}appendTriangle(e,t,n,r){if(!(!t||!n||!r))for(let i of[t,n,r])e.push(i.x,N_,i.z)}dispose(){for(let e of[this.buildings,this.units])e.geometry.dispose(),e.material.dispose()}};function R_(e){let t=[...e].sort((e,t)=>e.x-t.x||e.z-t.z),n=(e,t,n)=>(t.x-e.x)*(n.z-e.z)-(t.z-e.z)*(n.x-e.x),r=e=>{let t=[];for(let r of e){for(;t.length>=2&&n(t[t.length-2],t[t.length-1],r)<=0;)t.pop();t.push(r)}return t},i=r(t),a=r([...t].reverse());return i.pop(),a.pop(),[...i,...a]}var z_=2400,B_=7e3,V_=1600,H_=1e3;function U_(e,t,n,r){let i=(e,i)=>({x:t+e*r,y:n+i*r}),a=[i(-115,5),i(-75,-25),i(-20,-18),i(5,-48),i(70,-38),i(105,-8),i(92,18),i(-55,24)],o=[a[7],a[6],i(92,43),i(-55,49)],s=[a[6],a[5],i(105,18),i(92,43)],c=(t,n)=>{let r=t[0];if(r){e.beginPath(),e.moveTo(r.x,r.y);for(let n of t.slice(1))e.lineTo(n.x,n.y);e.closePath(),e.fillStyle=n,e.fill()}};c(o,`#dbd8c6`),c(s,`#c9c8bb`),c(a,`#f6f0dd`)}function W_(){let e=document.createElement(`canvas`);e.width=V_,e.height=H_;let t=e.getContext(`2d`);if(t){let n=t.createLinearGradient(0,0,0,e.height);n.addColorStop(0,`#${new Y(s_.sky).getHexString()}`),n.addColorStop(1,`#${new Y(s_.skyHorizon).getHexString()}`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height),U_(t,255,160,.75),U_(t,1240,125,1.1)}let n=new gi(e);return n.colorSpace=Fe,n.needsUpdate=!0,n}var G_=class{scene=new jn;city;units;combat;shadows;skyGradient;earth;constructor(e,t){this.skyGradient=W_(),this.scene.background=this.skyGradient,this.scene.fog=new An(s_.skyHorizon,z_,B_),this.earth=new j_,this.scene.add(this.earth.group),this.shadows=new L_(e,t),this.scene.add(this.shadows.group),this.city=new p_(e),this.scene.add(this.city.group),this.units=new Tm(t),this.scene.add(this.units.group),this.combat=new x_,this.scene.add(this.combat.group);let n=new No(16774102,2.05);n.position.set(-1,1,0).normalize(),this.scene.add(n),this.scene.add(new vo(s_.sky,7236170,1))}dispose(){this.city.dispose(),this.units.dispose(),this.combat.dispose(),this.shadows.dispose(),this.earth.dispose(),this.skyGradient.dispose(),this.scene.clear()}},K_=[1,2,3,4,5,6,7,8,9,0],q_=class{ids=[];groups=new Map;get size(){return this.ids.length}list(){return this.ids}has(e){return this.ids.includes(e)}primary(){return this.ids[0]}set(e){this.ids=[...new Set(e)].sort((e,t)=>e-t)}add(e){this.set([...this.ids,...e])}toggle(e){this.set(this.has(e)?this.ids.filter(t=>t!==e):[...this.ids,e])}clear(){this.ids=[]}assignGroup(e,t=this.ids){K_.includes(e)&&this.groups.set(e,[...t])}recallGroup(e){let t=this.groups.get(e);return!t||t.length===0?!1:(this.set(t),!0)}groupSize(e){return this.groups.get(e)?.length??0}occupiedGroups(){return K_.filter(e=>this.groupSize(e)>0)}prune(e){this.ids=this.ids.filter(e);for(let[t,n]of this.groups){let r=n.filter(e);r.length!==n.length&&(r.length===0?this.groups.delete(t):this.groups.set(t,r))}}},J_=1213353265,Y_=250,X_=85,Z_=100,Q_=1800,$_=80,ev=3;function tv(e,t,n){let r,i=1/0;for(let a of e.buildings){if(a.state===`rubble`)continue;let e=(a.x-t)**2+(a.z-n)**2;e<i&&(i=e,r=a.id)}return r}var nv=class{windowTicks;ticks=[];earned=[];total=0;last=null;constructor(e=360){this.windowTicks=e}add(e,t){for(this.last!==null&&t>this.last&&(this.total+=t-this.last),this.last=t,this.ticks.push(e),this.earned.push(this.total);this.ticks.length>1&&e-(this.ticks[0]??e)>this.windowTicks;)this.ticks.shift(),this.earned.shift()}get perMinute(){if(this.ticks.length<2)return 0;let e=(this.ticks.at(-1)??0)-(this.ticks[0]??0);return e<=0?0:((this.earned.at(-1)??0)-(this.earned[0]??0))/e*30*60}};function rv(e){switch(e.kind){case`produced`:return`${(e.subject??`UNIT`).toUpperCase()} READY`;case`productionQueued`:return`BUILDING ${(e.subject??`UNIT`).toUpperCase()}`;case`productionRefused`:return`INSUFFICIENT HUMANS`;case`productionBlocked`:return`NO ROOM TO DEPLOY`;case`built`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`buildRefused`:return`CANNOT BUILD HERE`;case`constructionRefusedResources`:return`INSUFFICIENT HUMANS`;case`constructionStarted`:return`${(e.subject??`STRUCTURE`).toUpperCase()} SUMMONING`;case`constructionComplete`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`constructionCancelled`:return`SUMMONING CANCELLED`;case`underAttack`:return`UNIT UNDER ATTACK`;case`combatHit`:return null;case`unitDown`:return`UNIT DESTROYED`;case`victory`:return`HARBINGER DESTROYED`;case`tier2`:return`TIER 2 UNLOCKED`;case`tier2Refused`:return`TIER 2 UNAVAILABLE`;case`structureDown`:return`STRUCTURE DOWN`;case`civiliansDisplaced`:return`${e.count??0} HUMANS DISPLACED`;case`deposited`:return null}}var iv=new Set([`productionQueued`,`produced`,`productionRefused`,`productionBlocked`,`constructionStarted`,`constructionComplete`,`constructionCancelled`,`constructionRefusedResources`]);function av({world:e,renderer:t,overlayEl:n,boxEl:r,store:i,onLoadRequested:a,onSeedStepRequested:o,onExitToTitle:s,onBattleFactionRequested:c}){let l=new Bd(e),u=new G_(e.city,e.army),d=e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction),f=e.city.startAnchors[e.playerFaction===`machines`?0:1]??{x:0,z:0},p=d.length>0?{x:d.reduce((e,t)=>e+t.x,0)/d.length,z:d.reduce((e,t)=>e+t.z,0)/d.length}:f,m=new Rm(window.innerWidth/window.innerHeight,p),h=new _u(t.domElement),g=new q_,_=new vg(n),v=new gg,y=new nv,b=new nv,x=new wg(document.body,e.city,e.population,e.populationCapacity,e.playerFaction),S=new kg(document.body),C=new Vg(e.city,e.army,e.population);u.scene.add(C.group);let w=new Zg;u.scene.add(w.group);let T=new e_;u.scene.add(T.group);let E=null,D=0,O=(e,t)=>{E=e,D=t+Q_},k=new ph(document.body,Mh({world:e,selected:0,banner:null}),t=>{t===`cancel`&&g.size>0?e.enqueue(e.playerFaction,{kind:`stop`,unitIds:g.list()}):t===`primary`&&g.size>0&&e.playerFaction===`machines`&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()})}),A=Z_,j=null,M=null,N=new Um(document.body,e.playerFaction,{onDeploy:()=>e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()}),onIsolateType:t=>{g.set(g.list().filter(n=>e.army.get(n)?.typeId===t))}}),P=new th(document.body,e.playerFaction,{onProduce:(t,n)=>e.enqueue(e.playerFaction,{kind:`produce`,producer:t,typeId:n}),onBuild:(t,n)=>{let r=Sf(n).cost;if(!e.freeProduction&&e.resources.humans<r){O(`INSUFFICIENT HUMANS`,performance.now());return}M={builderId:t.id,structureTypeId:n},O(`CHOOSE SUMMONING SITE`,performance.now())},onUnlockTier2:()=>e.enqueue(e.playerFaction,{kind:`unlockTier2`})}),F=null,I=0,ee=null,te=!0,ne=null,re=!1,ie=()=>{ne?.dispose(),ne=null,re=!1,h.consume()},ae=()=>{ne||=(re=!0,new eg(document.body,ee,{onSaveAndExit:()=>{if(!i){ie(),s();return}let t=xp(e);i.put(t,Date.now()).catch(e=>console.error(`save failed`,e)).finally(()=>{ie(),s()})},onExitAnyway:()=>{ie(),s()},onCancel:()=>ie()}))},oe=()=>{t.setSize(window.innerWidth,window.innerHeight),m.setAspect(window.innerWidth/window.innerHeight),te=!0};window.addEventListener(`resize`,oe);let L=new G,se=t=>{let n=Nm(m.camera,e.city,t);return Wd(n===void 0?void 0:e.city.get(n),e.population)?n:void 0},ce=t=>{if(g.size===0)return;let n=jm(m.camera,e.army,t),r=n===void 0?void 0:e.army.get(n);if(!(!r||e.army.typeOf(r).faction===e.playerFaction))return g.list().some(t=>{let n=e.army.get(t);if(!n||n.deployTimer>0)return!1;let r=e.army.typeOf(n);return r.faction===e.playerFaction&&(r.weaponIds??[]).some(e=>Gf(e).targetClasses.includes(`unit`))})?r.id:void 0},le=0,ue=null,de=0,fe=0,pe=30,me=Y_,he=0,ge=0,_e=0,ve=!1,ye=!1,be=e.tick,xe=``,Se=NaN,Ce=NaN,we=NaN,Te=!0,Ee=0,De=!1,Oe=n=>{if(De)return;let s=ue===null?1e3/60:n-ue;if(ue=n,v.add(s),h.sample(),!re){m.update(h,s/1e3);let t=M!==null&&h.orderAt!==void 0;t&&(M=null,O(`SUMMONING CANCELLED`,n));let r=h.selectGesture;if(r&&M){if(!r.isBox){L.set((r.rect.x0+r.rect.x1)/2,(r.rect.y0+r.rect.y1)/2);let t=Am(m.camera,L),n=t&&e.constructionPlacement(M.builderId,M.structureTypeId,t.x,t.z);n&&(e.enqueue(e.playerFaction,{kind:`build`,builderId:M.builderId,structureTypeId:M.structureTypeId,x:n.x,z:n.z}),M=null)}}else if(r)if(r.isBox){let t=Fm(m.camera,e.army,r.rect).filter(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});r.additive?g.add(t):g.set(t)}else{L.set((r.rect.x0+r.rect.x1)/2,(r.rect.y0+r.rect.y1)/2);let t=jm(m.camera,e.army,L),i=t===void 0?void 0:e.army.get(t),a=i&&e.army.typeOf(i).faction===e.playerFaction?t:void 0;if(i&&a===void 0)j=i.id,r.additive||g.clear();else if(a===void 0){r.additive||(j=null);let t=g.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),i=km(m.camera,e.crowds.all,L),a=se(L);t.length>0&&i!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,crowdId:i}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):t.length>0&&a!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,buildingId:a}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):r.additive||g.clear()}else r.additive?(j=null,g.toggle(a)):(j=null,g.set([a]))}for(let e of K_){let t=h.pressModifiers(`Digit${e}`);t&&(t.shift?g.assignGroup(e):g.recallGroup(e))}if(h.wasPressed(`Escape`)&&(M?(M=null,O(`SUMMONING CANCELLED`,n)):g.size>0||j!==null?(g.clear(),j=null):ae()),h.wasPressed(`KeyP`)&&(Te=!0),h.wasPressed(`KeyI`)&&x.toggle(),e.battlefield&&h.wasPressed(`Digit1`)&&c(`machines`),e.battlefield&&h.wasPressed(`Digit2`)&&c(`ancients`),h.wasPressed(`BracketLeft`)&&o(-1),h.wasPressed(`BracketRight`)&&o(1),h.orderAt&&!t&&g.size>0){let t=g.list(),r=ce(h.orderAt),i=t.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),a=km(m.camera,e.crowds.all,h.orderAt),o=se(h.orderAt);if(r!==void 0){let n=e.army.get(r);n&&e.enqueue(e.playerFaction,{kind:`attack`,unitIds:t,targetId:n.id,x:n.x,z:n.z})}else if(i.length>0&&a!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,crowdId:a}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else if(i.length>0&&o!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,buildingId:o}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else{let n=Am(m.camera,h.orderAt);n&&e.enqueue(e.playerFaction,{kind:`move`,unitIds:t,x:n.x,z:n.z})}}if(h.wasPressed(`KeyQ`)&&g.size>0&&e.enqueue(e.playerFaction,{kind:`stop`,unitIds:g.list()}),h.wasPressed(`KeyX`)){let t=tv(e.city,m.focus.x,m.focus.z);t!==void 0&&e.enqueue(`debug`,{kind:`damage`,buildingId:t})}if(h.wasPressed(`KeyZ`)&&e.enqueue(`debug`,{kind:`raze`,x:m.focus.x,z:m.focus.z,radius:X_}),h.wasPressed(`KeyB`)){le=(le+1)%Mu.length;let t=Mu[le];e.enqueue(`debug`,{kind:`setAllStates`,state:t})}if(h.wasPressed(`KeyH`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:$_,charge:0}),h.wasPressed(`KeyJ`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:0,charge:ev}),h.wasPressed(`KeyE`)&&g.size>0){let t=tv(e.city,m.focus.x,m.focus.z);t!==void 0&&Wd(e.city.get(t),e.population)&&(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:g.list(),buildingId:t}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n))}if(h.wasPressed(`KeyR`)&&g.size>0&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()}),h.wasPressed(`KeyT`)&&e.enqueue(e.playerFaction,{kind:`unlockTier2`}),h.wasPressed(`KeyF`)||h.wasPressed(`KeyG`)){let t=e.army.units.find(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).producesUnits&&t.deployed&&t.deployTimer===0),r=e.playerFaction===`machines`?`machine-infantry`:`ancient-infantry`,i=e.playerFaction===`machines`?`machine-construct`:`ancient-support`;t?e.enqueue(e.playerFaction,{kind:`produce`,producer:{kind:`unit`,id:t.id},typeId:h.wasPressed(`KeyG`)?i:r}):O(`NO DEPLOYED FACTORY`,n)}if(h.wasPressed(`KeyV`)){let t=g.primary()===void 0?void 0:e.army.get(g.primary());t&&e.army.typeOf(t).canDeploy&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:[t.id]})}if(h.wasPressed(`F5`)&&i){let t=xp(e);O(`SAVING`,n),i.put(t,Date.now()).then(()=>{O(`SAVED · STEP ${t.tick}`,performance.now()),ee=`step ${t.tick}`}).catch(e=>{console.error(`save failed`,e),O(`SAVE FAILED`,performance.now())})}h.wasPressed(`F9`)&&a()}if(h.dragRect&&!re){let e=h.dragRect;r.style.display=`block`,r.style.left=`${(e.x0+1)/2*100}%`,r.style.top=`${(1-e.y1)/2*100}%`,r.style.width=`${(e.x1-e.x0)/2*100}%`,r.style.height=`${(e.y1-e.y0)/2*100}%`}else r.style.display=`none`;h.consume();let d=performance.now(),f=l.advance(re?0:s),p=e.drainChangedBuildings();if(p.length>0)if(he=performance.now()-d,Te=!0,p.length>8)u.city.refreshAll();else for(let e of p)u.city.refresh(e);let ne=e.drainEvents(),ie=ne.some(e=>e.kind===`combatHit`||e.kind===`unitDown`);u.combat.sync(ne,n);for(let e of ne){let t=rv(e);t&&(O(t,n),iv.has(e.kind)&&(F=t,I=n+Q_))}g.prune(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});let oe=g.list(),ke=`${j??``}|${oe.join(`,`)}`,Ae=ke!==xe;xe=ke;let R=m.camera,je=te||Math.abs(R.position.x-Se)>.01||Math.abs(R.position.y-Ce)>.01||Math.abs(R.position.z-we)>.01;te=!1,Se=R.position.x,Ce=R.position.y,we=R.position.z;let Me=e.tick!==be;be=e.tick;let Ne=p.length>0||Me&&e.army.units.some(Ef),z=ce(h.pointer);u.units.sync(e.army,f,t=>{let n=e.army.get(t);if(t===z)return`#ff2020`;if((g.has(t)||t===j)&&n)return ch[e.army.typeOf(n).faction].line},e=>u.combat.meleePose(e,n)),S.sync({army:e.army,camera:R,nowMs:n,cameraDirty:je,stateDirty:ie,selectionDirty:Ae,selectedIds:oe,inspectedEnemyId:j}),(Me||p.length>0)&&u.shadows.sync(e.city,e.army),w.sync(e.crowds.all,f,e.tick,e.army);let Pe=oe.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`});x.setSelectionEnabled(Pe.length>0),x.sync({camera:R,zoomFraction:m.zoomFraction,nowMs:n,cameraDirty:je,populationDirty:Ne});let B=Pe.length>0?se(h.pointer):void 0;C.sync(e.tick,Pe.length>0,B);let Fe=M?Am(m.camera,h.pointer):void 0,V=M!==null&&Fe!==void 0&&e.constructionPlacement(M.builderId,M.structureTypeId,Fe.x,Fe.z)!==void 0;if(T.sync(M&&Fe?{structureTypeId:M.structureTypeId,x:Fe.x,z:Fe.z}:void 0,V,e.constructionSites,n),t.render(u.scene,m.camera),j!==null&&e.army.get(j)===void 0&&(j=null),A+=s,A>=Z_){A=0,E!==null&&n>D&&(E=null),F!==null&&n>I&&(F=null),k.render(Mh({world:e,selected:g.size,banner:E})),N.render(Ih(e,g,j===null?void 0:e.army.get(j)));let t=g.primary()===void 0?void 0:e.army.get(g.primary());P.render(Rh(e,t,F))}if(fe+=s,fe>=1e3&&(pe=(l.stepCount-de)/fe*1e3,de=l.stepCount,fe=0),y.add(e.tick,e.resources.humans),b.add(e.tick,e.resources.charge),me+=s,me>=Y_){if(me=0,Te){Te=!1;let t=e.city.startAnchors[0];if(t){let n={x:m.focus.x,z:m.focus.z},r=e.nav.onShardCells,i=e.nav.flood(t.x,t.z,`small`,n),a=e.nav.flood(t.x,t.z,`large`,n);ge=i.count/r,_e=a.count/r,ve=i.reachedTarget,ye=a.reachedTarget}}let[t,n,r]=e.destructionCounts();_.render({faction:Zf[e.playerFaction].name,battlefield:e.battlefield,seed:e.seed,fps:v.fps,simHz:pe,stepCount:e.tick,droppedMs:l.droppedMs,alpha:f,zoomFraction:m.zoomFraction,pitchDeg:m.pitchDeg,distance:m.camera.position.distanceTo(m.focus),focusX:m.focus.x,focusZ:m.focus.z,cityBuildings:e.city.buildings.length,cityIntact:t??0,cityDamaged:n??0,cityRubble:r??0,populationLabels:x.enabled,units:e.army.units.length,unitsMoving:e.army.countMoving(),unitsBlocked:e.army.countBlocked(),unitsUnreached:e.army.countUnreached(),unitsStalled:e.army.countStalled(),selected:g.size,groups:g.occupiedGroups(),pathsQueued:e.army.pending,pathsTotal:e.army.pathsTotal,navCells:e.nav.cellCount,navRebuilds:e.nav.rebuildCount,navLastRebuildCells:e.nav.lastRebuildCells,navRebuildMs:he,smallPassable:e.nav.passableFraction(`small`),largePassable:e.nav.passableFraction(`large`),reachSmall:ge,reachLarge:_e,atFocusSmall:ve,atFocusLarge:ye,humans:e.resources.humans,humansCap:e.resources.humansCap,charge:e.resources.charge,chargeCap:e.resources.chargeCap,chargeSegments:e.resources.segmentsReady,techTier:e.techTier,humansPerMinute:y.perMinute,chargePerMinute:b.perMinute,cargoInTransit:e.cargoInTransit(),populationRemaining:e.remainingPopulation(),populationTotal:e.populationCapacity.reduce((e,t)=>e+t,0),structures:e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).role===`structure`).length,queued:e.queuedProduction(),civilianCrowds:e.crowds.all.length,civilianHumans:e.crowds.totalHumans(),harvesting:e.army.units.filter(Ef).length,harvestIdle:e.harvestersIdle(),unitsDeployed:e.army.countDeployed(),unitsDeploying:e.army.countDeploying()},v)}Ee=requestAnimationFrame(Oe)};return Ee=requestAnimationFrame(Oe),{dispose(){De=!0,cancelAnimationFrame(Ee),window.removeEventListener(`resize`,oe),h.dispose(),k.dispose(),N.dispose(),P.dispose(),ie(),u.dispose(),x.dispose(),S.dispose(),C.dispose(),w.dispose(),T.dispose(),r.style.display=`none`}}}async function ov(){let e=window.location.pathname.endsWith(`/battle.html`),t=document.getElementById(`overlay`),n=document.getElementById(`overlay-content`),r=document.getElementById(`overlay-toggle`),i=document.getElementById(`selectbox`);if(!t||!n||!(r instanceof HTMLButtonElement)||!i)throw Error(`overlay controls or #selectbox missing from the page shell`);r.addEventListener(`click`,()=>{let e=t.classList.toggle(`minimized`);r.textContent=e?`+`:`−`,r.title=e?`Restore developer panel`:`Minimize developer panel`,r.setAttribute(`aria-expanded`,String(!e))});let a=new pu({antialias:!0,powerPreference:`high-performance`});a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(a.domElement);let o=kp.available?new kp:null;o||console.warn(`IndexedDB unavailable; saving is disabled for this session`);let s=cv();Fp(`machines`,s.colourVariant.machines),Fp(`ancients`,s.colourVariant.ancients);let c=()=>{t.style.display=s.overlayVisible?``:`none`};c();let l=null,u=null,d=e=>{u?.dispose(),u=e},f=e=>{d(null),l?.dispose(),l=av({world:e,renderer:a,overlayEl:n,boxEl:i,store:o,onLoadRequested:p,onSeedStepRequested:t=>{let n=e.seed+t>>>0;queueMicrotask(()=>f(e.battlefield?new yp(n,e.playerFaction,{battlefield:!0}):new yp(n,e.playerFaction)))},onExitToTitle:()=>{l?.dispose(),l=null,m()},onBattleFactionRequested:t=>{!e.battlefield||t===e.playerFaction||queueMicrotask(()=>f(new yp(e.seed,t,{battlefield:!0})))}})},p=e=>{o&&o.get(e).then(e=>{if(!e){console.warn(o.lastRejection??`no save to load`);return}f(Sp(e.envelope))}).catch(e=>console.error(`load failed`,e))},m=async()=>{let e=o?await o.get().catch(()=>void 0):void 0,t=o?await o.list().catch(()=>[]):[];d(new Hh(document.body,{saved:e&&{faction:e.envelope.playerFaction,tick:e.envelope.tick,clock:Ah(e.envelope.tick)},slotCount:t.length,onStart:e=>f(new yp(J_,e)),onResume:()=>p(),onSelectSave:()=>void g(),onSettings:()=>h()}))},h=()=>{d(new Qh(document.body,s,{onColourVariant:(e,t)=>{s.colourVariant[e]=t,Fp(e,t),lv(s),h()},onToggleOverlay:e=>{s.overlayVisible=e,lv(s),c(),h()},onBack:()=>void m()}))},g=async()=>{let e=o?await o.list().catch(()=>[]):[];d(new $h(document.body,e.map(e=>({slot:e.slot,faction:e.readable?e.envelope.playerFaction:void 0,clock:Ah(e.envelope.tick??0),tick:e.envelope.tick??0,savedAtMs:e.savedAtMs,readable:e.readable})),{onLoad:e=>p(e),onDelete:e=>{o&&o.delete(e).then(()=>g()).catch(e=>console.error(`delete failed`,e))},onBack:()=>void m()}))},_=new URLSearchParams(window.location.search).get(`faction`);if(e){f(new yp(J_,_===`ancients`?`ancients`:`machines`,{battlefield:!0}));return}if(_===`machines`||_===`ancients`){f(new yp(J_,_));return}await m()}var sv=`human-resources.frontend`;function cv(){let e={colourVariant:{machines:0,ancients:0},overlayVisible:!0};try{let t=window.localStorage.getItem(sv);if(!t)return e;let n=JSON.parse(t),r=e=>+(e===1);return{colourVariant:{machines:r(n.colourVariant?.machines),ancients:r(n.colourVariant?.ancients)},overlayVisible:n.overlayVisible!==!1}}catch{return e}}function lv(e){try{window.localStorage.setItem(sv,JSON.stringify(e))}catch{}}ov();
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ts(e,t,n){let r=new Float32Array(ds),i=new K(0,1,0);return new Za({name:`SphericalGaussianBlur`,defines:{n:ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Os(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Es(){return new Za({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Os(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ds(){return new Za({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Os(),fragmentShader:`
	...
	`}var ks=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        <path d="M104 1 C70 1 46 8 30 21 C17 32 15 43 23 48 C30 53 41 52 46 46
                 C36 49 27 45 28 36 C30 24 55 13 104 21 Z"/>
        <ellipse cx="78" cy="40" rx="8" ry="6"/>
      </g>`}}},Bm=1920;function Vm(e,t,n){if(e.style.setProperty(`--panel-fill`,t.fill),e.style.setProperty(`--panel-edge`,t.edge),e.style.setProperty(`--panel-edge-px`,`${t.edgePx}px`),e.style.setProperty(`--panel-tile`,t.tile),e.style.setProperty(`--panel-tile-edge`,t.tileEdge),e.style.setProperty(`--panel-tile-radius`,t.tileRadius),e.style.setProperty(`--panel-heading`,t.heading),e.style.setProperty(`--panel-body`,t.body),e.style.setProperty(`--panel-dim`,t.dim),e.style.setProperty(`--panel-heading-shadow`,t.headingShadow),e.style.setProperty(`--panel-font`,t.font),e.style.setProperty(`--panel-accent`,t.accent),e.style.setProperty(`--panel-ok`,t.ok),e.style.setProperty(`--panel-warn`,t.warn),e.style.setProperty(`--panel-on-edge`,t.onEdge),e.style.setProperty(`--panel-border-top`,`${t.edgePx}px solid ${t.edge}`),e.style.setProperty(`--panel-border-inward`,`${t.edgePx}px solid ${t.edge}`),t.chamferPx>0){let r=t.chamferPx;e.style.setProperty(`--panel-clip`,n===`left`?`polygon(0 0, calc(100% - ${r}px) 0, 100% ${r}px, 100% 100%, 0 100%)`:`polygon(${r}px 0, 100% 0, 100% 100%, 0 100%, 0 ${r}px)`),e.style.setProperty(`--panel-radius`,`0`)}else e.style.setProperty(`--panel-clip`,`none`),e.style.setProperty(`--panel-radius`,n===`left`?`0 ${t.radiusPx}px 0 0`:`${t.radiusPx}px 0 0 0`)}function Hm(e){let t=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return t.setAttribute(`viewBox`,`0 0 ${e.width} ${e.height}`),t.setAttribute(`width`,String(e.width)),t.setAttribute(`height`,String(e.height)),t.innerHTML=e.inner,t}var Um=class{handlers;root;onResize;nameEl;metaEl;activityEl;statsEl;countEl;chipsEl;deployEl;deployFillEl;deployLabelEl;lastName=``;lastMeta=``;lastActivity=``;lastStats=``;lastCount=``;lastChipSignature=``;lastDeploy=``;lastVisible=null;constructor(e,t,n){this.handlers=n,$m();let r=zm[t];this.root=Wm(`div`,`hrp hrp-unit`),this.root.dataset.faction=t,Vm(this.root,r,`left`);let i=Hm(r.cornerLeft);i.classList.add(`hrp-corner`);let a=Wm(`div`,`hrp-shell`),o=Wm(`div`,`hrp-body`),s=Wm(`div`,`hrp-lead`),c=Wm(`div`,`hrp-portrait`);c.append(Ym(),Xm()),s.append(c);let l=Wm(`div`,`hrp-lead-text`);this.nameEl=Wm(`div`,`hrp-name`),this.metaEl=Wm(`div`,`hrp-meta`),this.activityEl=Wm(`div`,`hrp-activity`),this.statsEl=Wm(`div`,`hrp-stats`),l.append(this.nameEl,this.metaEl,this.activityEl,this.statsEl),s.append(l);let u=Wm(`div`,`hrp-rail`);this.countEl=Wm(`div`,`hrp-count`),this.chipsEl=Wm(`div`,`hrp-chips`),this.deployEl=document.createElement(`button`),this.deployEl.type=`button`,this.deployEl.className=`hrp-deploy`,this.deployFillEl=Wm(`div`,`hrp-deploy-fill`),this.deployLabelEl=Wm(`span`,`hrp-deploy-label`),this.deployEl.append(this.deployFillEl,Zm(),this.deployLabelEl),this.deployEl.addEventListener(`click`,()=>this.handlers.onDeploy()),u.append(this.countEl,this.chipsEl,this.deployEl),o.append(s,Wm(`div`,`hrp-divider`),u),a.append(o),this.root.append(a,i),e.append(this.root),this.rescale(),this.onResize=()=>this.rescale(),window.addEventListener(`resize`,this.onResize)}dispose(){window.removeEventListener(`resize`,this.onResize),this.root.remove()}rescale(){this.root.style.setProperty(`--hud-scale`,String(Gm()))}render(e){let t=e.mode!==`none`&&e.leader!==null;if(t!==this.lastVisible&&(this.root.classList.toggle(`shown`,t),this.lastVisible=t),!t||!e.leader)return;let n=e.leader;this.write(this.nameEl,`lastName`,n.name),this.write(this.metaEl,`lastMeta`,Km(n)),this.write(this.activityEl,`lastActivity`,n.activity??``),this.activityEl.classList.toggle(`empty`,n.activity===null);let r=`${n.humansOnboard?`${n.humansOnboard.current}/${n.humansOnboard.max}`:``} ${n.health?`${n.health.current}/${n.health.max}`:`none`}`;r!==this.lastStats&&(this.statsEl.replaceChildren(...n.humansOnboard?[qm(`HUMANS`,`${Math.round(n.humansOnboard.current)}/${n.humansOnboard.max}`)]:[],Jm(n.health)),this.lastStats=r),this.write(this.countEl,`lastCount`,e.selectedCount>1?`${e.selectedCount} SELECTED`:``),this.countEl.classList.toggle(`empty`,e.selectedCount<=1),this.root.dataset.inspect=e.inspectOnly?`true`:`false`;let i=e.tallies.map(e=>`${e.typeId}:${e.count}:${+!!e.isLeader}`).join(`|`);i!==this.lastChipSignature&&(this.chipsEl.replaceChildren(...e.tallies.map(e=>this.chip(e.typeId,e.count,e.isLeader))),this.lastChipSignature=i),this.paintDeploy(e.inspectOnly?{kind:`unable`}:n.deployState)}chip(e,t,n){let r=document.createElement(`button`);r.type=`button`,r.className=n?`hrp-chip leader`:`hrp-chip`,r.title=e;let i=Wm(`div`,`hrp-chip-well`);i.append(Ym());let a=Wm(`span`,`hrp-chip-count`);return a.textContent=`×${t}`,r.append(i,a),r.addEventListener(`click`,()=>this.handlers.onIsolateType(e)),r}paintDeploy(e){let t=e.kind===`transitioning`?`transitioning:${e.to}:${Math.round(e.progress*20)}`:e.kind;t!==this.lastDeploy&&(this.lastDeploy=t,this.root.dataset.deploy=e.kind,this.deployEl.hidden=e.kind===`unable`,this.deployEl.disabled=e.kind===`transitioning`,e.kind===`transitioning`?(this.deployFillEl.style.width=`${Math.round(e.progress*100)}%`,this.deployLabelEl.textContent=e.to?`DEPLOYING`:`PACKING UP`):(this.deployFillEl.style.width=`0%`,this.deployLabelEl.textContent=e.kind===`deployed`?`DEPLOYED`:`DEPLOY`))}write(e,t,n){this[t]!==n&&(e.textContent=n,this[t]=n)}};function Wm(e,t){let n=document.createElement(e);return n.className=t,n}function Gm(){return Math.max(.7,Math.min(1,window.innerWidth/Bm))}function Km(e){return`${e.faction===`machines`?`MACHINES`:`ANCIENT ONES`} · ${e.role.toUpperCase()}`}function qm(e,t){let n=Wm(`div`,`hrp-stat`),r=Wm(`span`,`hrp-stat-label`);r.textContent=e;let i=Wm(`span`,`hrp-stat-value`);return i.textContent=t,n.append(r,i),n}function Jm(e){let t=Wm(`div`,`hrp-stat`),n=Wm(`span`,`hrp-stat-label`);if(n.textContent=`HEALTH`,t.append(n),!e){let e=Wm(`span`,`hrp-stat-value pending`);return e.textContent=`— M5`,t.append(e),t}let r=Wm(`div`,`hrp-health`),i=Math.max(+(e.current>0),Math.floor(e.current/e.max*12));for(let e=0;e<12;e++){let t=Wm(`i`,e<i?`hrp-pip on`:`hrp-pip`);r.append(t)}t.append(r);let a=Wm(`span`,`hrp-stat-value`);return a.textContent=`${Math.max(0,Math.ceil(e.current))}/${e.max}`,t.append(a),t}function Ym(){return Wm(`div`,`hrp-placeholder`)}function Xm(){let e=Wm(`div`,`hrp-portrait-label`);return e.textContent=`unit portrait`,e}function Zm(){let e=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return e.setAttribute(`viewBox`,`0 0 24 24`),e.setAttribute(`width`,`22`),e.setAttribute(`height`,`22`),e.classList.add(`hrp-deploy-icon`),e.innerHTML=`<rect x="9" y="4" width="6" height="11" fill="currentColor"/>
    <rect x="5" y="17" width="14" height="1.8" fill="currentColor"/>
    <path d="M2 12 L6 8.5 V15.5 Z" fill="currentColor"/>
    <path d="M22 12 L18 8.5 V15.5 Z" fill="currentColor"/>`,e}var Qm=!1;function $m(){if(Qm)return;Qm=!0;let e=document.createElement(`style`);e.textContent=eh,document.head.append(e)}var eh=`
.hrp {
  --hud-scale: 1;
  position: fixed;
  bottom: 0;
...
`,th=class{handlers;root;onResize;titleEl;stateEl;humansEl;gridEl;queueRowEl;queueEl;tierEl;noticeEl;producer={kind:`unit`,id:-1};lastTitle=``;lastState=``;lastHumans=``;lastGridSignature=``;lastQueueSignature=``;lastTier=``;lastNotice=null;lastVisible=null;constructor(e,t,n){this.handlers=n,$m(),oh();let r=zm[t];this.root=nh(`div`,`hrp hrp-build`),this.root.dataset.faction=t,Vm(this.root,r,`right`);let i=Hm(r.cornerRight);i.classList.add(`hrp-corner`);let a=nh(`div`,`hrp-shell`),o=nh(`div`,`hrpb-head`),s=nh(`div`,`hrpb-heading`);this.titleEl=nh(`div`,`hrp-name`),this.stateEl=nh(`div`,`hrp-meta`),s.append(this.titleEl,this.stateEl);let c=nh(`div`,`hrpb-bank`),l=nh(`span`,`hrp-stat-label`);l.textContent=`HUMANS`,this.humansEl=nh(`span`,`hrpb-humans`),c.append(l,this.humansEl),o.append(s,c),this.gridEl=nh(`div`,`hrpb-grid`);let u=nh(`div`,`hrpb-foot`);this.queueRowEl=nh(`div`,`hrpb-queue-row`);let d=nh(`span`,`hrp-stat-label`);d.textContent=`QUEUE`,this.queueEl=nh(`div`,`hrpb-queue`),this.queueRowEl.append(d,this.queueEl),this.tierEl=document.createElement(`button`),this.tierEl.type=`button`,this.tierEl.className=`hrpb-tier`,this.tierEl.addEventListener(`click`,()=>this.handlers.onUnlockTier2()),u.append(this.queueRowEl,nh(`div`,`hrpb-spacer`),this.tierEl),this.noticeEl=nh(`div`,`hrpb-notice`),a.append(o,this.gridEl,u,this.noticeEl),this.root.append(a,i),e.append(this.root),this.rescale(),this.onResize=()=>this.rescale(),window.addEventListener(`resize`,this.onResize)}dispose(){window.removeEventListener(`resize`,this.onResize),this.root.remove()}rescale(){this.root.style.setProperty(`--hud-scale`,String(Gm()))}render(e){if(e.visible!==this.lastVisible&&(this.root.classList.toggle(`shown`,e.visible),this.lastVisible=e.visible),!e.visible)return;this.producer=e.producer,e.title!==this.lastTitle&&(this.titleEl.textContent=e.title,this.lastTitle=e.title),e.state!==this.lastState&&(this.stateEl.textContent=e.state,this.lastState=e.state);let t=String(Math.floor(e.humans));t!==this.lastHumans&&(this.humansEl.textContent=t,this.lastHumans=t);let n=e.producesUnits?e.producible.map(e=>`${e.typeId}:${+!!e.enabled}:${+!!e.lockedByTier}:${+!!e.unaffordable}`).join(`|`):`none`;n!==this.lastGridSignature&&(this.gridEl.classList.toggle(`empty`,!e.producesUnits),this.gridEl.replaceChildren(...e.producesUnits?e.producible.map(e=>this.tile(e)):[rh()]),this.lastGridSignature=n),this.queueRowEl.classList.toggle(`empty`,!e.producesUnits);let r=e.queue.map((e,t)=>`${e.typeId}:${t===0?Math.round(e.progress*20):0}`).join(`|`);r!==this.lastQueueSignature&&(this.queueEl.replaceChildren(...e.queue.map((e,t)=>ih(e.name,t===0?e.progress:0,e.secondsLeft,t===0))),this.lastQueueSignature=r);let i=`${e.tier2.unlocked}:${e.tier2.affordable}`;i!==this.lastTier&&(this.tierEl.hidden=e.tier2.unlocked,this.tierEl.disabled=!e.tier2.affordable,this.tierEl.textContent=`UNLOCK TIER 2 · ${e.tier2.cost}`,this.lastTier=i),e.notice!==this.lastNotice&&(this.noticeEl.textContent=e.notice??``,this.noticeEl.classList.toggle(`shown`,e.notice!==null),this.lastNotice=e.notice)}tile(e){let t=document.createElement(`button`);t.type=`button`,t.className=`hrpb-tile`,t.disabled=!e.enabled&&!(e.action===`build`&&e.unaffordable&&!e.lockedByTier),t.title=e.lockedByTier?`${e.name} — requires Tier ${e.tier}`:e.unaffordable?`${e.name} — costs ${e.cost} Humans`:e.name,e.lockedByTier&&(t.dataset.locked=`tier`);let n=nh(`div`,`hrpb-well`);if(e.lockedByTier){let t=nh(`span`,`hrpb-tier-badge`);t.textContent=`TIER ${e.tier}`,n.append(t)}else n.append(nh(`div`,`hrp-placeholder`));let r=nh(`span`,`hrpb-name`);r.textContent=e.name;let i=nh(`div`,`hrpb-costs`),a=nh(`span`,e.unaffordable?`hrpb-cost short`:`hrpb-cost`);a.textContent=String(e.cost);let o=nh(`span`,`hrpb-time`);return o.textContent=`${e.seconds}s`,i.append(a,o),t.append(n,r,i),t.addEventListener(`click`,()=>e.action===`build`?this.handlers.onBuild(this.producer,e.typeId):this.handlers.onProduce(this.producer,e.typeId)),t}};function nh(e,t){let n=document.createElement(e);return n.className=t,n}function rh(){let e=nh(`div`,`hrpb-note`);return e.textContent=`Builds no units. Harvesters deliver here; production is the factory’s.`,e}function ih(e,t,n,r){let i=nh(`div`,r?`hrpb-slot active`:`hrpb-slot`);if(i.title=e,r){let e=nh(`div`,`hrpb-slot-fill`);e.style.height=`${Math.round(t*100)}%`;let r=nh(`span`,`hrpb-slot-label`);r.textContent=`${n.toFixed(1)}s`,i.append(e,r)}return i}var ah=!1;function oh(){if(ah)return;ah=!0;let e=document.createElement(`style`);e.textContent=sh,document.head.append(e)}var sh=`
...
`,ch={machines:{line:`#70e3bd`,chrome:`#25ae8a`,plate:`#3e6354`,onPlate:`#70e3bd`,pipOn:`#a2f1ab`,pipGap:`#0a5913`,pipOff:`#9e9da2`,pipOffGap:`#4c4d52`,accent:`#ffb020`,label:`#f2fff6`,warn:`#e6483d`,go:`#7fe3b0`,font:`"Eurostile", "Bahnschrift", "DIN Alternate", "Arial Narrow", system-ui, sans-serif`,primaryIcon:{width:24,height:24,inner:`<rect x="9" y="4" width="6" height="11" fill="#ffffff"/>
      ...
      <path d="M15 6 L23 13 L15 24 L7 13 Z" fill="#f0f070" stroke="var(--outline)"
        stroke-width="1.6"/>`}}},lh=1920,uh=5,dh=4,fh=30,ph=class{onCommand;root;onResize;skin;humansTrough;meterTroughs;divider;clockEl;alertEl;bannerEl;buttons=new Map;lastClock=``;lastBanner=null;lastAlert=null;constructor(e,t,n){this.onCommand=n,this.skin=ch[t.faction],Dh(),this.root=hh(`div`,`hud`),this.root.dataset.faction=t.faction,this.root.style.setProperty(`--line`,this.skin.line),this.root.style.setProperty(`--chrome`,this.skin.chrome),this.root.style.setProperty(`--plate`,this.skin.plate),this.root.style.setProperty(`--on-plate`,this.skin.onPlate),this.root.style.setProperty(`--pip-on`,this.skin.pipOn),this.root.style.setProperty(`--pip-gap`,this.skin.pipGap),this.root.style.setProperty(`--pip-off`,this.skin.pipOff),this.root.style.setProperty(`--pip-off-gap`,this.skin.pipOffGap),this.root.style.setProperty(`--accent`,this.skin.accent),this.root.style.setProperty(`--label`,this.skin.label),this.root.style.setProperty(`--warn`,this.skin.warn),this.root.style.setProperty(`--go`,this.skin.go),this.root.style.setProperty(`--icon-stroke`,this.skin.outline??`transparent`),this.root.style.setProperty(`--hud-font`,this.skin.font),this.root.style.setProperty(`--band`,this.skin.band),this.root.style.setProperty(`--on-band`,this.skin.onBand),this.root.style.setProperty(`--rail`,`${this.skin.railPx}px`),this.root.style.setProperty(`--divider`,this.skin.divider),this.root.style.setProperty(`--radius`,this.skin.radius),this.root.style.setProperty(`--outline`,this.skin.outline??this.skin.line),this.root.style.setProperty(`--chamfer`,this.skin.chamferPx>0?`polygon(${this.skin.chamferPx}px 0, calc(100% - ${this.skin.chamferPx}px) 0, 100% 100%, 0 100%)`:`none`);let r=hh(`div`,`hud-band`);r.append(bh(this.skin,`left`));let i=hh(`div`,`hud-meters`),a=hh(`div`,`hud-meter`);a.append(gh(`HUMANS`)),this.humansTrough=_h(t.humans.trough.pips),a.append(this.humansTrough.el),i.append(a);let o=hh(`div`,`hud-meter`);o.append(gh(t.meter.label)),this.divider=hh(`div`,`hud-divider`);let s=[];t.meter.troughs.forEach((e,t)=>{t>0&&o.append(this.divider);let n=_h(e.pips);s.push(n),o.append(n.el)}),this.meterTroughs=s,i.append(o),r.append(i,bh(this.skin,`right`)),this.root.append(r);let c=hh(`div`,`hud-island`);c.append(xh(Sh())),this.alertEl=xh(Ch()),this.alertEl.classList.add(`hud-alert`),c.append(this.alertEl),this.clockEl=hh(`div`,`hud-time`),c.append(this.clockEl),this.root.append(c),this.bannerEl=hh(`div`,`hud-banner`),this.root.append(this.bannerEl);let l=hh(`div`,`hud-column`),u=hh(`div`,`hud-collapse`);u.append(yh(this.skin.badge)),l.append(u,hh(`div`,`hud-spine`));let d=hh(`div`,`hud-cluster`);for(let e of t.commands){let t=document.createElement(`button`);t.className=`hud-button`,t.type=`button`,t.title=e.label,t.setAttribute(`aria-label`,e.label),t.innerHTML=wh(e.id,this.skin),t.addEventListener(`click`,()=>this.onCommand(e.id)),this.buttons.set(e.id,t),d.append(t)}l.append(d),this.root.append(l),e.append(this.root),this.rescale(),this.onResize=()=>this.rescale(),window.addEventListener(`resize`,this.onResize),this.render(t)}dispose(){window.removeEventListener(`resize`,this.onResize),this.root.remove()}rescale(){let e=Math.max(.7,Math.min(1,window.innerWidth/lh));this.root.style.setProperty(`--hud-scale`,String(e))}render(e){mh(this.humansTrough,e.humans.trough),e.meter.troughs.forEach((e,t)=>{let n=this.meterTroughs[t];n&&mh(n,e)}),this.divider.classList.toggle(`lit`,e.meter.dividerLit),e.clock!==this.lastClock&&(this.clockEl.textContent=e.clock,this.lastClock=e.clock),e.alert!==this.lastAlert&&(this.alertEl.classList.toggle(`on`,e.alert),this.lastAlert=e.alert),e.banner!==this.lastBanner&&(this.bannerEl.textContent=e.banner??``,this.bannerEl.classList.toggle(`shown`,e.banner!==null),this.lastBanner=e.banner);for(let t of e.commands){let e=this.buttons.get(t.id);e&&(e.disabled=!t.enabled)}}};function mh(e,t){e.pips.forEach((e,n)=>{let r=n<t.filled;e.classList.toggle(`on`,r),e.classList.toggle(`accent`,r&&t.accent)})}function hh(e,t){let n=document.createElement(e);return n.className=t,n}function gh(e){let t=hh(`div`,`hud-label`);return t.textContent=e,t}function _h(e){let t=hh(`div`,`hud-trough`),n=[];for(let r=0;r<e;r++){let e=hh(`i`,`hud-pip`);n.push(e),t.append(e)}return{el:t,pips:n}}function vh(e,t,n){let r=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return r.setAttribute(`viewBox`,`0 0 ${e} ${t}`),r.setAttribute(`width`,String(e)),r.setAttribute(`height`,String(t)),r.innerHTML=n,r}function yh(e){return vh(e.width,e.height,e.inner)}function bh(e,t){let n=yh(e.cap);return n.classList.add(`hud-cap`,t),n}function xh(e){let t=hh(`div`,`hud-plate`);return t.append(e),t}function Sh(){return vh(22,22,`<circle cx="11" cy="11" r="8" fill="none" stroke="var(--on-plate)" stroke-width="2"/>
     <path d="M11 11 V5 A6 6 0 0 1 17 11 Z" fill="var(--on-plate)"/>`)}function Ch(){return vh(22,22,`<rect x="9" y="4" width="4" height="9" rx="1.4" fill="currentColor"/>
     <rect x="8.5" y="15" width="5" height="3.2" rx="1" fill="currentColor"/>`)}function wh(e,t){switch(e){case`primary`:return`<svg viewBox="0 0 ${t.primaryIcon.width} ${t.primaryIcon.height}"
        width="${fh}" height="${fh}">${t.primaryIcon.inner}</svg>`;case`regroup`:return Th(`M12 11 L8.5 6.5 H10.8 V3 H13.2 V6.5 H15.5 Z`,`var(--warn)`,45);case`scatter`:return Th(`M12 3 L15.5 7.5 H13.2 V11 H10.8 V7.5 H8.5 Z`,`var(--go)`,0);case`cancel`:return`<svg viewBox="0 0 24 24" width="${fh}" height="${fh}">
      ...
      </svg>`}}function Th(e,t,n){return`<svg viewBox="0 0 24 24" width="${fh}" height="${fh}">
  ...
  </svg>`}var Eh=!1;function Dh(){if(Eh)return;Eh=!0;let e=document.createElement(`style`);e.textContent=Oh,document.head.append(e)}var Oh=`
.hud {
  --hud-scale: 1;
  position: fixed;
  inset: 0;
...
`;function kh(e,t,n){if(!(t>0)||n<=0||e<=0)return 0;if(e>=t)return n;let r=Math.floor(e/t*n);return Math.min(Math.max(r,1),n-1)}function Ah(e){let t=Math.floor(e/30),n=Math.floor(t/60),r=t%60;return`${n}:${String(r).padStart(2,`0`)}`}function jh(e){let{segments:t,pipsPerSegment:n}=Xf,r=[];for(let i=0;i<t;i++){let t=e-i*n;r.push({pips:n,filled:Math.min(Math.max(Math.floor(t),0),n),accent:i>0})}return r}function Mh({world:e,selected:t,banner:n}){let r=Zf[e.playerFaction],{humans:i,humansCap:a,charge:o,chargeCap:s}=e.resources,c=t>0;return{faction:r.id,factionName:r.name,humans:{value:i,cap:a,trough:{pips:Xf.humansPips,filled:kh(i,a,Xf.humansPips),accent:!1}},meter:{label:r.meterLabel,value:o,cap:s,segmentsReady:e.resources.segmentsReady,troughs:jh(o),dividerLit:o>Xf.pipsPerSegment},clock:Ah(e.tick),alert:e.army.units.some(e=>e.attackCooldown>0),selected:t,commands:[{id:`primary`,label:r.primaryOrder,enabled:r.id===`machines`&&c},{id:`regroup`,label:`Regroup — unresolved reading`,enabled:!1},{id:`scatter`,label:`Scatter — unresolved reading`,enabled:!1},{id:`cancel`,label:`Stop`,enabled:c}],banner:n}}function Nh(e,t){if(!t)return{kind:`unable`};if(e.deployTimer>0){let t=Math.max(Vd,1);return{kind:`transitioning`,to:e.deployTarget,stepsLeft:e.deployTimer,progress:Math.min(Math.max(1-e.deployTimer/t,0),1)}}return e.deployed?{kind:`deployed`}:{kind:`mobile`}}function Ph(e){return e.harvestingBuildingId===null?e.harvestingCrowdId===null?e.cargo>0?`Carrying ${Math.round(e.cargo)}`:e.unreachable?`Could not reach its goal`:e.path.length>0?`Moving`:null:`Harvesting a street crowd`:`Harvesting`}function Fh(e){let t=Sf(e.typeId);return{typeId:t.id,name:t.name,faction:t.faction,role:t.role,cost:t.cost,health:{current:e.health,max:t.health},humansOnboard:t.faction===`machines`&&t.role===`harvester`?{current:e.cargo,max:60}:null,deployState:Nh(e,!!t.canDeploy),activity:Ph(e)}}function Ih(e,t,n){let r=e.playerFaction;if(n&&e.army.typeOf(n).faction!==r)return{mode:`single`,faction:r,selectedCount:1,inspectOnly:!0,leader:Fh(n),tallies:[]};let i=t.list(),a=t.primary(),o=a===void 0?void 0:e.army.get(a);if(!o)return{mode:`none`,faction:r,selectedCount:0,inspectOnly:!1,leader:null,tallies:[]};let s=new Map;for(let t of i){let n=e.army.get(t);n&&s.set(n.typeId,(s.get(n.typeId)??0)+1)}let c=[...s.entries()].map(([e,t])=>({typeId:e,name:Sf(e).name,count:t,isLeader:e===o.typeId})).sort((e,t)=>t.count-e.count||e.typeId.localeCompare(t.typeId));return{mode:i.length>1?`multi`:`single`,faction:r,selectedCount:i.length,inspectOnly:!1,leader:Fh(o),tallies:i.length>1?c:[]}}var Lh={visible:!1,faction:`machines`,producer:{kind:`unit`,id:-1},title:``,state:``,humans:0,producesUnits:!1,producible:[],queue:[],tier2:{unlocked:!1,cost:Hd.tier2Cost,affordable:!1},notice:null};function Rh(e,t,n){if(!t)return Lh;let r=Sf(t.typeId);if(!r.producesUnits&&!r.constructionTypes||r.faction!==e.playerFaction)return Lh;let i=e.resources.humans,a=e.constructionSites.some(e=>e.builderId===t.id),o=r.constructionTypes?bf.filter(e=>r.constructionTypes?.includes(e.id)).map(t=>({action:`build`,typeId:t.id,name:t.name,cost:e.freeProduction?0:t.cost,seconds:Math.round((t.constructionSteps??0)/30),tier:t.tier,lockedByTier:!1,unaffordable:!e.freeProduction&&i<t.cost,enabled:!a&&(e.freeProduction||i>=t.cost)})):bf.filter(e=>r.productionTypes?.includes(e.id)??(e.faction===r.faction&&e.role!==`harbinger`&&!e.processesHumans&&!e.producesUnits)).map(n=>({action:`produce`,typeId:n.id,name:n.name,cost:e.freeProduction?0:n.cost,seconds:Math.round(n.buildSteps/30),tier:n.tier,lockedByTier:n.tier>e.techTier,unaffordable:!e.freeProduction&&i<n.cost,enabled:n.tier<=e.techTier&&(e.freeProduction||i>=n.cost)&&t.deployed&&t.deployTimer===0})).sort((e,t)=>e.tier-t.tier||e.cost-t.cost);return{visible:!0,faction:r.faction,producer:{kind:`unit`,id:t.id},title:r.constructionTypes?`${r.name} — Build`:r.name,state:r.constructionTypes?a?`SUMMONING STRUCTURE`:`CONSTRUCTION AVAILABLE`:t.deployTimer>0?t.deployTarget?`DEPLOYING`:`PACKING UP`:t.deployed?t.queue.length?`DEPLOYED · PRODUCING`:`DEPLOYED`:`MOBILE — CANNOT PRODUCE`,humans:i,producesUnits:!0,producible:o,queue:t.queue.map((e,t)=>({typeId:e.typeId,name:Sf(e.typeId).name,progress:t===0?1-e.remainingSteps/Math.max(Sf(e.typeId).buildSteps,1):0,secondsLeft:e.remainingSteps/30})),tier2:{unlocked:e.techTier>=2,cost:Hd.tier2Cost,affordable:i>=Hd.tier2Cost},notice:n}}var zh={machines:[`Humans in, Progress out. We don't do feelings, we do throughput.`,`Collect. Convert. Repeat. It's not cruelty, it's an assembly line.`,`No detours, no snacking. Just humans on a conveyor belt to somewhere worse.`,`Efficiency is a love language.`],ancients:[`Chant a little, eat a lot.`,`Every summoning circle doubles as a dinner table.`,`The stars aligned. So did our appetite.`,`Insanity is a side effect. Also the main course.`]};function Bh(e){let t=zh[e];return t[Math.floor(Math.random()*t.length)]}var Vh={machines:`ENERGY`,ancients:`INSANITY`},Hh=class{root;constructor(e,t){Yh(),this.root=Uh(`div`,`menu`),this.root.append(qh());let n=Uh(`div`,`menu-panel`),r=document.createElement(`h1`);r.className=`menu-title`,r.innerHTML=`HUMAN<br>RESOURCES`,n.append(r);let i=Uh(`div`,`menu-tagline`);i.append(Uh(`span`,`menu-rule`));let a=Uh(`span`,``);a.textContent=`Choose your apocalypse`,i.append(a),n.append(i);let o=Uh(`div`,`menu-columns`),s=Uh(`div`,`menu-cards`);for(let e of[`machines`,`ancients`])s.append(this.buildCard(e,t.onStart));o.append(s),o.append(this.buildActions(t)),n.append(o),this.root.append(n),e.append(this.root)}buildCard(e,t){let n=Zf[e],r=ch[e],i=document.createElement(`button`);i.type=`button`,i.className=`menu-card`,i.dataset.faction=e,i.style.setProperty(`--card-line`,r.line),i.style.setProperty(`--card-font`,r.font),i.style.setProperty(`--card-pip-on`,r.pipOn),i.style.setProperty(`--card-pip-gap`,r.pipGap),i.style.setProperty(`--card-pip-off`,r.pipOff),i.style.setProperty(`--card-accent`,r.accent),e===`ancients`?(i.style.setProperty(`--card-fill`,r.plate),i.style.setProperty(`--card-ink`,`#4a3520`),i.style.setProperty(`--card-body`,`#20180e`),i.style.setProperty(`--card-label`,`#2f2214`)):(i.style.setProperty(`--card-fill`,`rgba(20, 26, 24, 0.55)`),i.style.setProperty(`--card-ink`,`#f2fff6`),i.style.setProperty(`--card-body`,`#dff3ea`),i.style.setProperty(`--card-label`,r.line));let a=Uh(`div`,`menu-card-head`),o=Uh(`div`,`menu-card-name`);o.textContent=n.name,a.append(o,Kh(e)),i.append(a);let s=Uh(`div`,`menu-card-meter`),c=Uh(`span`,`menu-card-meter-label`);c.textContent=Vh[e],s.append(c,Gh(8,e===`ancients`?6:5,e===`ancients`?2:0)),i.append(s);let l=Uh(`div`,`menu-card-copy`);return l.textContent=Bh(e),i.append(l),i.addEventListener(`click`,()=>t(e)),i}buildActions(e){let t=Uh(`nav`,`menu-actions`);if(e.saved){let n=Zf[e.saved.faction];t.append(Wh(`Resume`,`${n.name} · ${e.saved.clock}`,e.onResume))}let n=e.slotCount??0;if(n>0&&t.append(Wh(`Select save`,n===1?`1 slot`:`${n} slots`,e.onSelectSave)),t.append(Wh(`Settings`,``,e.onSettings)),e.onExit&&t.append(Wh(`Exit`,``,e.onExit,`quiet`)),!e.saved&&n===0){let e=Uh(`div`,`menu-note`);e.textContent=`No saved match`,t.prepend(e)}return t}dispose(){this.root.remove()}};function Uh(e,t){let n=document.createElement(e);return n.className=t,n}function Wh(e,t,n,r=``){let i=document.createElement(`button`);i.type=`button`,i.className=r?`menu-action ${r}`:`menu-action`;let a=Uh(`span`,`menu-action-label`);a.textContent=e;let o=Uh(`span`,`menu-action-meta`);return o.textContent=t,i.append(a,o),i.addEventListener(`click`,n),i}function Gh(e,t,n){let r=Uh(`div`,`menu-trough`);for(let i=0;i<e;i++){let e=Uh(`i`,`menu-pip`);i<t&&e.classList.add(n>0&&i>=t-n?`accent`:`on`),r.append(e)}return r}function Kh(e){let t=ch[e],n=t.cap,r=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return r.setAttribute(`viewBox`,`0 0 ${n.width} ${n.height}`),r.setAttribute(`width`,e===`ancients`?`78`:`92`),r.setAttribute(`height`,e===`ancients`?`42`:`52`),r.classList.add(`menu-card-cap`),r.style.setProperty(`--line`,t.line),r.style.setProperty(`--outline`,t.outline??t.line),r.innerHTML=n.inner,r}function qh(){let e=[34,52,41,68,47,82,58,39,71,50,88,44,63,36,76,55,42,66,48,80],t=100/e.length,n=e.map((e,n)=>`<rect x="${n*t}" y="${100-e}" width="${t+.3}" height="${e}"/>`).join(``),r=Uh(`div`,`menu-skyline`);return r.innerHTML=`<svg viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
    <g fill="#050302">${n}</g>
  </svg>`,r}var Jh=!1;function Yh(){if(Jh)return;Jh=!0;let e=document.createElement(`style`);e.textContent=Xh,document.head.append(e)}var Xh=`
.menu, .fe {
  position: fixed;
  inset: 0;
  z-index: 40;
...
`,Zh=[[`Pan`,`WASD / arrows · middle drag`],[`Zoom`,`wheel`],[`Select · box select`,`left drag`],[`Move order`,`right click`],[`Add to selection`,`shift + click`],[`Control group`,`shift + digit`],[`Clear selection · exit`,`Esc`],[`Stop`,`Q`],[`Quick save · load`,`F5 · F9`],[`Building occupancy indicators`,`I`]],Qh=class{root;constructor(e,t,n){mg(),this.root=ng(`SETTINGS`);let r=tg(`div`,`fe-body`);r.append(rg(`Machines colour`,`Recolours Machine units and structures. Applies to your next match.`,ig(`machines`,t.colourVariant.machines,n.onColourVariant)),rg(`Ancients colour`,`Recolours Ancient units and structures. Applies to your next match.`,ig(`ancients`,t.colourVariant.ancients,n.onColourVariant)),rg(`Diagnostic overlay`,`fps, sim Hz, blocked and stalled counts, nav reachability probe.`,og(t.overlayVisible,n.onToggleOverlay)),rg(`City lighting`,`Warm directional sunlight and cool ambient fill. Off restores the original even lighting rig.`,og(t.cityLighting,n.onToggleCityLighting)),rg(`Enhanced shadows`,`Soft mapped shadows on city geometry. Off restores the original projected-shadow treatment.`,og(t.enhancedShadows,n.onToggleEnhancedShadows)),rg(`Ambient occlusion`,`Subtle local darkening at building bases and in narrow city gaps.`,og(t.ambientOcclusion,n.onToggleAmbientOcclusion)));let i=tg(`section`,`fe-section`),a=tg(`div`,`fe-row-title`);a.textContent=`Controls`;let o=tg(`div`,`fe-row-sub`);o.textContent=`Reference only. Rebinding needs an options system that does not exist yet.`;let s=tg(`div`,`fe-controls`);for(let[e,t]of Zh){let n=tg(`div`,`fe-control`),r=tg(`span`,``);r.textContent=e;let i=tg(`span`,`fe-keys`);i.textContent=t,n.append(r,i),s.append(n)}i.append(a,o,s),r.append(i),this.root.append(r,fg(n.onBack)),e.append(this.root)}dispose(){this.root.remove()}},$h=class{root;constructor(e,t,n){mg(),this.root=ng(`SELECT SAVE`,t.length===1?`1 SLOT`:`${t.length} SLOTS`);let r=tg(`div`,`fe-slots`);if(t.length===0){let e=tg(`div`,`fe-empty`);e.textContent=`No saved matches`,r.append(e)}t.forEach((e,t)=>r.append(sg(e,t===0,n)));let i=tg(`p`,`fe-note`);i.textContent=`One slot for now: F5 always writes “quick”. Naming and multiple slots need a keyed-slot scheme in saveStore.ts — the envelope in sim/save.ts does not need to change.`,this.root.append(r,i,fg(n.onBack)),e.append(this.root)}dispose(){this.root.remove()}},eg=class{root;onKey;constructor(e,t,n){mg(),this.root=tg(`div`,`fe-scrim`);let r=tg(`div`,`fe-dialog`),i=tg(`h2`,`fe-dialog-title`);i.textContent=`ABANDON MATCH?`;let a=tg(`p`,`fe-dialog-body`);a.textContent=`Returns to the title screen. The match is not saved unless you save it first.`;let o=tg(`p`,`fe-dialog-meta`);o.textContent=t?`Last quick save: ${t}`:`No quick save in this session.`;let s=tg(`div`,`fe-dialog-actions`);s.append(dg(`Save and exit`,`primary`,n.onSaveAndExit),dg(`Exit anyway`,`danger`,n.onExitAnyway),dg(`Cancel`,`ghost`,n.onCancel)),r.append(i,a,o,s),this.root.append(r),e.append(this.root),this.onKey=e=>{e.key===`Escape`&&n.onCancel()},window.addEventListener(`keydown`,this.onKey)}dispose(){window.removeEventListener(`keydown`,this.onKey),this.root.remove()}};function tg(e,t){let n=document.createElement(e);return n.className=t,n}function ng(e,t=``){let n=tg(`div`,`fe`),r=tg(`div`,`fe-head`),i=document.createElement(`h1`);if(i.className=`menu-title fe-title`,i.textContent=e,r.append(i),t){let e=tg(`span`,`fe-head-meta`);e.textContent=t,r.append(e)}return n.append(r),n}function rg(e,t,n){let r=tg(`div`,`fe-row`),i=tg(`div`,``),a=tg(`div`,`fe-row-title`);a.textContent=e;let o=tg(`div`,`fe-row-sub`);return o.textContent=t,i.append(a,o),r.append(i,n),r}function ig(e,t,n){let r=tg(`div`,`fe-swatches`);return Ip(e).forEach((i,a)=>{let o=a,s=document.createElement(`button`);s.type=`button`,s.className=t===o?`fe-swatch on`:`fe-swatch`,s.style.setProperty(`--swatch-colour`,ag(i)),s.setAttribute(`aria-label`,`${Zf[e].name} colour option ${a+1}`),s.addEventListener(`click`,()=>n(e,o)),r.append(s)}),r}function ag(e){return`#${e.toString(16).padStart(6,`0`)}`}function og(e,t){let n=document.createElement(`button`);return n.type=`button`,n.className=e?`fe-switch on`:`fe-switch`,n.setAttribute(`role`,`switch`),n.setAttribute(`aria-checked`,String(e)),n.append(tg(`span`,`fe-switch-knob`)),n.addEventListener(`click`,()=>t(!e)),n}function sg(e,t,n){let r=tg(`div`,e.readable?t?`fe-slot primary`:`fe-slot`:`fe-slot broken`),i=tg(`div`,`fe-slot-badge`);e.readable&&e.faction?(i.dataset.faction=e.faction,i.style.setProperty(`--badge-line`,ch[e.faction].line),i.append(lg(e.faction))):i.textContent=`!`;let a=tg(`div`,`fe-slot-text`),o=tg(`div`,`fe-slot-name`);o.textContent=e.readable&&e.faction?`${Zf[e.faction].name} — ${e.slot}`:`Unreadable — ${e.slot}`;let s=tg(`div`,`fe-slot-meta`);return s.textContent=e.readable?`${e.clock} · tick ${e.tick.toLocaleString(`en-GB`)} · saved ${ug(e.savedAtMs)}`:`Written by an older build. Old versions are refused, not migrated.`,a.append(o,s),r.append(i,a),e.readable&&r.append(dg(`Load`,t?`primary`:`ghost`,()=>n.onLoad(e.slot))),r.append(cg(()=>n.onDelete(e.slot))),r}function cg(e){let t=document.createElement(`button`);t.type=`button`,t.className=`fe-button icon`,t.title=`Delete this save`,t.textContent=`×`;let n=!1,r=()=>{n&&(n=!1,t.classList.remove(`armed`),t.textContent=`×`,t.title=`Delete this save`)};return t.addEventListener(`click`,()=>{if(n){e();return}n=!0,t.classList.add(`armed`),t.textContent=`Delete?`,t.title=`Click again to delete`}),t.addEventListener(`pointerleave`,r),t.addEventListener(`blur`,r),t}function lg(e){let t=ch[e],n=t.primaryIcon,r=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);return r.setAttribute(`viewBox`,`0 0 ${n.width} ${n.height}`),r.setAttribute(`width`,`44`),r.setAttribute(`height`,`44`),r.style.setProperty(`--line`,t.line),r.style.setProperty(`--outline`,t.outline??t.line),r.innerHTML=n.inner,r}function ug(e){let t=Math.max(0,Math.round((Date.now()-e)/1e3));if(t<60)return`just now`;let n=Math.round(t/60);if(n<60)return`${n} minute${n===1?``:`s`} ago`;let r=Math.round(n/60);if(r<24)return`${r} hour${r===1?``:`s`} ago`;let i=Math.round(r/24);return i===1?`yesterday`:`${i} days ago`}function dg(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`fe-button ${t}`,r.textContent=e,r.addEventListener(`click`,n),r}function fg(e){let t=tg(`div`,`fe-footer`);return t.append(dg(`Back`,`ghost`,e)),t}var pg=!1;function mg(){if(pg)return;pg=!0;let e=document.createElement(`style`);e.textContent=Xh+hg,document.head.append(e)}var hg=`
.fe {
  display: flex;
  flex-direction: column;
  gap: 26px;
...
`,document.head.append(e)}var Mg=.6,Ng=1.8,Pg=2696995,Fg=Ru+Ng/2;function Ig(){return new bi(Mg,Ng,Mg)}function Lg(){return new $a({color:Pg,flatShading:!0})}var Rg=8,zg=96;function Bg(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var Vg=class{city;army;population;group=new Sn;highlight;civilians;matrix=new qt;highlightGeometry=new Map;constructor(e,t,n){this.city=e,this.army=t,this.population=n,this.highlight=new Jr(new Tr,new $a({color:16719904,flatShading:!0,transparent:!0,opacity:.32,depthWrite:!1,side:2})),this.highlight.visible=!1,this.highlight.renderOrder=7,this.group.add(this.highlight),this.civilians=new oi(Ig(),Lg(),zg),this.civilians.instanceMatrix.setUsage(Be),this.civilians.count=0,this.civilians.frustumCulled=!1,this.group.add(this.civilians)}sync(e,t,n){let r=0,i=!1;for(let t of this.army.units){let n=t.harvestingBuildingId,a=n===null?void 0:this.city.get(n);if(!Wd(a,this.population)||Gd(t.x,t.z,a)>22**2)continue;let o=t.x-a.x,s=t.z-a.z,c=Math.max(Math.hypot(o,s),1),l=yu({x:o/c,z:s/c},-(a.rotation??0)),u=Math.min(Math.abs(l.x)>.001?a.width/2/Math.abs(l.x):1/0,Math.abs(l.z)>.001?a.depth/2/Math.abs(l.z):1/0),d=a.x+o/c*u,f=a.z+s/c*u;for(let n=0;n<Rg&&r<zg;n++){let a=(e+n*5+t.id*11)%30/30,l=(n%3-1)*1.7,u=d+(t.x-d)*a-s/c*l,p=f+(t.z-f)*a+o/c*l;this.matrix.makeTranslation(u,Fg,p),i=Bg(this.civilians,r++,this.matrix)||i}}this.civilians.count=r,i&&(this.civilians.instanceMatrix.needsUpdate=!0);let a=n===void 0?void 0:this.city.get(n),o=Wd(a,this.population)?a:void 0;this.highlight.visible=t&&o!==void 0,t&&o&&(this.highlight.geometry=this.geometryFor(o))}dispose(){for(let e of this.highlightGeometry.values())e.dispose();this.highlight.material.dispose(),this.civilians.geometry.dispose(),this.civilians.material.dispose()}geometryFor(e){let t=`${e.id}:${e.state}`,n=this.highlightGeometry.get(t);if(n)return n;let r=Math.max(e.height*(e.state===`intact`?1:e.state===`damaged`?.54:.06),2.2),i=Ug(Hg(e.clip??this.rectangleFootprint(e),1.02),Ru+.15,Ru+r);return this.highlightGeometry.set(t,i),i}rectangleFootprint(e){let t=e.width/2,n=e.depth/2;return[{x:-t,z:-n},{x:t,z:-n},{x:t,z:n},{x:-t,z:n}].map(t=>{let n=yu(t,e.rotation??0);return{x:e.x+n.x,z:e.z+n.z}})}};function Hg(e,t){let n=0,r=0;for(let t of e)n+=t.x,r+=t.z;return n/=e.length,r/=e.length,e.map(e=>({x:n+(e.x-n)*t,z:r+(e.z-r)*t}))}function Ug(e,t,n){let r=[],i=e.map(e=>new G(e.x,e.z));for(let e of Fa.triangulateShape(i,[])){let a=i[e[0]??-1],o=i[e[1]??-1],s=i[e[2]??-1];!a||!o||!s||(r.push(a.x,n,a.y,o.x,n,o.y,s.x,n,s.y),r.push(s.x,t,s.y,o.x,t,o.y,a.x,t,a.y))}for(let e=0;e<i.length;e++){let a=i[e],o=i[(e+1)%i.length];a&&o&&r.push(a.x,t,a.y,a.x,n,a.y,o.x,t,o.y,o.x,t,o.y,a.x,n,a.y,o.x,n,o.y)}let a=new Tr;return a.setAttribute(`position`,new ur(new Float32Array(r),3)),a.computeVertexNormals(),a}var Wg=2,Gg=32,Kg=640,qg=5,Jg=1.6,Yg=8;function Xg(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var Zg=class{group=new Sn;figures;matrix=new qt;constructor(){this.figures=new oi(Ig(),Lg(),Kg),this.figures.instanceMatrix.setUsage(Be),this.figures.count=0,this.figures.frustumCulled=!1,this.group.add(this.figures)}sync(e,t,n,r){let i=0,a=!1,o=new Map;for(let e of r.units){if(e.harvestingCrowdId===null)continue;let t=o.get(e.harvestingCrowdId);t?t.push(e):o.set(e.harvestingCrowdId,[e])}for(let r of e){let e=r.prevX+(r.x-r.prevX)*t,s=r.prevZ+(r.z-r.prevZ)*t,c=r.trailDirX,l=r.trailDirZ,u=Math.min(Math.max(1,Math.ceil(r.humans/Wg)),Gg),d=2.4+Math.sqrt(u)*1.5,f=(o.get(r.id)??[]).filter(e=>Ud(e.x,e.z,r.x,r.z)<=22**2),p=Math.min(u,f.length*Yg);for(let o=0;o<u&&!(i>=Kg);o++){let u=(Qg(r.id*31+o*7+1)*2-1)*d,m=(Qg(r.id*17+o*13+2)*2-1)*d,h=o%qg*Jg*r.trailStrength,g=e+u-c*h,_=s+m-l*h;if(o<p){let e=f[o%f.length],r=e.prevX+(e.x-e.prevX)*t,i=e.prevZ+(e.z-e.prevZ)*t,a=(n+o*5+e.id*11)%30/30;this.matrix.makeTranslation(g+(r-g)*a,Fg,_+(i-_)*a)}else this.matrix.makeTranslation(g,Fg,_);a=Xg(this.figures,i++,this.matrix)||a}if(i>=Kg)break}this.figures.count=i,a&&(this.figures.instanceMatrix.needsUpdate=!0)}dispose(){this.figures.geometry.dispose(),this.figures.material.dispose()}};function Qg(e){let t=Math.sin(e*127.1)*43758.5453;return t-Math.floor(t)}var $g=48,e_=class{group=new Sn;preview=new Sn;previewTypeId=null;sites=new Map;constructor(){this.group.add(this.preview)}sync(e,t,n,r){e?(this.previewTypeId!==e.structureTypeId&&this.replacePreview(e.structureTypeId),this.preview.visible=!0,this.preview.position.set(e.x,.1,e.z),this.tint(this.preview,t?7729818:15749714,.48)):this.preview.visible=!1;let i=new Set(n.map(e=>e.builderId));for(let[e,t]of this.sites)i.has(e)||(this.group.remove(t.group),i_(t.group),this.sites.delete(e));for(let e of n){let t=this.sites.get(e.builderId);t||(t=this.siteGroup(e),this.sites.set(e.builderId,t),this.group.add(t.group)),t.group.position.set(e.x,.12,e.z);let n=r_(e.summoning?1-e.remainingSteps/Math.max(Sf(e.structureTypeId).constructionSteps??1,1):0,0,1);this.animateSite(t,n,r)}}dispose(){i_(this.group),this.sites.clear()}replacePreview(e){i_(this.preview),this.preview.clear(),this.preview.add(n_(e).group),this.previewTypeId=e}siteGroup(e){let t=Sf(e.structureTypeId).anchoredFootprint,n=Math.hypot((t?.width??18)/2,(t?.depth??18)/2)+2,r=new Sn,i=t_(n),a=n_(e.structureTypeId),o=bm(e.structureTypeId);return i.group.position.y=o.minY+o.height*.5,r.add(i.group,a.group),{group:r,circle:i.group,circleMaterials:i.materials,progressGeometry:i.progressGeometry,progressMaterial:i.progressMaterial,ghostMaterial:a.material}}animateSite(e,t,n){let r=n*.0024+e.group.id*.73,i=.16+t*.68,a=Math.sin(r)*(.13-t*.05);e.ghostMaterial.opacity=r_(i+a,.06,.92);let o=.27+t*.22+Math.sin(r*1.4)*.08;for(let t of e.circleMaterials)t.opacity=r_(o,.12,.62);e.progressMaterial.opacity=r_(o+.2,.3,.82),e.progressGeometry.setDrawRange(0,Math.round(t*$g)*6);let s=1+Math.sin(r*1.4)*.035;e.circle.scale.setScalar(s),e.circle.rotation.y=r*.15}tint(e,t,n){e.traverse(e=>{!(e instanceof Jr)||!(e.material instanceof $a)||(e.material.color.setHex(t),e.material.opacity=n)})}};function t_(e){let t=new Sn,n=[],r=e=>{let t=new $a({color:15786104,flatShading:!0,transparent:!0,opacity:e,depthWrite:!1,side:2});return n.push(t),t},i=(e,t,n)=>{let i=new Jr(new Ba(e,t,48),r(n));return i.rotation.x=-Math.PI/2,i.renderOrder=12,i};t.add(i(e-.62,e,.48),i(e*.56,e*.68,.38));let a=new Ba(e*.3,e*.42,$g);a.setDrawRange(0,0);let o=new $a({color:15786104,flatShading:!0,transparent:!0,opacity:.72,depthWrite:!1,side:2}),s=new Jr(a,o);s.rotation.x=-Math.PI/2,s.renderOrder=14,t.add(s);for(let n=0;n<8;n++){let i=n/8*Math.PI*2,a=new Jr(new bi(.36,.08,e*.18),r(.42));a.position.set(Math.sin(i)*e*.79,.03,Math.cos(i)*e*.79),a.rotation.y=i,a.renderOrder=13,t.add(a)}return{group:t,materials:n,progressGeometry:a,progressMaterial:o}}function n_(e){let t=_m(e),n=new Sn,r=new $a({color:14263807,flatShading:!0,transparent:!0,opacity:.48,depthWrite:!1});return n.add(new Jr(Gp([...t.parts??[],...t.secondary??[],...t.accents??[]]),r)),{group:n,material:r}}function r_(e,t,n){return Math.max(t,Math.min(n,e))}function i_(e){e.traverse(e=>{e instanceof Jr&&(e.geometry.dispose(),e.material instanceof $a&&e.material.dispose())})}var a_=[{facade:12823945,roof:11771002,trim:13416082,window:8942684,rooftop:10587760},{facade:12494723,roof:11244402,trim:13021069,window:8417113,rooftop:9995883},{facade:12165501,roof:10849645,trim:12757638,window:8219735,rooftop:9601128},{facade:13021324,roof:11573880,trim:13613463,window:9140319,rooftop:10521968},{facade:12099966,roof:10849902,trim:12692103,window:8351064,rooftop:9535593},{facade:12626310,roof:11376245,trim:13218446,window:8745820,rooftop:10127467},{facade:12955531,roof:11573624,trim:13547413,window:9008735,rooftop:10390383},{facade:12297344,roof:10981232,trim:12889481,window:8416857,rooftop:9732456},{facade:12626566,roof:11375988,trim:13218446,window:8679771,rooftop:9995883},{facade:13087117,roof:11705210,trim:13678999,window:9140318,rooftop:10587760},{facade:12034431,roof:10718317,trim:12626311,window:8219479,rooftop:9404007},{facade:12889480,roof:11573624,trim:13481618,window:9008477,rooftop:10455918},{facade:12231551,roof:10915696,trim:12823688,window:8416856,rooftop:9666921},{facade:12692102,roof:11376245,trim:13284238,window:8745563,rooftop:10193004},{facade:10650211,roof:8744276,trim:11178095,window:7298122,rooftop:7956047},{facade:9732202,roof:8284503,trim:10389616,window:7035981,rooftop:7693910},{facade:10129774,roof:8551006,trim:10787448,window:7366991,rooftop:8156510},{facade:8154970,roof:6774093,trim:8944228,window:6247752,rooftop:6643024},{facade:10840145,roof:8936778,trim:11368542,window:7492164,rooftop:8347727},{facade:12165220,roof:9994065,trim:12823152,window:7957324,rooftop:9271631}];function o_(e){let t=Math.imul(e.id+1,2654435761)^Math.imul(e.paletteIndex+11,2246822507);return t^=t>>>16,t=Math.imul(t,2146121005),t^=t>>>15,a_[(t>>>0)%a_.length]??a_[0]}var s_=[11028540,3493995,14209990,7307086,9072296,4145992],c_={sky:12048612,skyHorizon:14872553,shardTop:10323041,cliff:[11100220,9260336,7289894],road:10659477,sidewalk:13027512,parking:10132878,laneMarking:14205527,crosswalk:14672082,park:8362574,tree:5204788,treeTrunk:7360569,rubble:12892060,hvac:13027512},l_={intact:1,damaged:.54,rubble:.06},u_=.8,d_=3;function f_(e,t={}){return new $a({color:e,flatShading:!0,...t})}function p_(e){let t=new bi(1,1,1,1,e,1).toNonIndexed(),n=t.getAttribute(`position`),r=new Float32Array(n.count*3);for(let t=0;t<n.count;t+=3){let i=(n.getY(t)+n.getY(t+1)+n.getY(t+2))/3,a=Math.floor((i+.5)*e)%2==0?1:u_;for(let e=0;e<3;e++)r[(t+e)*3]=a,r[(t+e)*3+1]=a,r[(t+e)*3+2]=a}return t.setAttribute(`color`,new ur(r,3)),t}var m_=class{city;group=new Sn;buildingMeshList=[];slots=new Map;detailSlots=new Map;roofs;trims;windowBands;greebles;greebleStart=new Map;debris;matrix=new qt;color=new Y;scale=new K;clipped;clippedState=``;constructor(e){this.city=e;for(let e of this.buildShardTops())this.group.add(e);for(let e of this.buildCliffBands())this.group.add(e);this.group.add(this.buildPads(`built`,c_.sidewalk,Ru)),this.group.add(this.buildPads(`parking`,c_.parking,Ru)),this.group.add(this.buildPads(`park`,c_.sidewalk,Ru)),this.group.add(this.buildParkland()),this.group.add(this.buildRoads());for(let e of this.buildFragmentOverlays())this.group.add(e);let t=this.buildStripes([...this.city.centreLines,...this.city.decorativeFragments.flatMap(e=>e.centreLines)],c_.laneMarking,1.1);t.name=`centre-lines`,this.group.add(t);let n=this.buildStripes(this.city.crosswalks,c_.crosswalk,1.1);n.name=`crosswalks`,this.group.add(n),this.group.add(this.buildTrees()),this.group.add(this.buildCars()),this.group.add(this.buildEdgeRubble());let r=new Map;for(let e of this.city.buildings){if(e.clip)continue;let t=ju(e.height,e.district),n=r.get(t);n?n.push(e):r.set(t,[e])}for(let[e,t]of r){let n=new oi(p_(e),f_(16777215,{vertexColors:!0}),t.length);n.frustumCulled=!1,n.userData.storeys=e,this.buildingMeshList.push(n),this.group.add(n),t.forEach((e,t)=>this.slots.set(e.id,{mesh:n,index:t}))}let i=this.city.buildings.filter(e=>!e.clip);i.forEach((e,t)=>this.detailSlots.set(e.id,t)),this.roofs=new oi(new bi(1,1,1),f_(16777215),Math.max(i.length,1)),this.roofs.name=`building-roofs`,this.roofs.frustumCulled=!1,this.trims=new oi(new bi(1,1,1),f_(16777215),Math.max(i.length,1)),this.trims.name=`building-trims`,this.trims.frustumCulled=!1,this.windowBands=new oi(new bi(1,1,1),f_(16777215),Math.max(i.length,1)),this.windowBands.name=`building-window-bands`,this.windowBands.frustumCulled=!1,this.group.add(this.trims,this.windowBands,this.roofs);let a=0;for(let t of e.buildings)this.greebleStart.set(t.id,a),a+=t.greebles;this.greebles=new oi(new bi(1,1,1),f_(16777215),Math.max(a,1)),this.greebles.name=`rooftop-structures`,this.greebles.frustumCulled=!1,this.group.add(this.greebles),this.debris=new oi(new bi(1,1,1),f_(c_.rubble),Math.max(e.buildings.length*d_,1)),this.debris.frustumCulled=!1,this.group.add(this.debris),this.refreshAll(),this.group.traverse(e=>{e.castShadow=!0,e.receiveShadow=!0})}buildShardTops(){return[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)].map((e,t)=>{let n=e[0];if(!n)throw Error(`city boundary is empty`);let r=new ea;r.moveTo(n.x,-n.z);for(let t=1;t<e.length;t++){let n=e[t];n&&r.lineTo(n.x,-n.z)}r.closePath();let i=new Jr(new Va(r),f_(c_.shardTop));return i.rotation.x=-Math.PI/2,i.name=t<this.city.surfaces.length?`shard-top-${t}`:`shard-chip-top-${t}`,i})}buildCliffBands(){let e=[...this.city.surfaces.map(e=>({points:e,depth:340,chip:!1})),...this.city.decorativeFragments.map(e=>({points:e.boundary,depth:e.depth,chip:!0}))],t=[0,.28,.62,1],n=[];for(let r=0;r<3;r++){let i=c_.cliff[r];if(i===void 0)continue;let a=[];for(let n of e){if(n.chip&&r>0)continue;let e=n.points,i=n.chip?0:-(t[r]??0)*n.depth,o=n.chip?-n.depth:-(t[r+1]??1)*n.depth,s=this.polygonCentre(e),c=[1,.995,.985,.97][r]??1,l=[1,.995,.985,.97][r+1]??.97;for(let t=0;t<e.length;t++){let n=e[t],r=e[(t+1)%e.length];if(!n||!r)continue;let u=this.scaleFrom(n,s,c),d=this.scaleFrom(r,s,c),f=this.scaleFrom(r,s,l),p=this.scaleFrom(n,s,l);a.push(u.x,i,u.z,d.x,i,d.z,f.x,o,f.z,u.x,i,u.z,f.x,o,f.z,p.x,o,p.z)}}let o=new Tr;o.setAttribute(`position`,new ur(new Float32Array(a),3)),o.computeVertexNormals();let s=new Jr(o,f_(i,{side:2}));s.name=`cliff-band-${r}`,n.push(s)}return n}polygonCentre(e){let t=0,n=0;for(let r of e)t+=r.x,n+=r.z;return{x:t/e.length,z:n/e.length}}scaleFrom(e,t,n){return{x:t.x+(e.x-t.x)*n,z:t.z+(e.z-t.z)*n}}buildPads(e,t,n){let r=this.city.blocks.filter(t=>t.kind===e),i=r.map(e=>e.clip??this.rectPoints(e)),a=e===`park`?r.map(e=>{let t=this.parkGrassFootprint(e);return t.length>=3?[t]:[]}):void 0,o=new Jr(this.polygonsGeometry(i,0,n,a),f_(t));return o.name=`${e}-pads`,o}buildParkland(){let e=this.city.blocks.filter(e=>e.kind===`park`).map(e=>this.parkGrassFootprint(e)).filter(e=>e.length>=3),t=new Jr(this.polygonsGeometry(e,0,Ru),f_(c_.park));return t.name=`parkland`,t}parkGrassFootprint(e){let t=e.innerClip;if(!t||t.length<3)return[];let n=e.clip??[];if(!n.length||!t.some(e=>this.distanceToPolygonEdge(e,n)<=1e-4))return t;let r=this.polygonCentre(t),i=Math.max(...t.map(e=>Math.hypot(e.x-r.x,e.z-r.z)),1),a=1-Math.min(.02/i,.001);return t.map(e=>this.scaleFrom(e,r,a))}distanceToPolygonEdge(e,t){let n=1/0;for(let r=0;r<t.length;r++){let i=t[r],a=t[(r+1)%t.length];if(!i||!a)continue;let o=a.x-i.x,s=a.z-i.z,c=Math.max(0,Math.min(1,((e.x-i.x)*o+(e.z-i.z)*s)/Math.max(o*o+s*s,1e-9)));n=Math.min(n,Math.hypot(e.x-(i.x+o*c),e.z-(i.z+s*c)))}return n}buildRoads(){let e=[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)],t=new Jr(this.polygonsGeometry(e,0,1),f_(c_.road));return t.name=`roads`,t}buildFragmentOverlays(){return[{kind:`built`,colour:c_.sidewalk,top:Ru},{kind:`parking`,colour:c_.parking,top:Ru},{kind:`park`,colour:c_.park,top:Ru}].map(e=>{let t=this.city.decorativeFragments.flatMap(t=>t.overlays.filter(t=>t.kind===e.kind).map(e=>e.polygon)),n=new Jr(this.polygonsGeometry(t,0,e.top),f_(e.colour));return n.name=`chip-${e.kind}`,n})}rectPoints(e){return[{x:e.x0,z:e.z0},{x:e.x1,z:e.z0},{x:e.x1,z:e.z1},{x:e.x0,z:e.z1}]}appendPrism(e,t,n,r,i=!0,a=[]){if(t.length<3)return;let o=t.reduce((e,n,r)=>{let i=t[(r+1)%t.length];return i?e+n.x*i.z-i.x*n.z:e},0)>=0?[...t]:[...t].reverse(),s=o.map(e=>new G(e.x,e.z)),c=a.filter(e=>e.length>=3).map(e=>e.map(e=>new G(e.x,e.z))),l=[s,...c].flat(),u=Fa.triangulateShape(s,c);for(let t of u){let n=t[0],i=t[1],a=t[2];if(n===void 0||i===void 0||a===void 0)continue;let o=l[n],s=l[i],c=l[a];!o||!s||!c||((s.x-o.x)*(c.y-o.y)-(s.y-o.y)*(c.x-o.x)>0?e.push(o.x,r,o.y,c.x,r,c.y,s.x,r,s.y):e.push(o.x,r,o.y,s.x,r,s.y,c.x,r,c.y))}if(i)for(let t=0;t<o.length;t++){let i=o[t],a=o[(t+1)%o.length];!i||!a||e.push(i.x,n,i.z,i.x,r,i.z,a.x,n,a.z,a.x,n,a.z,i.x,r,i.z,a.x,r,a.z)}}appendBandedPrism(e,t,n,r,i,a,o){if(n.length<3)return;let s=e.length/3;this.appendPrism(e,n,r,i,!1);for(let n=s;n<e.length/3;n++)t.push(o.r,o.g,o.b);let c=Math.max(1,Math.round(a));for(let a=0;a<c;a++){let s=r+(i-r)*a/c,l=r+(i-r)*(a+1)/c,u=a%2==0?1:u_,d=e.length/3;for(let t=0;t<n.length;t++){let r=n[t],i=n[(t+1)%n.length];!r||!i||e.push(r.x,s,r.z,r.x,l,r.z,i.x,s,i.z,i.x,s,i.z,r.x,l,r.z,i.x,l,i.z)}for(let n=d;n<e.length/3;n++)t.push(o.r*u,o.g*u,o.b*u)}}polygonsGeometry(e,t,n,r){let i=[];e.forEach((e,a)=>this.appendPrism(i,e,t,n,!0,r?.[a]??[]));let a=new Tr;return a.setAttribute(`position`,new ur(new Float32Array(i),3)),a.computeVertexNormals(),a}buildEdgeRubble(){let e=this.city.decorativeFragments.flatMap(e=>e.rubble),t=new Jr(this.polygonsGeometry(e,Ru,Ru+2.2),f_(c_.rubble));return t.name=`edge-rubble`,t}buildClipped(){let e=[],t=[];for(let n of this.city.buildings){if(!n.clip||n.clip.length<3)continue;let r=Math.max(n.height*l_[n.state],2.2);if(n.state===`rubble`?this.color.setHex(c_.rubble):(this.color.setHex(o_(n).facade),n.state===`damaged`&&this.color.multiplyScalar(.76)),n.state===`rubble`){let i=e.length/3;this.appendPrism(e,n.clip,Ru,Ru+r);for(let n=i;n<e.length/3;n++)t.push(this.color.r,this.color.g,this.color.b)}else{let i=ju(r,n.district);this.appendBandedPrism(e,t,n.clip,Ru,Ru+r,i,this.color)}}let n=new Tr;n.setAttribute(`position`,new ur(new Float32Array(e),3)),n.setAttribute(`color`,new ur(new Float32Array(t),3)),n.computeVertexNormals();let r=new Jr(n,f_(16777215,{vertexColors:!0}));return r.name=`clipped-buildings`,r}clippedSignature(){let e=``;for(let t of this.city.buildings)t.clip&&(e+=t.state[0]);return e}rebuildClipped(){let e=this.clippedSignature();if(e===this.clippedState)return;this.clippedState=e;let t=this.buildClipped();if(this.clipped){this.group.remove(this.clipped),this.clipped.geometry.dispose();let e=this.clipped.material;Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}this.clipped=t,t.castShadow=!0,t.receiveShadow=!0,this.group.add(t)}buildStripes(e,t,n){let r=e.map(e=>e.clip??this.rectPoints({x0:e.x-e.width/2,z0:e.z-e.depth/2,x1:e.x+e.width/2,z1:e.z+e.depth/2})),i=new Jr(this.polygonsGeometry(r,0,n),f_(t));return i.frustumCulled=!1,i}buildTrees(){let e=new Sn;e.name=`trees`;let t=new oi(new Ra(2.75,2),f_(c_.tree),Math.max(this.city.trees.length,1));t.name=`tree-canopies`,t.frustumCulled=!1;let n=new oi(new Si(.55,.72,1.5,5),f_(c_.treeTrunk),Math.max(this.city.trees.length,1));return n.name=`tree-stumps`,n.frustumCulled=!1,this.city.trees.forEach((e,r)=>{this.matrix.makeScale(e.scale,e.scale,e.scale),this.matrix.setPosition(e.x,Ru+.75*e.scale,e.z),n.setMatrixAt(r,this.matrix),this.matrix.setPosition(e.x,Ru+3.5*e.scale,e.z),t.setMatrixAt(r,this.matrix)}),t.instanceMatrix.needsUpdate=!0,n.instanceMatrix.needsUpdate=!0,e.add(n,t),e}buildCars(){let e=[...this.city.cars,...this.city.decorativeFragments.flatMap(e=>e.parkedCars)],t=new oi(new bi(1,1,1),f_(16777215),Math.max(e.length,1));return t.name=`cars`,t.frustumCulled=!1,e.forEach((e,n)=>{let r=5.4,i=2.4;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(e.alongX?r:i,2,e.alongX?i:r),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,(e.parked?Ru:1)+1,e.z),t.setMatrixAt(n,this.matrix),this.color.setHex(s_[e.paletteIndex%s_.length]??16777215),t.setColorAt(n,this.color)}),t.instanceMatrix.needsUpdate=!0,t.instanceColor&&(t.instanceColor.needsUpdate=!0),t}refresh(e){let t=this.city.get(e);t&&(this.writeBuilding(t),this.flush(this.slots.get(e)?.mesh),this.flushDetails(),this.debris.instanceMatrix.needsUpdate=!0,t.clip&&this.rebuildClipped())}refreshAll(){for(let e of this.city.buildings)this.writeBuilding(e);for(let e of this.buildingMeshList)this.flush(e);this.flushDetails(),this.debris.instanceMatrix.needsUpdate=!0,this.rebuildClipped()}flush(e){e&&(e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0))}flushDetails(){for(let e of[this.roofs,this.trims,this.windowBands,this.greebles])this.flush(e)}writeBuilding(e){let t=this.slots.get(e.id);if(!t)return;let n=Nu[e.state],r=Math.max(e.height*l_[e.state],2.2),i=e.width*n,a=e.depth*n,o=o_(e);this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(i,r,a),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,Ru+r/2,e.z),t.mesh.setMatrixAt(t.index,this.matrix);let s=o.facade;e.state===`rubble`?this.color.setHex(c_.rubble):(this.color.setHex(s),e.state===`damaged`&&this.color.multiplyScalar(.76)),t.mesh.setColorAt(t.index,this.color),this.writeBuildingDetails(e,i,a,r,o),this.writeGreebles(e,Ru+r),this.writeDebris(e)}writeBuildingDetails(e,t,n,r,i){let a=this.detailSlots.get(e.id);if(a===void 0)return;let o=(t,n,r,i,o,s)=>{this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(n,r,i),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,o,e.z),t.setMatrixAt(a,this.matrix),this.color.setHex(s),e.state===`damaged`&&this.color.multiplyScalar(.76),t.setColorAt(a,this.color)};if(e.state===`rubble`){for(let t of[this.roofs,this.trims,this.windowBands])this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,Ru,e.z),t.setMatrixAt(a,this.matrix);return}let s=.65,c=.42,l=Ru+r,u=Math.min(1.15,Math.max(.65,r*.09)),d=l-Math.min(4.2,Math.max(1.6,r*.22));o(this.trims,t*1.025,c,n*1.025,l-c/2,i.trim),o(this.windowBands,t*1.012,u,n*1.012,d,i.window),o(this.roofs,t*.985,s,n*.985,l+s/2,i.roof)}writeGreebles(e,t){let n=this.greebleStart.get(e.id);if(n===void 0)return;let r=e.state===`intact`;for(let i=0;i<e.greebles;i++){if(!r){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,t,e.z),this.greebles.setMatrixAt(n+i,this.matrix);continue}let a=yu({x:((i+1)/(e.greebles+1)-.5)*e.width*.55,z:((e.id+i)%5/5-.5)*e.depth*.55},e.rotation??0),o=Math.min(e.width,e.depth)*.16,s=o*(.52+(e.id+i)%3*.1);this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(o*1.28,s,o),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+a.x,t+s/2,e.z+a.z),this.greebles.setMatrixAt(n+i,this.matrix),this.color.setHex(c_.hvac),this.greebles.setColorAt(n+i,this.color)}}writeDebris(e){let t=e.id*d_;if(t+d_>this.debris.count)return;let n=e.state===`rubble`;for(let r=0;r<d_;r++){if(!n){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,Ru,e.z),this.debris.setMatrixAt(t+r,this.matrix);continue}let i=e.id*3+r,a=yu({x:(i*37%100/100-.5)*(e.width+16),z:(i*61%100/100-.5)*(e.depth+16)},e.rotation??0),o=Math.min(e.width,e.depth)*(.14+i%4/4*.16);this.matrix.makeScale(o,o*.5,o),this.matrix.setPosition(e.x+a.x,Ru+o*.25,e.z+a.z),this.debris.setMatrixAt(t+r,this.matrix)}}get meshCount(){return this.group.children.length}get buildingMeshes(){return this.buildingMeshList}renderedStoreysOf(e){let t=this.slots.get(e);return typeof t?.mesh.userData.storeys==`number`?t.mesh.userData.storeys:void 0}renderedHeightOf(e){if(this.city.get(e)?.clip)return 2.2;let t=this.slots.get(e);if(t)return t.mesh.getMatrixAt(t.index,this.matrix),this.matrix.elements[5]}dispose(){for(let e of this.group.children)if(e instanceof Jr){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}}},h_=256,g_=180,__=new K(0,1,0);function v_(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}function y_(e,t,n){let r=e.instanceColor,i=t*3;if(r&&Math.fround(n.r)===r.array[i]&&Math.fround(n.g)===r.array[i+1]&&Math.fround(n.b)===r.array[i+2])return!1;e.setColorAt(t,n);let a=e.instanceColor;return a?(a.setUsage(Be),a.addUpdateRange(i,3),!0):!1}function b_(e,t,n){return Math.max(t,Math.min(n,e))}function x_(e){switch(e){case`machine-cannon`:return{colour:Hp(`machines`),width:.82,impact:3.1};case`machine-harbinger-laser`:return{colour:Hp(`machines`),width:.48,impact:2.3};case`machine-rifle`:return{colour:Hp(`machines`),width:.18,impact:1};case`ancient-acid`:return{colour:zp,width:.34,impact:1.7};case`ancient-bite`:return{colour:16760428,width:0,impact:1.8};default:return{colour:16777215,width:.25,impact:1.2}}}var S_=class{group=new Sn;beamsMesh;impactsMesh;matrix=new qt;position=new K;direction=new K;scale=new K;rotation=new Tt;colour=new Y;beams=[];impacts=[];melee=new Map;constructor(){this.beamsMesh=new oi(new Si(1,1,1,6),new Ir({color:16777215,transparent:!0,opacity:.9,depthWrite:!1}),h_),this.impactsMesh=new oi(new Ra(1,1),new Ir({color:16777215,transparent:!0,opacity:.85,depthWrite:!1}),h_);for(let e of[this.beamsMesh,this.impactsMesh])e.instanceMatrix.setUsage(Be),e.count=0;this.beamsMesh.frustumCulled=!1,this.impactsMesh.frustumCulled=!1,this.beamsMesh.renderOrder=20,this.impactsMesh.renderOrder=21,this.group.add(this.beamsMesh,this.impactsMesh)}sync(e,t){for(let n of e)n.kind===`combatHit`&&this.addHit(n,t);this.beams=this.beams.filter(e=>t<e.startedAt+e.duration),this.impacts=this.impacts.filter(e=>t<e.startedAt+e.duration);for(let[e,n]of this.melee)t>=n.startedAt+n.duration&&this.melee.delete(e);this.syncBeams(t),this.syncImpacts(t)}meleePose(e,t){let n=this.melee.get(e);if(!n)return;let r=b_((t-n.startedAt)/n.duration,0,1);if(r>=1)return;let i=Math.sin(r*Math.PI);return{forward:i*n.distance,yaw:i*.18}}addHit(e,t){let n=Gf(e.weaponId),r=x_(e.weaponId),i=bm(e.attackerTypeId),a=bm(e.targetTypeId),o=Math.max(1,i.radius*.48),s=(e.shotIndex-(e.shotCount-1)/2)*Math.max(.8,i.radius*.3),c=new K(e.sourceX+Math.cos(e.sourceHeading)*o-Math.sin(e.sourceHeading)*s,Ru+i.height*.58,e.sourceZ+Math.sin(e.sourceHeading)*o+Math.cos(e.sourceHeading)*s),l=new K(e.targetX,Ru+a.height*.56,e.targetZ);if(n.projectileSpeed===0){this.melee.set(e.attackerId,{startedAt:t,duration:g_,distance:Math.max(.6,i.radius*.1)}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t,duration:130});return}let u=b_(c.distanceTo(l)/n.projectileSpeed*250,65,180);this.pushBeam({start:c,end:l,colour:r.colour,width:r.width,startedAt:t,duration:u}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t+u*.72,duration:120})}pushBeam(e){this.beams.length>=h_&&this.beams.shift(),this.beams.push(e)}pushImpact(e){this.impacts.length>=h_&&this.impacts.shift(),this.impacts.push(e)}syncBeams(e){let t=0,n=!1,r=!1;for(let i of this.beams){let a=b_((e-i.startedAt)/i.duration,0,1);this.direction.subVectors(i.end,i.start).multiplyScalar(a);let o=this.direction.length();if(o<=1e-5)continue;this.direction.normalize(),this.position.copy(i.start).addScaledVector(this.direction,o/2),this.rotation.setFromUnitVectors(__,this.direction);let s=1-a*.55;this.scale.set(i.width*s,o,i.width*s),this.matrix.compose(this.position,this.rotation,this.scale),n=v_(this.beamsMesh,t,this.matrix)||n,this.colour.setHex(i.colour),r=y_(this.beamsMesh,t,this.colour)||r,t++}this.finish(this.beamsMesh,t,n,r)}syncImpacts(e){let t=0,n=!1,r=!1;for(let i of this.impacts){let a=(e-i.startedAt)/i.duration;if(a<0||a>=1)continue;let o=i.radius*(.45+Math.sin(a*Math.PI)*.9);this.matrix.makeScale(o,o,o),this.matrix.setPosition(i.position),n=v_(this.impactsMesh,t,this.matrix)||n,this.colour.setHex(i.colour),r=y_(this.impactsMesh,t,this.colour)||r,t++}this.finish(this.impactsMesh,t,n,r)}finish(e,t,n,r){e.count=t,n&&(e.instanceMatrix.needsUpdate=!0),r&&e.instanceColor&&(e.instanceColor.needsUpdate=!0)}dispose(){this.beamsMesh.geometry.dispose(),this.beamsMesh.material.dispose(),this.impactsMesh.geometry.dispose(),this.impactsMesh.material.dispose()}},C_=[10800,-81e3,10800],w_=35e3,T_=[8433856,8433856,8958144,8960192,9484488],E_=[12636344,11585712,12112064,11585720,12636352,11059376],D_=40,O_=22;function k_(e,t){return(e*17+t*13)%19/18}function A_(e,t,n){let r=Math.atan2(n,e),i=Math.asin(t/Math.hypot(e,t,n)),a=Math.floor((r+Math.PI)/(Math.PI*2)*D_);return Math.floor((i+Math.PI/2)/Math.PI*O_)*D_+a}function j_(){let e=new Ra(w_,5).toNonIndexed(),t=e.getAttribute(`position`),n=new Float32Array(t.count*3),r=new Y;for(let e=0;e<t.count/3;e++){let i=e*3,a=((t.getX(i)??0)+(t.getX(i+1)??0)+(t.getX(i+2)??0))/3,o=((t.getY(i)??0)+(t.getY(i+1)??0)+(t.getY(i+2)??0))/3,s=((t.getZ(i)??0)+(t.getZ(i+1)??0)+(t.getZ(i+2)??0))/3,c=(a+s)*.6+o*.53,l=A_(a,o,s),u=c<w_*.35||k_(l,1)>.48?T_:E_,d=Math.min(u.length-1,Math.floor(k_(l,2)*u.length));r.setHex(u[d]);for(let e=0;e<3;e++){let t=(i+e)*3;n[t]=r.r,n[t+1]=r.g,n[t+2]=r.b}}e.setAttribute(`color`,new ur(n,3));let i=new Jr(e,new Ir({vertexColors:!0,fog:!1}));return i.position.set(C_[0],C_[1],C_[2]),i}var M_=class{group=new Sn;constructor(){this.group.add(j_())}dispose(){for(let e of this.group.children)e instanceof Jr&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose());this.group.clear()}},N_={x:-1244,y:3e3,z:700},P_=16770750,F_=2.6,I_=7438479,L_=.82,R_={x:-N_.x/N_.y,z:-N_.z/N_.y},z_=4096,B_=760,V_=1900,H_=.9;function U_(e,t,n){if(!e.castShadow)return;let r=wt.clamp(n,0,1),i=wt.lerp(B_,V_,r*r),a=i*2/z_,o=Math.round(t.x/a)*a,s=Math.round(t.z/a)*a;e.position.set(N_.x+o,N_.y,N_.z+s),e.target.position.set(o,0,s),e.shadow.camera.left=-i,e.shadow.camera.right=i,e.shadow.camera.top=i,e.shadow.camera.bottom=-i,e.shadow.radius=H_/a,e.shadow.camera.updateProjectionMatrix()}function W_(e={cityLighting:!0,enhancedShadows:!0}){let t=e.cityLighting?new No(P_,F_):new No(16774102,2.05);return e.enhancedShadows?t.position.set(N_.x,N_.y,N_.z):t.position.set(-1,1,0).normalize(),t.castShadow=e.enhancedShadows,e.enhancedShadows?(t.shadow.mapSize.set(z_,z_),t.shadow.camera.left=-1900,t.shadow.camera.right=V_,t.shadow.camera.top=V_,t.shadow.camera.bottom=-1900,t.shadow.camera.near=100,t.shadow.camera.far=6e3,t.shadow.normalBias=.12,t.shadow.bias=-8e-5,t.shadow.radius=H_/(V_*2/z_),t.shadow.camera.updateProjectionMatrix(),t):t}function G_(e={cityLighting:!0,enhancedShadows:!0}){return e.cityLighting?new vo(c_.sky,I_,L_):new vo(c_.sky,7236170,1)}var K_=256,q_=Ru+.12,J_=R_.x,Y_=R_.z,X_=2.75,Z_=6.25,Q_=8,$_=1.4,ev=1,tv=0;function nv(e,t,n){let r=t*16,i=e.instanceMatrix.array;for(let a=0;a<16;a++)if(Math.fround(n.elements[a]??0)!==i[r+a])return e.setMatrixAt(t,n),e.instanceMatrix.addUpdateRange(r,16),!0;return!1}var rv=class{group=new Sn;buildings;contacts;trees;units;matrix=new qt;scale=new K;enhancedShadows;buildingSignature=``;constructor(e,t,n={cityLighting:!0,enhancedShadows:!0,ambientOcclusion:!1}){this.enhancedShadows=n.enhancedShadows;let r=(e,t)=>new $a({color:1512978,flatShading:!0,transparent:!0,opacity:e,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,...t===void 0?{}:{side:t}});this.buildings=new Jr(new Tr,r(n.enhancedShadows?.1:.24)),this.buildings.name=`building-shadows`,this.contacts=new Jr(new Tr,r(.22,2)),this.contacts.name=`building-contact-ao`,this.contacts.visible=n.ambientOcclusion,this.trees=new Jr(new Tr,r(n.enhancedShadows?.13:.24)),this.trees.name=`tree-shadows`,this.units=new oi(new xi(1,12),r(n.enhancedShadows?.18:.24),K_),this.units.visible=!n.enhancedShadows,this.units.instanceMatrix.setUsage(Be),this.units.count=0;for(let e of[this.buildings,this.contacts,this.trees,this.units])e.frustumCulled=!1,e.castShadow=!1,e.receiveShadow=!1;this.group.add(this.buildings,this.contacts,this.trees,this.units),this.rebuildTreeShadows(e),this.sync(e,t)}sync(e,t){let n=e.buildings.map(e=>e.state).join(``);n!==this.buildingSignature&&(this.buildingSignature=n,this.rebuildBuildingShadows(e),this.rebuildBuildingContacts(e));let r=0,i=!1;for(let e of t.units){if(r>=this.units.instanceMatrix.count)break;let n=Cf(t.typeOf(e));this.matrix.makeRotationX(-Math.PI/2),this.scale.set(n*.9,n*.62,1),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+n*.22,q_+.03,e.z+n*.16),i=nv(this.units,r++,this.matrix)||i}this.units.count=r,i&&(this.units.instanceMatrix.needsUpdate=!0)}rebuildBuildingShadows(e){let t=[],n=e.surfaces.flatMap(iv);for(let r of e.buildings){let e=r.state===`intact`?r.height:r.state===`damaged`?r.height*.55:0;if(e<=0)continue;let i=e*(this.enhancedShadows?1:.48),a=this.enhancedShadows?J_:ev,o=this.enhancedShadows?Y_:tv,s=r.clip??Lu(r),c=av([...s,...s.map(e=>({x:e.x+a*i,z:e.z+o*i}))]);this.appendClippedShadow(t,n,c)}let r=this.buildings.geometry,i=new Tr;i.setAttribute(`position`,new ur(new Float32Array(t),3)),i.computeVertexNormals(),this.buildings.geometry=i,r.dispose()}rebuildBuildingContacts(e){let t=[],n=e.surfaces.flatMap(iv);for(let r of e.buildings){if(r.state===`rubble`)continue;let e=r.clip??Lu(r);if(e.length<3)continue;let i=e.map(e=>{let t=e.x-r.x,n=e.z-r.z,i=Math.hypot(t,n)||1;return{x:e.x+t/i*$_,z:e.z+n/i*$_}});for(let r=0;r<e.length;r++){let a=(r+1)%e.length,o=e[r],s=e[a],c=i[r],l=i[a];!o||!s||!c||!l||(this.appendClippedShadow(t,n,[o,l,c]),this.appendClippedShadow(t,n,[o,s,l]))}}let r=this.contacts.geometry,i=new Tr;i.setAttribute(`position`,new ur(new Float32Array(t),3)),i.computeVertexNormals(),this.contacts.geometry=i,r.dispose()}rebuildTreeShadows(e){let t=[],n=e.surfaces.flatMap(iv);for(let r of e.trees){let e=X_*r.scale,i=Z_*r.scale*(this.enhancedShadows?1:.48),a=this.enhancedShadows?J_:ev,o=this.enhancedShadows?Y_:tv,s=Array.from({length:Q_},(t,n)=>{let i=n/Q_*Math.PI*2;return{x:r.x+Math.cos(i)*e,z:r.z+Math.sin(i)*e}});this.appendClippedShadow(t,n,av([...s,...s.map(e=>({x:e.x+a*i,z:e.z+o*i}))]))}let r=this.trees.geometry,i=new Tr;i.setAttribute(`position`,new ur(new Float32Array(t),3)),i.computeVertexNormals(),this.trees.geometry=i,r.dispose()}appendClippedShadow(e,t,n){for(let r of t){let t=Tu(r,n);for(let n=1;n<t.length-1;n++)this.appendTriangle(e,t[0],t[n+1],t[n])}}appendTriangle(e,t,n,r){if(!(!t||!n||!r))for(let i of[t,n,r])e.push(i.x,q_,i.z)}dispose(){for(let e of[this.buildings,this.contacts,this.trees,this.units])e.geometry.dispose(),e.material.dispose()}};function iv(e){if(e.length<3)return[];let t=e.map(e=>new G(e.x,e.z));return Fa.triangulateShape(t,[]).flatMap(t=>{let[n,r,i]=t,a=n===void 0?void 0:e[n],o=r===void 0?void 0:e[r],s=i===void 0?void 0:e[i];return a&&o&&s?[[a,o,s]]:[]})}function av(e){let t=[...e].sort((e,t)=>e.x-t.x||e.z-t.z),n=(e,t,n)=>(t.x-e.x)*(n.z-e.z)-(t.z-e.z)*(n.x-e.x),r=e=>{let t=[];for(let r of e){for(;t.length>=2&&n(t[t.length-2],t[t.length-1],r)<=0;)t.pop();t.push(r)}return t},i=r(t),a=r([...t].reverse());return i.pop(),a.pop(),[...i,...a]}var ov=2400,sv=7e3,cv=1600,lv=1e3;function uv(e,t,n,r){let i=(e,i)=>({x:t+e*r,y:n+i*r}),a=[i(-115,5),i(-75,-25),i(-20,-18),i(5,-48),i(70,-38),i(105,-8),i(92,18),i(-55,24)],o=[a[7],a[6],i(92,43),i(-55,49)],s=[a[6],a[5],i(105,18),i(92,43)],c=(t,n)=>{let r=t[0];if(r){e.beginPath(),e.moveTo(r.x,r.y);for(let n of t.slice(1))e.lineTo(n.x,n.y);e.closePath(),e.fillStyle=n,e.fill()}};c(o,`#dbd8c6`),c(s,`#c9c8bb`),c(a,`#f6f0dd`)}function dv(){let e=document.createElement(`canvas`);e.width=cv,e.height=lv;let t=e.getContext(`2d`);if(t){let n=t.createLinearGradient(0,0,0,e.height);n.addColorStop(0,`#${new Y(c_.sky).getHexString()}`),n.addColorStop(1,`#${new Y(c_.skyHorizon).getHexString()}`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height),uv(t,255,160,.75),uv(t,1240,125,1.1)}let n=new gi(e);return n.colorSpace=Fe,n.needsUpdate=!0,n}var fv=class{scene=new jn;city;units;combat;shadows;skyGradient;earth;sun;constructor(e,t,n={cityLighting:!0,enhancedShadows:!0,ambientOcclusion:!1}){this.skyGradient=dv(),this.scene.background=this.skyGradient,this.scene.fog=new An(c_.skyHorizon,ov,sv),this.earth=new M_,this.scene.add(this.earth.group),this.shadows=new rv(e,t,n),this.scene.add(this.shadows.group),this.city=new m_(e),this.scene.add(this.city.group),this.units=new Tm(t),this.scene.add(this.units.group),this.combat=new S_,this.scene.add(this.combat.group),this.sun=W_(n),this.scene.add(this.sun,this.sun.target),this.scene.add(G_(n))}updateShadowCoverage(e,t){U_(this.sun,e,t)}dispose(){this.city.dispose(),this.units.dispose(),this.combat.dispose(),this.shadows.dispose(),this.earth.dispose(),this.skyGradient.dispose(),this.scene.clear()}},pv=[1,2,3,4,5,6,7,8,9,0],mv=class{ids=[];groups=new Map;get size(){return this.ids.length}list(){return this.ids}has(e){return this.ids.includes(e)}primary(){return this.ids[0]}set(e){this.ids=[...new Set(e)].sort((e,t)=>e-t)}add(e){this.set([...this.ids,...e])}toggle(e){this.set(this.has(e)?this.ids.filter(t=>t!==e):[...this.ids,e])}clear(){this.ids=[]}assignGroup(e,t=this.ids){pv.includes(e)&&this.groups.set(e,[...t])}recallGroup(e){let t=this.groups.get(e);return!t||t.length===0?!1:(this.set(t),!0)}groupSize(e){return this.groups.get(e)?.length??0}occupiedGroups(){return pv.filter(e=>this.groupSize(e)>0)}prune(e){this.ids=this.ids.filter(e);for(let[t,n]of this.groups){let r=n.filter(e);r.length!==n.length&&(r.length===0?this.groups.delete(t):this.groups.set(t,r))}}},hv=1213353265,gv=250,_v=85,vv=100,yv=1800,bv=80,xv=3;function Sv(e,t,n){let r,i=1/0;for(let a of e.buildings){if(a.state===`rubble`)continue;let e=(a.x-t)**2+(a.z-n)**2;e<i&&(i=e,r=a.id)}return r}var Cv=class{windowTicks;ticks=[];earned=[];total=0;last=null;constructor(e=360){this.windowTicks=e}add(e,t){for(this.last!==null&&t>this.last&&(this.total+=t-this.last),this.last=t,this.ticks.push(e),this.earned.push(this.total);this.ticks.length>1&&e-(this.ticks[0]??e)>this.windowTicks;)this.ticks.shift(),this.earned.shift()}get perMinute(){if(this.ticks.length<2)return 0;let e=(this.ticks.at(-1)??0)-(this.ticks[0]??0);return e<=0?0:((this.earned.at(-1)??0)-(this.earned[0]??0))/e*30*60}};function wv(e){switch(e.kind){case`produced`:return`${(e.subject??`UNIT`).toUpperCase()} READY`;case`productionQueued`:return`BUILDING ${(e.subject??`UNIT`).toUpperCase()}`;case`productionRefused`:return`INSUFFICIENT HUMANS`;case`productionBlocked`:return`NO ROOM TO DEPLOY`;case`built`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`buildRefused`:return`CANNOT BUILD HERE`;case`constructionRefusedResources`:return`INSUFFICIENT HUMANS`;case`constructionStarted`:return`${(e.subject??`STRUCTURE`).toUpperCase()} SUMMONING`;case`constructionComplete`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`constructionCancelled`:return`SUMMONING CANCELLED`;case`underAttack`:return`UNIT UNDER ATTACK`;case`combatHit`:return null;case`unitDown`:return`UNIT DESTROYED`;case`victory`:return`HARBINGER DESTROYED`;case`tier2`:return`TIER 2 UNLOCKED`;case`tier2Refused`:return`TIER 2 UNAVAILABLE`;case`structureDown`:return`STRUCTURE DOWN`;case`civiliansDisplaced`:return`${e.count??0} HUMANS DISPLACED`;case`deposited`:return null}}var Tv=new Set([`productionQueued`,`produced`,`productionRefused`,`productionBlocked`,`constructionStarted`,`constructionComplete`,`constructionCancelled`,`constructionRefusedResources`]);function Ev({world:e,renderer:t,renderSettings:n,overlayEl:r,boxEl:i,store:a,onLoadRequested:o,onSeedStepRequested:s,onExitToTitle:c,onBattleFactionRequested:l}){let u=new Bd(e),d=new fv(e.city,e.army,n),f=e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction),p=e.city.startAnchors[e.playerFaction===`machines`?0:1]??{x:0,z:0},m=f.length>0?{x:f.reduce((e,t)=>e+t.x,0)/f.length,z:f.reduce((e,t)=>e+t.z,0)/f.length}:p,h=new Rm(window.innerWidth/window.innerHeight,m),g=new _u(t.domElement),_=new mv,v=new vg(r),y=new gg,b=new Cv,x=new Cv,S=new wg(document.body,e.city,e.population,e.populationCapacity,e.playerFaction),C=new kg(document.body),w=new Vg(e.city,e.army,e.population);d.scene.add(w.group);let T=new Zg;d.scene.add(T.group);let E=new e_;d.scene.add(E.group);let D=null,O=0,k=(e,t)=>{D=e,O=t+yv},A=new ph(document.body,Mh({world:e,selected:0,banner:null}),t=>{t===`cancel`&&_.size>0?e.enqueue(e.playerFaction,{kind:`stop`,unitIds:_.list()}):t===`primary`&&_.size>0&&e.playerFaction===`machines`&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:_.list()})}),j=vv,M=null,N=null,P=new Um(document.body,e.playerFaction,{onDeploy:()=>e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:_.list()}),onIsolateType:t=>{_.set(_.list().filter(n=>e.army.get(n)?.typeId===t))}}),F=new th(document.body,e.playerFaction,{onProduce:(t,n)=>e.enqueue(e.playerFaction,{kind:`produce`,producer:t,typeId:n}),onBuild:(t,n)=>{let r=Sf(n).cost;if(!e.freeProduction&&e.resources.humans<r){k(`INSUFFICIENT HUMANS`,performance.now());return}N={builderId:t.id,structureTypeId:n},k(`CHOOSE SUMMONING SITE`,performance.now())},onUnlockTier2:()=>e.enqueue(e.playerFaction,{kind:`unlockTier2`})}),I=null,ee=0,te=null,ne=!0,re=null,ie=!1,ae=()=>{re?.dispose(),re=null,ie=!1,g.consume()},oe=()=>{re||=(ie=!0,new eg(document.body,te,{onSaveAndExit:()=>{if(!a){ae(),c();return}let t=xp(e);a.put(t,Date.now()).catch(e=>console.error(`save failed`,e)).finally(()=>{ae(),c()})},onExitAnyway:()=>{ae(),c()},onCancel:()=>ae()}))},L=()=>{t.setSize(window.innerWidth,window.innerHeight),h.setAspect(window.innerWidth/window.innerHeight),ne=!0};window.addEventListener(`resize`,L);let se=new G,ce=t=>{let n=Nm(h.camera,e.city,t);return Wd(n===void 0?void 0:e.city.get(n),e.population)?n:void 0},le=t=>{if(_.size===0)return;let n=jm(h.camera,e.army,t),r=n===void 0?void 0:e.army.get(n);if(!(!r||e.army.typeOf(r).faction===e.playerFaction))return _.list().some(t=>{let n=e.army.get(t);if(!n||n.deployTimer>0)return!1;let r=e.army.typeOf(n);return r.faction===e.playerFaction&&(r.weaponIds??[]).some(e=>Gf(e).targetClasses.includes(`unit`))})?r.id:void 0},ue=0,de=null,fe=0,pe=0,me=30,he=gv,ge=0,_e=0,ve=0,ye=!1,be=!1,xe=e.tick,Se=``,Ce=NaN,we=NaN,Te=NaN,Ee=!0,De=0,Oe=!1,ke=n=>{if(Oe)return;let r=de===null?1e3/60:n-de;if(de=n,y.add(r),g.sample(),!ie){h.update(g,r/1e3);let t=N!==null&&g.orderAt!==void 0;t&&(N=null,k(`SUMMONING CANCELLED`,n));let i=g.selectGesture;if(i&&N){if(!i.isBox){se.set((i.rect.x0+i.rect.x1)/2,(i.rect.y0+i.rect.y1)/2);let t=Am(h.camera,se),n=t&&e.constructionPlacement(N.builderId,N.structureTypeId,t.x,t.z);n&&(e.enqueue(e.playerFaction,{kind:`build`,builderId:N.builderId,structureTypeId:N.structureTypeId,x:n.x,z:n.z}),N=null)}}else if(i)if(i.isBox){let t=Fm(h.camera,e.army,i.rect).filter(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});i.additive?_.add(t):_.set(t)}else{se.set((i.rect.x0+i.rect.x1)/2,(i.rect.y0+i.rect.y1)/2);let t=jm(h.camera,e.army,se),r=t===void 0?void 0:e.army.get(t),a=r&&e.army.typeOf(r).faction===e.playerFaction?t:void 0;if(r&&a===void 0)M=r.id,i.additive||_.clear();else if(a===void 0){i.additive||(M=null);let t=_.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),r=km(h.camera,e.crowds.all,se),a=ce(se);t.length>0&&r!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,crowdId:r}),k(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):t.length>0&&a!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,buildingId:a}),k(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):i.additive||_.clear()}else i.additive?(M=null,_.toggle(a)):(M=null,_.set([a]))}for(let e of pv){let t=g.pressModifiers(`Digit${e}`);t&&(t.shift?_.assignGroup(e):_.recallGroup(e))}if(g.wasPressed(`Escape`)&&(N?(N=null,k(`SUMMONING CANCELLED`,n)):_.size>0||M!==null?(_.clear(),M=null):oe()),g.wasPressed(`KeyP`)&&(Ee=!0),g.wasPressed(`KeyI`)&&S.toggle(),e.battlefield&&g.wasPressed(`Digit1`)&&l(`machines`),e.battlefield&&g.wasPressed(`Digit2`)&&l(`ancients`),g.wasPressed(`BracketLeft`)&&s(-1),g.wasPressed(`BracketRight`)&&s(1),g.orderAt&&!t&&_.size>0){let t=_.list(),r=le(g.orderAt),i=t.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),a=km(h.camera,e.crowds.all,g.orderAt),o=ce(g.orderAt);if(r!==void 0){let n=e.army.get(r);n&&e.enqueue(e.playerFaction,{kind:`attack`,unitIds:t,targetId:n.id,x:n.x,z:n.z})}else if(i.length>0&&a!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,crowdId:a}),k(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else if(i.length>0&&o!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,buildingId:o}),k(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else{let n=Am(h.camera,g.orderAt);n&&e.enqueue(e.playerFaction,{kind:`move`,unitIds:t,x:n.x,z:n.z})}}if(g.wasPressed(`KeyQ`)&&_.size>0&&e.enqueue(e.playerFaction,{kind:`stop`,unitIds:_.list()}),g.wasPressed(`KeyX`)){let t=Sv(e.city,h.focus.x,h.focus.z);t!==void 0&&e.enqueue(`debug`,{kind:`damage`,buildingId:t})}if(g.wasPressed(`KeyZ`)&&e.enqueue(`debug`,{kind:`raze`,x:h.focus.x,z:h.focus.z,radius:_v}),g.wasPressed(`KeyB`)){ue=(ue+1)%Mu.length;let t=Mu[ue];e.enqueue(`debug`,{kind:`setAllStates`,state:t})}if(g.wasPressed(`KeyH`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:bv,charge:0}),g.wasPressed(`KeyJ`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:0,charge:xv}),g.wasPressed(`KeyE`)&&_.size>0){let t=Sv(e.city,h.focus.x,h.focus.z);t!==void 0&&Wd(e.city.get(t),e.population)&&(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:_.list(),buildingId:t}),k(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n))}if(g.wasPressed(`KeyR`)&&_.size>0&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:_.list()}),g.wasPressed(`KeyT`)&&e.enqueue(e.playerFaction,{kind:`unlockTier2`}),g.wasPressed(`KeyF`)||g.wasPressed(`KeyG`)){let t=e.army.units.find(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).producesUnits&&t.deployed&&t.deployTimer===0),r=e.playerFaction===`machines`?`machine-infantry`:`ancient-infantry`,i=e.playerFaction===`machines`?`machine-construct`:`ancient-support`;t?e.enqueue(e.playerFaction,{kind:`produce`,producer:{kind:`unit`,id:t.id},typeId:g.wasPressed(`KeyG`)?i:r}):k(`NO DEPLOYED FACTORY`,n)}if(g.wasPressed(`KeyV`)){let t=_.primary()===void 0?void 0:e.army.get(_.primary());t&&e.army.typeOf(t).canDeploy&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:[t.id]})}if(g.wasPressed(`F5`)&&a){let t=xp(e);k(`SAVING`,n),a.put(t,Date.now()).then(()=>{k(`SAVED · STEP ${t.tick}`,performance.now()),te=`step ${t.tick}`}).catch(e=>{console.error(`save failed`,e),k(`SAVE FAILED`,performance.now())})}g.wasPressed(`F9`)&&o()}if(g.dragRect&&!ie){let e=g.dragRect;i.style.display=`block`,i.style.left=`${(e.x0+1)/2*100}%`,i.style.top=`${(1-e.y1)/2*100}%`,i.style.width=`${(e.x1-e.x0)/2*100}%`,i.style.height=`${(e.y1-e.y0)/2*100}%`}else i.style.display=`none`;g.consume();let c=performance.now(),f=u.advance(ie?0:r),p=e.drainChangedBuildings();if(p.length>0)if(ge=performance.now()-c,Ee=!0,p.length>8)d.city.refreshAll();else for(let e of p)d.city.refresh(e);let m=e.drainEvents(),re=m.some(e=>e.kind===`combatHit`||e.kind===`unitDown`);d.combat.sync(m,n);for(let e of m){let t=wv(e);t&&(k(t,n),Tv.has(e.kind)&&(I=t,ee=n+yv))}_.prune(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});let ae=_.list(),L=`${M??``}|${ae.join(`,`)}`,Ae=L!==Se;Se=L;let R=h.camera,je=ne||Math.abs(R.position.x-Ce)>.01||Math.abs(R.position.y-we)>.01||Math.abs(R.position.z-Te)>.01;ne=!1,Ce=R.position.x,we=R.position.y,Te=R.position.z;let Me=e.tick!==xe;xe=e.tick;let Ne=p.length>0||Me&&e.army.units.some(Ef),z=le(g.pointer);d.units.sync(e.army,f,t=>{let n=e.army.get(t);if(t===z)return`#ff2020`;if((_.has(t)||t===M)&&n)return ch[e.army.typeOf(n).faction].line},e=>d.combat.meleePose(e,n)),C.sync({army:e.army,camera:R,nowMs:n,cameraDirty:je,stateDirty:re,selectionDirty:Ae,selectedIds:ae,inspectedEnemyId:M}),(Me||p.length>0)&&d.shadows.sync(e.city,e.army),T.sync(e.crowds.all,f,e.tick,e.army);let Pe=ae.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`});S.setSelectionEnabled(Pe.length>0),S.sync({camera:R,zoomFraction:h.zoomFraction,nowMs:n,cameraDirty:je,populationDirty:Ne});let B=Pe.length>0?ce(g.pointer):void 0;w.sync(e.tick,Pe.length>0,B);let Fe=N?Am(h.camera,g.pointer):void 0,V=N!==null&&Fe!==void 0&&e.constructionPlacement(N.builderId,N.structureTypeId,Fe.x,Fe.z)!==void 0;if(E.sync(N&&Fe?{structureTypeId:N.structureTypeId,x:Fe.x,z:Fe.z}:void 0,V,e.constructionSites,n),d.updateShadowCoverage(h.focus,h.zoomFraction),t.render(d.scene,h.camera),M!==null&&e.army.get(M)===void 0&&(M=null),j+=r,j>=vv){j=0,D!==null&&n>O&&(D=null),I!==null&&n>ee&&(I=null),A.render(Mh({world:e,selected:_.size,banner:D})),P.render(Ih(e,_,M===null?void 0:e.army.get(M)));let t=_.primary()===void 0?void 0:e.army.get(_.primary());F.render(Rh(e,t,I))}if(pe+=r,pe>=1e3&&(me=(u.stepCount-fe)/pe*1e3,fe=u.stepCount,pe=0),b.add(e.tick,e.resources.humans),x.add(e.tick,e.resources.charge),he+=r,he>=gv){if(he=0,Ee){Ee=!1;let t=e.city.startAnchors[0];if(t){let n={x:h.focus.x,z:h.focus.z},r=e.nav.onShardCells,i=e.nav.flood(t.x,t.z,`small`,n),a=e.nav.flood(t.x,t.z,`large`,n);_e=i.count/r,ve=a.count/r,ye=i.reachedTarget,be=a.reachedTarget}}let[t,n,r]=e.destructionCounts();v.render({faction:Zf[e.playerFaction].name,battlefield:e.battlefield,seed:e.seed,fps:y.fps,simHz:me,stepCount:e.tick,droppedMs:u.droppedMs,alpha:f,zoomFraction:h.zoomFraction,pitchDeg:h.pitchDeg,distance:h.camera.position.distanceTo(h.focus),focusX:h.focus.x,focusZ:h.focus.z,cityBuildings:e.city.buildings.length,cityIntact:t??0,cityDamaged:n??0,cityRubble:r??0,populationLabels:S.enabled,units:e.army.units.length,unitsMoving:e.army.countMoving(),unitsBlocked:e.army.countBlocked(),unitsUnreached:e.army.countUnreached(),unitsStalled:e.army.countStalled(),selected:_.size,groups:_.occupiedGroups(),pathsQueued:e.army.pending,pathsTotal:e.army.pathsTotal,navCells:e.nav.cellCount,navRebuilds:e.nav.rebuildCount,navLastRebuildCells:e.nav.lastRebuildCells,navRebuildMs:ge,smallPassable:e.nav.passableFraction(`small`),largePassable:e.nav.passableFraction(`large`),reachSmall:_e,reachLarge:ve,atFocusSmall:ye,atFocusLarge:be,humans:e.resources.humans,humansCap:e.resources.humansCap,charge:e.resources.charge,chargeCap:e.resources.chargeCap,chargeSegments:e.resources.segmentsReady,techTier:e.techTier,humansPerMinute:b.perMinute,chargePerMinute:x.perMinute,cargoInTransit:e.cargoInTransit(),populationRemaining:e.remainingPopulation(),populationTotal:e.populationCapacity.reduce((e,t)=>e+t,0),structures:e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).role===`structure`).length,queued:e.queuedProduction(),civilianCrowds:e.crowds.all.length,civilianHumans:e.crowds.totalHumans(),harvesting:e.army.units.filter(Ef).length,harvestIdle:e.harvestersIdle(),unitsDeployed:e.army.countDeployed(),unitsDeploying:e.army.countDeploying()},y)}De=requestAnimationFrame(ke)};return De=requestAnimationFrame(ke),{dispose(){Oe=!0,cancelAnimationFrame(De),window.removeEventListener(`resize`,L),g.dispose(),A.dispose(),P.dispose(),F.dispose(),ae(),d.dispose(),S.dispose(),C.dispose(),w.dispose(),T.dispose(),E.dispose(),i.style.display=`none`}}}async function Dv(){let e=window.location.pathname.endsWith(`/battle.html`),t=document.getElementById(`overlay`),n=document.getElementById(`overlay-content`),r=document.getElementById(`overlay-toggle`),i=document.getElementById(`selectbox`);if(!t||!n||!(r instanceof HTMLButtonElement)||!i)throw Error(`overlay controls or #selectbox missing from the page shell`);r.addEventListener(`click`,()=>{let e=t.classList.toggle(`minimized`);r.textContent=e?`+`:`−`,r.title=e?`Restore developer panel`:`Minimize developer panel`,r.setAttribute(`aria-expanded`,String(!e))});let a=new pu({antialias:!0,powerPreference:`high-performance`});a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.shadowMap.enabled=!0,a.shadowMap.type=1,a.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(a.domElement);let o=kp.available?new kp:null;o||console.warn(`IndexedDB unavailable; saving is disabled for this session`);let s=kv();Fp(`machines`,s.colourVariant.machines),Fp(`ancients`,s.colourVariant.ancients);let c=()=>{t.style.display=s.overlayVisible?``:`none`};c();let l=null,u=null,d=e=>{u?.dispose(),u=e},f=e=>{d(null),l?.dispose(),a.shadowMap.enabled=s.enhancedShadows,l=Ev({world:e,renderer:a,renderSettings:s,overlayEl:n,boxEl:i,store:o,onLoadRequested:p,onSeedStepRequested:t=>{let n=e.seed+t>>>0;queueMicrotask(()=>f(e.battlefield?new yp(n,e.playerFaction,{battlefield:!0}):new yp(n,e.playerFaction)))},onExitToTitle:()=>{l?.dispose(),l=null,m()},onBattleFactionRequested:t=>{!e.battlefield||t===e.playerFaction||queueMicrotask(()=>f(new yp(e.seed,t,{battlefield:!0})))}})},p=e=>{o&&o.get(e).then(e=>{if(!e){console.warn(o.lastRejection??`no save to load`);return}f(Sp(e.envelope))}).catch(e=>console.error(`load failed`,e))},m=async()=>{let e=o?await o.get().catch(()=>void 0):void 0,t=o?await o.list().catch(()=>[]):[];d(new Hh(document.body,{saved:e&&{faction:e.envelope.playerFaction,tick:e.envelope.tick,clock:Ah(e.envelope.tick)},slotCount:t.length,onStart:e=>f(new yp(hv,e)),onResume:()=>p(),onSelectSave:()=>void g(),onSettings:()=>h()}))},h=()=>{d(new Qh(document.body,s,{onColourVariant:(e,t)=>{s.colourVariant[e]=t,Fp(e,t),Av(s),h()},onToggleOverlay:e=>{s.overlayVisible=e,Av(s),c(),h()},onToggleCityLighting:e=>{s.cityLighting=e,Av(s),h()},onToggleEnhancedShadows:e=>{s.enhancedShadows=e,a.shadowMap.enabled=e,Av(s),h()},onToggleAmbientOcclusion:e=>{s.ambientOcclusion=e,Av(s),h()},onBack:()=>void m()}))},g=async()=>{let e=o?await o.list().catch(()=>[]):[];d(new $h(document.body,e.map(e=>({slot:e.slot,faction:e.readable?e.envelope.playerFaction:void 0,clock:Ah(e.envelope.tick??0),tick:e.envelope.tick??0,savedAtMs:e.savedAtMs,readable:e.readable})),{onLoad:e=>p(e),onDelete:e=>{o&&o.delete(e).then(()=>g()).catch(e=>console.error(`delete failed`,e))},onBack:()=>void m()}))},_=new URLSearchParams(window.location.search).get(`faction`);if(e){f(new yp(hv,_===`ancients`?`ancients`:`machines`,{battlefield:!0}));return}if(_===`machines`||_===`ancients`){f(new yp(hv,_));return}await m()}var Ov=`human-resources.frontend`;function kv(){let e={colourVariant:{machines:0,ancients:0},overlayVisible:!0,cityLighting:!0,enhancedShadows:!0,ambientOcclusion:!1};try{let t=window.localStorage.getItem(Ov);if(!t)return e;let n=JSON.parse(t),r=e=>+(e===1);return{colourVariant:{machines:r(n.colourVariant?.machines),ancients:r(n.colourVariant?.ancients)},overlayVisible:n.overlayVisible!==!1,cityLighting:n.cityLighting!==!1,enhancedShadows:n.enhancedShadows!==!1,ambientOcclusion:n.ambientOcclusion===!0}}catch{return e}}function Av(e){try{window.localStorage.setItem(Ov,JSON.stringify(e))}catch{}}Dv();
...
`,document.head.append(e)}var wg=.6,Tg=1.8,Eg=2696995,Dg=Iu+Tg/2;function Og(){return new vi(wg,Tg,wg)}function kg(){return new Za({color:Eg,flatShading:!0})}var Ag=8,jg=96,Mg=class{city;army;population;group=new xn;highlight;civilians;matrix=new Kt;highlightGeometry=new Map;constructor(e,t,n){this.city=e,this.army=t,this.population=n,this.highlight=new qr(new wr,new Za({color:16719904,flatShading:!0,transparent:!0,opacity:.32,depthWrite:!1,side:2})),this.highlight.visible=!1,this.highlight.renderOrder=7,this.group.add(this.highlight),this.civilians=new ai(Og(),kg(),jg),this.civilians.frustumCulled=!1,this.group.add(this.civilians)}sync(e,t,n){let r=0;for(let t of this.army.units){let n=t.harvestingBuildingId,i=n===null?void 0:this.city.get(n);if(!Hd(i,this.population)||Ud(t.x,t.z,i)>22**2)continue;let a=t.x-i.x,o=t.z-i.z,s=Math.max(Math.hypot(a,o),1),c=_u({x:a/s,z:o/s},-(i.rotation??0)),l=Math.min(Math.abs(c.x)>.001?i.width/2/Math.abs(c.x):1/0,Math.abs(c.z)>.001?i.depth/2/Math.abs(c.z):1/0),u=i.x+a/s*l,d=i.z+o/s*l;for(let n=0;n<Ag&&r<jg;n++){let i=(e+n*5+t.id*11)%30/30,c=(n%3-1)*1.7,l=u+(t.x-u)*i-o/s*c,f=d+(t.z-d)*i+a/s*c;this.matrix.makeTranslation(l,Dg,f),this.civilians.setMatrixAt(r++,this.matrix)}}for(let e=r;e<this.civilians.count;e++)this.civilians.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.civilians.instanceMatrix.needsUpdate=!0;let i=n===void 0?void 0:this.city.get(n),a=Hd(i,this.population)?i:void 0;this.highlight.visible=t&&a!==void 0,t&&a&&(this.highlight.geometry=this.geometryFor(a))}dispose(){for(let e of this.highlightGeometry.values())e.dispose();this.highlight.material.dispose(),this.civilians.geometry.dispose(),this.civilians.material.dispose()}geometryFor(e){let t=`${e.id}:${e.state}`,n=this.highlightGeometry.get(t);if(n)return n;let r=Math.max(e.height*(e.state===`intact`?1:e.state===`damaged`?.54:.06),2.2),i=Pg(Ng(e.clip??this.rectangleFootprint(e),1.02),Iu+.15,Iu+r);return this.highlightGeometry.set(t,i),i}rectangleFootprint(e){let t=e.width/2,n=e.depth/2;return[{x:-t,z:-n},{x:t,z:-n},{x:t,z:n},{x:-t,z:n}].map(t=>{let n=_u(t,e.rotation??0);return{x:e.x+n.x,z:e.z+n.z}})}};function Ng(e,t){let n=0,r=0;for(let t of e)n+=t.x,r+=t.z;return n/=e.length,r/=e.length,e.map(e=>({x:n+(e.x-n)*t,z:r+(e.z-r)*t}))}function Pg(e,t,n){let r=[],i=e.map(e=>new G(e.x,e.z));for(let e of Na.triangulateShape(i,[])){let a=i[e[0]??-1],o=i[e[1]??-1],s=i[e[2]??-1];!a||!o||!s||(r.push(a.x,n,a.y,o.x,n,o.y,s.x,n,s.y),r.push(s.x,t,s.y,o.x,t,o.y,a.x,t,a.y))}for(let e=0;e<i.length;e++){let a=i[e],o=i[(e+1)%i.length];a&&o&&r.push(a.x,t,a.y,a.x,n,a.y,o.x,t,o.y,o.x,t,o.y,a.x,n,a.y,o.x,n,o.y)}let a=new wr;return a.setAttribute(`position`,new lr(new Float32Array(r),3)),a.computeVertexNormals(),a}var Fg=2,Ig=32,Lg=640,Rg=5,zg=1.6,Bg=8,Vg=class{group=new xn;figures;matrix=new Kt;constructor(){this.figures=new ai(Og(),kg(),Lg),this.figures.frustumCulled=!1,this.group.add(this.figures)}sync(e,t,n,r){let i=0;for(let a of e){let e=a.prevX+(a.x-a.prevX)*t,o=a.prevZ+(a.z-a.prevZ)*t,s=a.trailDirX,c=a.trailDirZ,l=Math.min(Math.max(1,Math.ceil(a.humans/Fg)),Ig),u=2.4+Math.sqrt(l)*1.5,d=r.units.filter(e=>e.harvestingCrowdId===a.id&&Vd(e.x,e.z,a.x,a.z)<=22**2),f=Math.min(l,d.length*Bg);for(let r=0;r<l&&!(i>=Lg);r++){let l=(Hg(a.id*31+r*7+1)*2-1)*u,p=(Hg(a.id*17+r*13+2)*2-1)*u,m=r%Rg*zg*a.trailStrength,h=e+l-s*m,g=o+p-c*m;if(r<f){let e=d[r%d.length],i=e.prevX+(e.x-e.prevX)*t,a=e.prevZ+(e.z-e.prevZ)*t,o=(n+r*5+e.id*11)%30/30;this.matrix.makeTranslation(h+(i-h)*o,Dg,g+(a-g)*o)}else this.matrix.makeTranslation(h,Dg,g);this.figures.setMatrixAt(i++,this.matrix)}if(i>=Lg)break}for(let e=i;e<this.figures.count;e++)this.figures.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.figures.instanceMatrix.needsUpdate=!0}dispose(){this.figures.geometry.dispose(),this.figures.material.dispose()}};function Hg(e){let t=Math.sin(e*127.1)*43758.5453;return t-Math.floor(t)}var Ug=48,Wg=class{group=new xn;preview=new xn;previewTypeId=null;sites=new Map;constructor(){this.group.add(this.preview)}sync(e,t,n,r){e?(this.previewTypeId!==e.structureTypeId&&this.replacePreview(e.structureTypeId),this.preview.visible=!0,this.preview.position.set(e.x,.1,e.z),this.tint(this.preview,t?7729818:15749714,.48)):this.preview.visible=!1;let i=new Set(n.map(e=>e.builderId));for(let[e,t]of this.sites)i.has(e)||(this.group.remove(t.group),Jg(t.group),this.sites.delete(e));for(let e of n){let t=this.sites.get(e.builderId);t||(t=this.siteGroup(e),this.sites.set(e.builderId,t),this.group.add(t.group)),t.group.position.set(e.x,.12,e.z);let n=qg(e.summoning?1-e.remainingSteps/Math.max(bf(e.structureTypeId).constructionSteps??1,1):0,0,1);this.animateSite(t,n,r)}}dispose(){Jg(this.group),this.sites.clear()}replacePreview(e){Jg(this.preview),this.preview.clear(),this.preview.add(Kg(e).group),this.previewTypeId=e}siteGroup(e){let t=bf(e.structureTypeId).anchoredFootprint,n=Math.hypot((t?.width??18)/2,(t?.depth??18)/2)+2,r=new xn,i=Gg(n),a=Kg(e.structureTypeId),o=vm(e.structureTypeId);return i.group.position.y=o.minY+o.height*.5,r.add(i.group,a.group),{group:r,circle:i.group,circleMaterials:i.materials,progressGeometry:i.progressGeometry,progressMaterial:i.progressMaterial,ghostMaterial:a.material}}animateSite(e,t,n){let r=n*.0024+e.group.id*.73,i=.16+t*.68,a=Math.sin(r)*(.13-t*.05);e.ghostMaterial.opacity=qg(i+a,.06,.92);let o=.27+t*.22+Math.sin(r*1.4)*.08;for(let t of e.circleMaterials)t.opacity=qg(o,.12,.62);e.progressMaterial.opacity=qg(o+.2,.3,.82),e.progressGeometry.setDrawRange(0,Math.round(t*Ug)*6);let s=1+Math.sin(r*1.4)*.035;e.circle.scale.setScalar(s),e.circle.rotation.y=r*.15}tint(e,t,n){e.traverse(e=>{!(e instanceof qr)||!(e.material instanceof Za)||(e.material.color.setHex(t),e.material.opacity=n)})}};function Gg(e){let t=new xn,n=[],r=e=>{let t=new Za({color:15786104,flatShading:!0,transparent:!0,opacity:e,depthWrite:!1,side:2});return n.push(t),t},i=(e,t,n)=>{let i=new qr(new Ra(e,t,48),r(n));return i.rotation.x=-Math.PI/2,i.renderOrder=12,i};t.add(i(e-.62,e,.48),i(e*.56,e*.68,.38));let a=new Ra(e*.3,e*.42,Ug);a.setDrawRange(0,0);let o=new Za({color:15786104,flatShading:!0,transparent:!0,opacity:.72,depthWrite:!1,side:2}),s=new qr(a,o);s.rotation.x=-Math.PI/2,s.renderOrder=14,t.add(s);for(let n=0;n<8;n++){let i=n/8*Math.PI*2,a=new qr(new vi(.36,.08,e*.18),r(.42));a.position.set(Math.sin(i)*e*.79,.03,Math.cos(i)*e*.79),a.rotation.y=i,a.renderOrder=13,t.add(a)}return{group:t,materials:n,progressGeometry:a,progressMaterial:o}}function Kg(e){let t=hm(e),n=new xn,r=new Za({color:14263807,flatShading:!0,transparent:!0,opacity:.48,depthWrite:!1});return n.add(new qr(Up([...t.parts??[],...t.secondary??[],...t.accents??[]]),r)),{group:n,material:r}}function qg(e,t,n){return Math.max(t,Math.min(n,e))}function Jg(e){e.traverse(e=>{e instanceof qr&&(e.geometry.dispose(),e.material instanceof Za&&e.material.dispose())})}var Yg=[13215870,13215870,13215870,11570272,11570272,10580815,10580815,14208942,13878668,9408867,6317130],Xg=[11028540,3493995,14209990,7307086,9072296,4145992],Zg={sky:14145730,shardTop:10323041,cliff:[11100220,9260336,7289894],road:10659477,sidewalk:13027512,parking:10132878,laneMarking:14205527,crosswalk:14672082,park:8362574,tree:5204788,treeTrunk:7360569,rubble:12892060,greeble:11118485},Qg={intact:1,damaged:.54,rubble:.06},$g=.8,e_=3;function t_(e,t={}){return new Za({color:e,flatShading:!0,...t})}function n_(e){let t=new vi(1,1,1,1,e,1).toNonIndexed(),n=t.getAttribute(`position`),r=new Float32Array(n.count*3);for(let t=0;t<n.count;t+=3){let i=(n.getY(t)+n.getY(t+1)+n.getY(t+2))/3,a=Math.floor((i+.5)*e)%2==0?1:$g;for(let e=0;e<3;e++)r[(t+e)*3]=a,r[(t+e)*3+1]=a,r[(t+e)*3+2]=a}return t.setAttribute(`color`,new lr(r,3)),t}var r_=class{city;group=new xn;buildingMeshList=[];slots=new Map;greebles;greebleStart=new Map;debris;matrix=new Kt;color=new Y;scale=new K;clipped;clippedState=``;constructor(e){this.city=e;for(let e of this.buildShardTops())this.group.add(e);for(let e of this.buildCliffBands())this.group.add(e);this.group.add(this.buildPads(`built`,Zg.sidewalk,Iu)),this.group.add(this.buildPads(`parking`,Zg.parking,Iu)),this.group.add(this.buildPads(`park`,Zg.sidewalk,Iu)),this.group.add(this.buildParkland()),this.group.add(this.buildRoads());for(let e of this.buildFragmentOverlays())this.group.add(e);let t=this.buildStripes([...this.city.centreLines,...this.city.decorativeFragments.flatMap(e=>e.centreLines)],Zg.laneMarking,1.1);t.name=`centre-lines`,this.group.add(t);let n=this.buildStripes(this.city.crosswalks,Zg.crosswalk,1.1);n.name=`crosswalks`,this.group.add(n),this.group.add(this.buildTrees()),this.group.add(this.buildCars()),this.group.add(this.buildEdgeRubble());let r=new Map;for(let e of this.city.buildings){if(e.clip)continue;let t=ku(e.height,e.district),n=r.get(t);n?n.push(e):r.set(t,[e])}for(let[e,t]of r){let n=new ai(n_(e),t_(16777215,{vertexColors:!0}),t.length);n.frustumCulled=!1,n.userData.storeys=e,this.buildingMeshList.push(n),this.group.add(n),t.forEach((e,t)=>this.slots.set(e.id,{mesh:n,index:t}))}let i=0;for(let t of e.buildings)this.greebleStart.set(t.id,i),i+=t.greebles;this.greebles=new ai(new vi(1,1,1),t_(Zg.greeble),Math.max(i,1)),this.greebles.frustumCulled=!1,this.group.add(this.greebles),this.debris=new ai(new vi(1,1,1),t_(Zg.rubble),Math.max(e.buildings.length*e_,1)),this.debris.frustumCulled=!1,this.group.add(this.debris),this.refreshAll()}buildShardTops(){return[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)].map((e,t)=>{let n=e[0];if(!n)throw Error(`city boundary is empty`);let r=new Qi;r.moveTo(n.x,-n.z);for(let t=1;t<e.length;t++){let n=e[t];n&&r.lineTo(n.x,-n.z)}r.closePath();let i=new qr(new za(r),t_(Zg.shardTop));return i.rotation.x=-Math.PI/2,i.name=t<this.city.surfaces.length?`shard-top-${t}`:`shard-chip-top-${t}`,i})}buildCliffBands(){let e=[...this.city.surfaces.map(e=>({points:e,depth:340,chip:!1})),...this.city.decorativeFragments.map(e=>({points:e.boundary,depth:e.depth,chip:!0}))],t=[0,.28,.62,1],n=[];for(let r=0;r<3;r++){let i=Zg.cliff[r];if(i===void 0)continue;let a=[];for(let n of e){if(n.chip&&r>0)continue;let e=n.points,i=n.chip?0:-(t[r]??0)*n.depth,o=n.chip?-n.depth:-(t[r+1]??1)*n.depth,s=this.polygonCentre(e),c=[1,.995,.985,.97][r]??1,l=[1,.995,.985,.97][r+1]??.97;for(let t=0;t<e.length;t++){let n=e[t],r=e[(t+1)%e.length];if(!n||!r)continue;let u=this.scaleFrom(n,s,c),d=this.scaleFrom(r,s,c),f=this.scaleFrom(r,s,l),p=this.scaleFrom(n,s,l);a.push(u.x,i,u.z,d.x,i,d.z,f.x,o,f.z,u.x,i,u.z,f.x,o,f.z,p.x,o,p.z)}}let o=new wr;o.setAttribute(`position`,new lr(new Float32Array(a),3)),o.computeVertexNormals();let s=new qr(o,t_(i,{side:2}));s.name=`cliff-band-${r}`,n.push(s)}return n}polygonCentre(e){let t=0,n=0;for(let r of e)t+=r.x,n+=r.z;return{x:t/e.length,z:n/e.length}}scaleFrom(e,t,n){return{x:t.x+(e.x-t.x)*n,z:t.z+(e.z-t.z)*n}}buildPads(e,t,n){let r=this.city.blocks.filter(t=>t.kind===e),i=r.map(e=>e.clip??this.rectPoints(e)),a=e===`park`?r.map(e=>{let t=this.parkGrassFootprint(e);return t.length>=3?[t]:[]}):void 0,o=new qr(this.polygonsGeometry(i,0,n,a),t_(t));return o.name=`${e}-pads`,o}buildParkland(){let e=this.city.blocks.filter(e=>e.kind===`park`).map(e=>this.parkGrassFootprint(e)).filter(e=>e.length>=3),t=new qr(this.polygonsGeometry(e,0,Iu),t_(Zg.park));return t.name=`parkland`,t}parkGrassFootprint(e){let t=e.innerClip;if(!t||t.length<3)return[];let n=e.clip??[];if(!n.length||!t.some(e=>this.distanceToPolygonEdge(e,n)<=1e-4))return t;let r=this.polygonCentre(t),i=Math.max(...t.map(e=>Math.hypot(e.x-r.x,e.z-r.z)),1),a=1-Math.min(.02/i,.001);return t.map(e=>this.scaleFrom(e,r,a))}distanceToPolygonEdge(e,t){let n=1/0;for(let r=0;r<t.length;r++){let i=t[r],a=t[(r+1)%t.length];if(!i||!a)continue;let o=a.x-i.x,s=a.z-i.z,c=Math.max(0,Math.min(1,((e.x-i.x)*o+(e.z-i.z)*s)/Math.max(o*o+s*s,1e-9)));n=Math.min(n,Math.hypot(e.x-(i.x+o*c),e.z-(i.z+s*c)))}return n}buildRoads(){let e=[...this.city.surfaces,...this.city.decorativeFragments.map(e=>e.boundary)],t=new qr(this.polygonsGeometry(e,0,1),t_(Zg.road));return t.name=`roads`,t}buildFragmentOverlays(){return[{kind:`built`,colour:Zg.sidewalk,top:Iu},{kind:`parking`,colour:Zg.parking,top:Iu},{kind:`park`,colour:Zg.park,top:Iu}].map(e=>{let t=this.city.decorativeFragments.flatMap(t=>t.overlays.filter(t=>t.kind===e.kind).map(e=>e.polygon)),n=new qr(this.polygonsGeometry(t,0,e.top),t_(e.colour));return n.name=`chip-${e.kind}`,n})}rectPoints(e){return[{x:e.x0,z:e.z0},{x:e.x1,z:e.z0},{x:e.x1,z:e.z1},{x:e.x0,z:e.z1}]}appendPrism(e,t,n,r,i=!0,a=[]){if(t.length<3)return;let o=t.reduce((e,n,r)=>{let i=t[(r+1)%t.length];return i?e+n.x*i.z-i.x*n.z:e},0)>=0?[...t]:[...t].reverse(),s=o.map(e=>new G(e.x,e.z)),c=a.filter(e=>e.length>=3).map(e=>e.map(e=>new G(e.x,e.z))),l=[s,...c].flat(),u=Na.triangulateShape(s,c);for(let t of u){let n=t[0],i=t[1],a=t[2];if(n===void 0||i===void 0||a===void 0)continue;let o=l[n],s=l[i],c=l[a];!o||!s||!c||((s.x-o.x)*(c.y-o.y)-(s.y-o.y)*(c.x-o.x)>0?e.push(o.x,r,o.y,c.x,r,c.y,s.x,r,s.y):e.push(o.x,r,o.y,s.x,r,s.y,c.x,r,c.y))}if(i)for(let t=0;t<o.length;t++){let i=o[t],a=o[(t+1)%o.length];!i||!a||e.push(i.x,n,i.z,i.x,r,i.z,a.x,n,a.z,a.x,n,a.z,i.x,r,i.z,a.x,r,a.z)}}appendBandedPrism(e,t,n,r,i,a,o){if(n.length<3)return;let s=e.length/3;this.appendPrism(e,n,r,i,!1);for(let n=s;n<e.length/3;n++)t.push(o.r,o.g,o.b);let c=Math.max(1,Math.round(a));for(let a=0;a<c;a++){let s=r+(i-r)*a/c,l=r+(i-r)*(a+1)/c,u=a%2==0?1:$g,d=e.length/3;for(let t=0;t<n.length;t++){let r=n[t],i=n[(t+1)%n.length];!r||!i||e.push(r.x,s,r.z,r.x,l,r.z,i.x,s,i.z,i.x,s,i.z,r.x,l,r.z,i.x,l,i.z)}for(let n=d;n<e.length/3;n++)t.push(o.r*u,o.g*u,o.b*u)}}polygonsGeometry(e,t,n,r){let i=[];e.forEach((e,a)=>this.appendPrism(i,e,t,n,!0,r?.[a]??[]));let a=new wr;return a.setAttribute(`position`,new lr(new Float32Array(i),3)),a.computeVertexNormals(),a}buildEdgeRubble(){let e=this.city.decorativeFragments.flatMap(e=>e.rubble),t=new qr(this.polygonsGeometry(e,Iu,Iu+2.2),t_(Zg.rubble));return t.name=`edge-rubble`,t}buildClipped(){let e=[],t=[];for(let n of this.city.buildings){if(!n.clip||n.clip.length<3)continue;let r=Math.max(n.height*Qg[n.state],2.2);if(n.state===`rubble`?this.color.setHex(Zg.rubble):(this.color.setHex(Yg[n.paletteIndex%Yg.length]??16777215),n.state===`damaged`&&this.color.multiplyScalar(.76)),n.state===`rubble`){let i=e.length/3;this.appendPrism(e,n.clip,Iu,Iu+r);for(let n=i;n<e.length/3;n++)t.push(this.color.r,this.color.g,this.color.b)}else{let i=ku(r,n.district);this.appendBandedPrism(e,t,n.clip,Iu,Iu+r,i,this.color)}}let n=new wr;n.setAttribute(`position`,new lr(new Float32Array(e),3)),n.setAttribute(`color`,new lr(new Float32Array(t),3)),n.computeVertexNormals();let r=new qr(n,t_(16777215,{vertexColors:!0}));return r.name=`clipped-buildings`,r}clippedSignature(){let e=``;for(let t of this.city.buildings)t.clip&&(e+=t.state[0]);return e}rebuildClipped(){let e=this.clippedSignature();if(e===this.clippedState)return;this.clippedState=e;let t=this.buildClipped();if(this.clipped){this.group.remove(this.clipped),this.clipped.geometry.dispose();let e=this.clipped.material;Array.isArray(e)?e.forEach(e=>e.dispose()):e.dispose()}this.clipped=t,this.group.add(t)}buildStripes(e,t,n){let r=e.map(e=>e.clip??this.rectPoints({x0:e.x-e.width/2,z0:e.z-e.depth/2,x1:e.x+e.width/2,z1:e.z+e.depth/2})),i=new qr(this.polygonsGeometry(r,0,n),t_(t));return i.frustumCulled=!1,i}buildTrees(){let e=new xn;e.name=`trees`;let t=new ai(new Ia(2.75,2),t_(Zg.tree),Math.max(this.city.trees.length,1));t.name=`tree-canopies`,t.frustumCulled=!1;let n=new ai(new bi(.55,.72,1.5,5),t_(Zg.treeTrunk),Math.max(this.city.trees.length,1));return n.name=`tree-stumps`,n.frustumCulled=!1,this.city.trees.forEach((e,r)=>{this.matrix.makeScale(e.scale,e.scale,e.scale),this.matrix.setPosition(e.x,Iu+.75*e.scale,e.z),n.setMatrixAt(r,this.matrix),this.matrix.setPosition(e.x,Iu+3.5*e.scale,e.z),t.setMatrixAt(r,this.matrix)}),t.instanceMatrix.needsUpdate=!0,n.instanceMatrix.needsUpdate=!0,e.add(n,t),e}buildCars(){let e=[...this.city.cars,...this.city.decorativeFragments.flatMap(e=>e.parkedCars)],t=new ai(new vi(1,1,1),t_(16777215),Math.max(e.length,1));return t.name=`cars`,t.frustumCulled=!1,e.forEach((e,n)=>{let r=5.4,i=2.4;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(e.alongX?r:i,2,e.alongX?i:r),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,(e.parked?Iu:1)+1,e.z),t.setMatrixAt(n,this.matrix),this.color.setHex(Xg[e.paletteIndex%Xg.length]??16777215),t.setColorAt(n,this.color)}),t.instanceMatrix.needsUpdate=!0,t.instanceColor&&(t.instanceColor.needsUpdate=!0),t}refresh(e){let t=this.city.get(e);t&&(this.writeBuilding(t),this.flush(this.slots.get(e)?.mesh),this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,t.clip&&this.rebuildClipped())}refreshAll(){for(let e of this.city.buildings)this.writeBuilding(e);for(let e of this.buildingMeshList)this.flush(e);this.greebles.instanceMatrix.needsUpdate=!0,this.debris.instanceMatrix.needsUpdate=!0,this.rebuildClipped()}flush(e){e&&(e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0))}writeBuilding(e){let t=this.slots.get(e.id);if(!t)return;let n=ju[e.state],r=Math.max(e.height*Qg[e.state],2.2),i=e.width*n,a=e.depth*n;this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(i,r,a),this.matrix.scale(this.scale),this.matrix.setPosition(e.x,Iu+r/2,e.z),t.mesh.setMatrixAt(t.index,this.matrix);let o=Yg[e.paletteIndex%Yg.length]??16777215;e.state===`rubble`?this.color.setHex(Zg.rubble):(this.color.setHex(o),e.state===`damaged`&&this.color.multiplyScalar(.76)),t.mesh.setColorAt(t.index,this.color),this.writeGreebles(e,Iu+r),this.writeDebris(e)}writeGreebles(e,t){let n=this.greebleStart.get(e.id);if(n===void 0)return;let r=e.state===`intact`;for(let i=0;i<e.greebles;i++){if(!r){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,t,e.z),this.greebles.setMatrixAt(n+i,this.matrix);continue}let a=_u({x:((i+1)/(e.greebles+1)-.5)*e.width*.55,z:((e.id+i)%5/5-.5)*e.depth*.55},e.rotation??0),o=Math.min(e.width,e.depth)*.16,s=o*(.7+(e.id+i)%3*.35);this.matrix.makeRotationY(-(e.rotation??0)),this.scale.set(o,s,o),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+a.x,t+s/2,e.z+a.z),this.greebles.setMatrixAt(n+i,this.matrix)}}writeDebris(e){let t=e.id*e_;if(t+e_>this.debris.count)return;let n=e.state===`rubble`;for(let r=0;r<e_;r++){if(!n){this.matrix.makeScale(0,0,0),this.matrix.setPosition(e.x,Iu,e.z),this.debris.setMatrixAt(t+r,this.matrix);continue}let i=e.id*3+r,a=_u({x:(i*37%100/100-.5)*(e.width+16),z:(i*61%100/100-.5)*(e.depth+16)},e.rotation??0),o=Math.min(e.width,e.depth)*(.14+i%4/4*.16);this.matrix.makeScale(o,o*.5,o),this.matrix.setPosition(e.x+a.x,Iu+o*.25,e.z+a.z),this.debris.setMatrixAt(t+r,this.matrix)}}get meshCount(){return this.group.children.length}get buildingMeshes(){return this.buildingMeshList}renderedStoreysOf(e){let t=this.slots.get(e);return typeof t?.mesh.userData.storeys==`number`?t.mesh.userData.storeys:void 0}renderedHeightOf(e){if(this.city.get(e)?.clip)return 2.2;let t=this.slots.get(e);if(t)return t.mesh.getMatrixAt(t.index,this.matrix),this.matrix.elements[5]}dispose(){for(let e of this.group.children)if(e instanceof qr){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}}},i_=256,a_=180,o_=new K(0,1,0);function s_(e,t,n){return Math.max(t,Math.min(n,e))}function c_(e){switch(e){case`machine-cannon`:return{colour:Bp(`machines`),width:.82,impact:3.1};case`machine-harbinger-laser`:return{colour:Bp(`machines`),width:.48,impact:2.3};case`machine-rifle`:return{colour:Bp(`machines`),width:.18,impact:1};case`ancient-acid`:return{colour:Lp,width:.34,impact:1.7};case`ancient-bite`:return{colour:16760428,width:0,impact:1.8};default:return{colour:16777215,width:.25,impact:1.2}}}var l_=class{group=new xn;beamsMesh;impactsMesh;matrix=new Kt;position=new K;direction=new K;scale=new K;rotation=new wt;colour=new Y;beams=[];impacts=[];melee=new Map;constructor(){this.beamsMesh=new ai(new bi(1,1,1,6),new Fr({color:16777215,transparent:!0,opacity:.9,depthWrite:!1}),i_),this.impactsMesh=new ai(new Ia(1,1),new Fr({color:16777215,transparent:!0,opacity:.85,depthWrite:!1}),i_),this.beamsMesh.frustumCulled=!1,this.impactsMesh.frustumCulled=!1,this.beamsMesh.renderOrder=20,this.impactsMesh.renderOrder=21,this.group.add(this.beamsMesh,this.impactsMesh)}sync(e,t){for(let n of e)n.kind===`combatHit`&&this.addHit(n,t);this.beams=this.beams.filter(e=>t<e.startedAt+e.duration),this.impacts=this.impacts.filter(e=>t<e.startedAt+e.duration);for(let[e,n]of this.melee)t>=n.startedAt+n.duration&&this.melee.delete(e);this.syncBeams(t),this.syncImpacts(t)}meleePose(e,t){let n=this.melee.get(e);if(!n)return;let r=s_((t-n.startedAt)/n.duration,0,1);if(r>=1)return;let i=Math.sin(r*Math.PI);return{forward:i*n.distance,yaw:i*.18}}addHit(e,t){let n=Uf(e.weaponId),r=c_(e.weaponId),i=vm(e.attackerTypeId),a=vm(e.targetTypeId),o=Math.max(1,i.radius*.48),s=(e.shotIndex-(e.shotCount-1)/2)*Math.max(.8,i.radius*.3),c=new K(e.sourceX+Math.cos(e.sourceHeading)*o-Math.sin(e.sourceHeading)*s,Iu+i.height*.58,e.sourceZ+Math.sin(e.sourceHeading)*o+Math.cos(e.sourceHeading)*s),l=new K(e.targetX,Iu+a.height*.56,e.targetZ);if(n.projectileSpeed===0){this.melee.set(e.attackerId,{startedAt:t,duration:a_,distance:Math.max(.6,i.radius*.1)}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t,duration:130});return}let u=s_(c.distanceTo(l)/n.projectileSpeed*250,65,180);this.pushBeam({start:c,end:l,colour:r.colour,width:r.width,startedAt:t,duration:u}),this.pushImpact({position:l,colour:r.colour,radius:r.impact,startedAt:t+u*.72,duration:120})}pushBeam(e){this.beams.length>=i_&&this.beams.shift(),this.beams.push(e)}pushImpact(e){this.impacts.length>=i_&&this.impacts.shift(),this.impacts.push(e)}syncBeams(e){let t=0;for(let n of this.beams){let r=s_((e-n.startedAt)/n.duration,0,1);this.direction.subVectors(n.end,n.start).multiplyScalar(r);let i=this.direction.length();if(i<=1e-5)continue;this.direction.normalize(),this.position.copy(n.start).addScaledVector(this.direction,i/2),this.rotation.setFromUnitVectors(o_,this.direction);let a=1-r*.55;this.scale.set(n.width*a,i,n.width*a),this.matrix.compose(this.position,this.rotation,this.scale),this.beamsMesh.setMatrixAt(t,this.matrix),this.colour.setHex(n.colour),this.beamsMesh.setColorAt(t,this.colour),t++}this.hideUnused(this.beamsMesh,t)}syncImpacts(e){let t=0;for(let n of this.impacts){let r=(e-n.startedAt)/n.duration;if(r<0||r>=1)continue;let i=n.radius*(.45+Math.sin(r*Math.PI)*.9);this.matrix.makeScale(i,i,i),this.matrix.setPosition(n.position),this.impactsMesh.setMatrixAt(t,this.matrix),this.colour.setHex(n.colour),this.impactsMesh.setColorAt(t,this.colour),t++}this.hideUnused(this.impactsMesh,t)}hideUnused(e,t){for(let n=t;n<e.count;n++)this.matrix.makeScale(0,0,0),e.setMatrixAt(n,this.matrix);e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0)}dispose(){this.beamsMesh.geometry.dispose(),this.beamsMesh.material.dispose(),this.impactsMesh.geometry.dispose(),this.impactsMesh.material.dispose()}},u_=256,d_=Iu+.12,f_=1,p_=0,m_=class{group=new xn;buildings;units;matrix=new Kt;scale=new K;buildingSignature=``;constructor(e,t){let n=()=>new Za({color:1512978,flatShading:!0,transparent:!0,opacity:.24,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1});this.buildings=new qr(new wr,n()),this.units=new ai(new yi(1,12),n(),u_);for(let e of[this.buildings,this.units])e.frustumCulled=!1;this.group.add(this.buildings,this.units),this.sync(e,t)}sync(e,t){let n=e.buildings.map(e=>e.state).join(``);n!==this.buildingSignature&&(this.buildingSignature=n,this.rebuildBuildingShadows(e));let r=0;for(let e of t.units){if(r>=this.units.count)break;let n=xf(t.typeOf(e));this.matrix.makeRotationX(-Math.PI/2),this.scale.set(n*.9,n*.62,1),this.matrix.scale(this.scale),this.matrix.setPosition(e.x+n*.22,d_+.03,e.z+n*.16),this.units.setMatrixAt(r++,this.matrix)}for(let e=r;e<this.units.count;e++)this.units.setMatrixAt(e,this.matrix.makeScale(0,0,0));this.units.instanceMatrix.needsUpdate=!0}rebuildBuildingShadows(e){let t=[];for(let n of e.buildings){let e=n.state===`intact`?n.height:n.state===`damaged`?n.height*.55:0;if(e<=0)continue;let r=e*.48,i=n.clip??Fu(n),a=h_([...i,...i.map(e=>({x:e.x+f_*r,z:e.z+p_*r}))]);for(let e=1;e<a.length-1;e++)this.appendTriangle(t,a[0],a[e+1],a[e])}let n=this.buildings.geometry,r=new wr;r.setAttribute(`position`,new lr(new Float32Array(t),3)),r.computeVertexNormals(),this.buildings.geometry=r,n.dispose()}appendTriangle(e,t,n,r){if(!(!t||!n||!r))for(let i of[t,n,r])e.push(i.x,d_,i.z)}dispose(){for(let e of[this.buildings,this.units])e.geometry.dispose(),e.material.dispose()}};function h_(e){let t=[...e].sort((e,t)=>e.x-t.x||e.z-t.z),n=(e,t,n)=>(t.x-e.x)*(n.z-e.z)-(t.z-e.z)*(n.x-e.x),r=e=>{let t=[];for(let r of e){for(;t.length>=2&&n(t[t.length-2],t[t.length-1],r)<=0;)t.pop();t.push(r)}return t},i=r(t),a=r([...t].reverse());return i.pop(),a.pop(),[...i,...a]}var g_=2400,__=7e3,v_=class{scene=new An;city;units;combat;shadows;constructor(e,t){this.scene.background=new Y(Zg.sky),this.scene.fog=new kn(Zg.sky,g_,__),this.shadows=new m_(e,t),this.scene.add(this.shadows.group),this.city=new r_(e),this.scene.add(this.city.group),this.units=new xm(t),this.scene.add(this.units.group),this.combat=new l_,this.scene.add(this.combat.group);let n=new jo(16774102,2.05);n.position.set(-1,1,0).normalize(),this.scene.add(n),this.scene.add(new go(Zg.sky,7236170,1))}dispose(){this.city.dispose(),this.units.dispose(),this.combat.dispose(),this.shadows.dispose(),this.scene.clear()}},y_=[1,2,3,4,5,6,7,8,9,0],b_=class{ids=[];groups=new Map;get size(){return this.ids.length}list(){return this.ids}has(e){return this.ids.includes(e)}primary(){return this.ids[0]}set(e){this.ids=[...new Set(e)].sort((e,t)=>e-t)}add(e){this.set([...this.ids,...e])}toggle(e){this.set(this.has(e)?this.ids.filter(t=>t!==e):[...this.ids,e])}clear(){this.ids=[]}assignGroup(e,t=this.ids){y_.includes(e)&&this.groups.set(e,[...t])}recallGroup(e){let t=this.groups.get(e);return!t||t.length===0?!1:(this.set(t),!0)}groupSize(e){return this.groups.get(e)?.length??0}occupiedGroups(){return y_.filter(e=>this.groupSize(e)>0)}prune(e){this.ids=this.ids.filter(e);for(let[t,n]of this.groups){let r=n.filter(e);r.length!==n.length&&(r.length===0?this.groups.delete(t):this.groups.set(t,r))}}},x_=1213353265,S_=250,C_=85,w_=100,T_=1800,E_=80,D_=3;function O_(e,t,n){let r,i=1/0;for(let a of e.buildings){if(a.state===`rubble`)continue;let e=(a.x-t)**2+(a.z-n)**2;e<i&&(i=e,r=a.id)}return r}var k_=class{windowTicks;ticks=[];earned=[];total=0;last=null;constructor(e=360){this.windowTicks=e}add(e,t){for(this.last!==null&&t>this.last&&(this.total+=t-this.last),this.last=t,this.ticks.push(e),this.earned.push(this.total);this.ticks.length>1&&e-(this.ticks[0]??e)>this.windowTicks;)this.ticks.shift(),this.earned.shift()}get perMinute(){if(this.ticks.length<2)return 0;let e=(this.ticks.at(-1)??0)-(this.ticks[0]??0);return e<=0?0:((this.earned.at(-1)??0)-(this.earned[0]??0))/e*30*60}};function A_(e){switch(e.kind){case`produced`:return`${(e.subject??`UNIT`).toUpperCase()} READY`;case`productionQueued`:return`BUILDING ${(e.subject??`UNIT`).toUpperCase()}`;case`productionRefused`:return`INSUFFICIENT HUMANS`;case`productionBlocked`:return`NO ROOM TO DEPLOY`;case`built`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`buildRefused`:return`CANNOT BUILD HERE`;case`constructionRefusedResources`:return`INSUFFICIENT HUMANS`;case`constructionStarted`:return`${(e.subject??`STRUCTURE`).toUpperCase()} SUMMONING`;case`constructionComplete`:return`${(e.subject??`STRUCTURE`).toUpperCase()} ONLINE`;case`constructionCancelled`:return`SUMMONING CANCELLED`;case`underAttack`:return`UNIT UNDER ATTACK`;case`combatHit`:return null;case`unitDown`:return`UNIT DESTROYED`;case`victory`:return`HARBINGER DESTROYED`;case`tier2`:return`TIER 2 UNLOCKED`;case`tier2Refused`:return`TIER 2 UNAVAILABLE`;case`structureDown`:return`STRUCTURE DOWN`;case`civiliansDisplaced`:return`${e.count??0} HUMANS DISPLACED`;case`deposited`:return null}}var j_=new Set([`productionQueued`,`produced`,`productionRefused`,`productionBlocked`,`constructionStarted`,`constructionComplete`,`constructionCancelled`,`constructionRefusedResources`]);function M_({world:e,renderer:t,overlayEl:n,boxEl:r,store:i,onLoadRequested:a,onSeedStepRequested:o,onExitToTitle:s,onBattleFactionRequested:c}){let l=new Rd(e),u=new v_(e.city,e.army),d=e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction),f=e.city.startAnchors[e.playerFaction===`machines`?0:1]??{x:0,z:0},p=d.length>0?{x:d.reduce((e,t)=>e+t.x,0)/d.length,z:d.reduce((e,t)=>e+t.z,0)/d.length}:f,m=new Pm(window.innerWidth/window.innerHeight,p),h=new hu(t.domElement),g=new b_,_=new mg(n),v=new fg,y=new k_,b=new k_,x=new vg(document.body,e.city,e.population,e.populationCapacity,e.playerFaction),S=new xg(document.body),C=new Mg(e.city,e.army,e.population);u.scene.add(C.group);let w=new Vg;u.scene.add(w.group);let T=new Wg;u.scene.add(T.group);let E=null,D=0,O=(e,t)=>{E=e,D=t+T_},k=new lh(document.body,Oh({world:e,selected:0,banner:null}),t=>{t===`cancel`&&g.size>0?e.enqueue(e.playerFaction,{kind:`stop`,unitIds:g.list()}):t===`primary`&&g.size>0&&e.playerFaction===`machines`&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()})}),A=w_,j=null,M=null,N=new zm(document.body,e.playerFaction,{onDeploy:()=>e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()}),onIsolateType:t=>{g.set(g.list().filter(n=>e.army.get(n)?.typeId===t))}}),P=new Zm(document.body,e.playerFaction,{onProduce:(t,n)=>e.enqueue(e.playerFaction,{kind:`produce`,producer:t,typeId:n}),onBuild:(t,n)=>{let r=bf(n).cost;if(!e.freeProduction&&e.resources.humans<r){O(`INSUFFICIENT HUMANS`,performance.now());return}M={builderId:t.id,structureTypeId:n},O(`CHOOSE SUMMONING SITE`,performance.now())},onUnlockTier2:()=>e.enqueue(e.playerFaction,{kind:`unlockTier2`})}),F=null,I=0,ee=null,te=null,ne=!1,re=()=>{te?.dispose(),te=null,ne=!1,h.consume()},ie=()=>{te||=(ne=!0,new Xh(document.body,ee,{onSaveAndExit:()=>{if(!i){re(),s();return}let t=yp(e);i.put(t,Date.now()).catch(e=>console.error(`save failed`,e)).finally(()=>{re(),s()})},onExitAnyway:()=>{re(),s()},onCancel:()=>re()}))},ae=()=>{t.setSize(window.innerWidth,window.innerHeight),m.setAspect(window.innerWidth/window.innerHeight)};window.addEventListener(`resize`,ae);let oe=new G,L=t=>{let n=km(m.camera,e.city,t);return Hd(n===void 0?void 0:e.city.get(n),e.population)?n:void 0},se=t=>{if(g.size===0)return;let n=Dm(m.camera,e.army,t),r=n===void 0?void 0:e.army.get(n);if(!(!r||e.army.typeOf(r).faction===e.playerFaction))return g.list().some(t=>{let n=e.army.get(t);if(!n||n.deployTimer>0)return!1;let r=e.army.typeOf(n);return r.faction===e.playerFaction&&(r.weaponIds??[]).some(e=>Uf(e).targetClasses.includes(`unit`))})?r.id:void 0},ce=0,le=null,ue=0,de=0,fe=30,pe=S_,me=0,he=0,ge=0,_e=!1,ve=!1,ye=!0,be=0,xe=!1,Se=n=>{if(xe)return;let s=le===null?1e3/60:n-le;if(le=n,v.add(s),h.sample(),!ne){m.update(h,s/1e3);let t=M!==null&&h.orderAt!==void 0;t&&(M=null,O(`SUMMONING CANCELLED`,n));let r=h.selectGesture;if(r&&M){if(!r.isBox){oe.set((r.rect.x0+r.rect.x1)/2,(r.rect.y0+r.rect.y1)/2);let t=Em(m.camera,oe),n=t&&e.constructionPlacement(M.builderId,M.structureTypeId,t.x,t.z);n&&(e.enqueue(e.playerFaction,{kind:`build`,builderId:M.builderId,structureTypeId:M.structureTypeId,x:n.x,z:n.z}),M=null)}}else if(r)if(r.isBox){let t=jm(m.camera,e.army,r.rect).filter(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});r.additive?g.add(t):g.set(t)}else{oe.set((r.rect.x0+r.rect.x1)/2,(r.rect.y0+r.rect.y1)/2);let t=Dm(m.camera,e.army,oe),i=t===void 0?void 0:e.army.get(t),a=i&&e.army.typeOf(i).faction===e.playerFaction?t:void 0;if(i&&a===void 0)j=i.id,r.additive||g.clear();else if(a===void 0){r.additive||(j=null);let t=g.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),i=Tm(m.camera,e.crowds.all,oe),a=L(oe);t.length>0&&i!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,crowdId:i}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):t.length>0&&a!==void 0?(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:t,buildingId:a}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n)):r.additive||g.clear()}else r.additive?(j=null,g.toggle(a)):(j=null,g.set([a]))}for(let e of y_){let t=h.pressModifiers(`Digit${e}`);t&&(t.shift?g.assignGroup(e):g.recallGroup(e))}if(h.wasPressed(`Escape`)&&(M?(M=null,O(`SUMMONING CANCELLED`,n)):g.size>0||j!==null?(g.clear(),j=null):ie()),h.wasPressed(`KeyP`)&&(ye=!0),h.wasPressed(`KeyI`)&&x.toggle(),e.battlefield&&h.wasPressed(`Digit1`)&&c(`machines`),e.battlefield&&h.wasPressed(`Digit2`)&&c(`ancients`),h.wasPressed(`BracketLeft`)&&o(-1),h.wasPressed(`BracketRight`)&&o(1),h.orderAt&&!t&&g.size>0){let t=g.list(),r=se(h.orderAt),i=t.filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`}),a=Tm(m.camera,e.crowds.all,h.orderAt),o=L(h.orderAt);if(r!==void 0){let n=e.army.get(r);n&&e.enqueue(e.playerFaction,{kind:`attack`,unitIds:t,targetId:n.id,x:n.x,z:n.z})}else if(i.length>0&&a!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,crowdId:a}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else if(i.length>0&&o!==void 0)e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:i,buildingId:o}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n);else{let n=Em(m.camera,h.orderAt);n&&e.enqueue(e.playerFaction,{kind:`move`,unitIds:t,x:n.x,z:n.z})}}if(h.wasPressed(`KeyQ`)&&g.size>0&&e.enqueue(e.playerFaction,{kind:`stop`,unitIds:g.list()}),h.wasPressed(`KeyX`)){let t=O_(e.city,m.focus.x,m.focus.z);t!==void 0&&e.enqueue(`debug`,{kind:`damage`,buildingId:t})}if(h.wasPressed(`KeyZ`)&&e.enqueue(`debug`,{kind:`raze`,x:m.focus.x,z:m.focus.z,radius:C_}),h.wasPressed(`KeyB`)){ce=(ce+1)%Au.length;let t=Au[ce];e.enqueue(`debug`,{kind:`setAllStates`,state:t})}if(h.wasPressed(`KeyH`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:E_,charge:0}),h.wasPressed(`KeyJ`)&&e.enqueue(`debug`,{kind:`debugResources`,humans:0,charge:D_}),h.wasPressed(`KeyE`)&&g.size>0){let t=O_(e.city,m.focus.x,m.focus.z);t!==void 0&&Hd(e.city.get(t),e.population)&&(e.enqueue(e.playerFaction,{kind:`harvest`,unitIds:g.list(),buildingId:t}),O(e.playerFaction===`machines`?`EXTRACTING HUMANS`:`CONSUMING HUMANS`,n))}if(h.wasPressed(`KeyR`)&&g.size>0&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:g.list()}),h.wasPressed(`KeyT`)&&e.enqueue(e.playerFaction,{kind:`unlockTier2`}),h.wasPressed(`KeyF`)||h.wasPressed(`KeyG`)){let t=e.army.units.find(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).producesUnits&&t.deployed&&t.deployTimer===0),r=e.playerFaction===`machines`?`machine-infantry`:`ancient-infantry`,i=e.playerFaction===`machines`?`machine-construct`:`ancient-support`;t?e.enqueue(e.playerFaction,{kind:`produce`,producer:{kind:`unit`,id:t.id},typeId:h.wasPressed(`KeyG`)?i:r}):O(`NO DEPLOYED FACTORY`,n)}if(h.wasPressed(`KeyV`)){let t=g.primary()===void 0?void 0:e.army.get(g.primary());t&&e.army.typeOf(t).canDeploy&&e.enqueue(e.playerFaction,{kind:`deploy`,unitIds:[t.id]})}if(h.wasPressed(`F5`)&&i){let t=yp(e);O(`SAVING`,n),i.put(t,Date.now()).then(()=>{O(`SAVED · STEP ${t.tick}`,performance.now()),ee=`step ${t.tick}`}).catch(e=>{console.error(`save failed`,e),O(`SAVE FAILED`,performance.now())})}h.wasPressed(`F9`)&&a()}if(h.dragRect&&!ne){let e=h.dragRect;r.style.display=`block`,r.style.left=`${(e.x0+1)/2*100}%`,r.style.top=`${(1-e.y1)/2*100}%`,r.style.width=`${(e.x1-e.x0)/2*100}%`,r.style.height=`${(e.y1-e.y0)/2*100}%`}else r.style.display=`none`;h.consume();let d=performance.now(),f=l.advance(ne?0:s),p=e.drainChangedBuildings();if(p.length>0)if(me=performance.now()-d,ye=!0,p.length>8)u.city.refreshAll();else for(let e of p)u.city.refresh(e);let te=e.drainEvents();u.combat.sync(te,n);for(let e of te){let t=A_(e);t&&(O(t,n),j_.has(e.kind)&&(F=t,I=n+T_))}g.prune(t=>{let n=e.army.get(t);return n!==void 0&&e.army.typeOf(n).faction===e.playerFaction});let re=se(h.pointer);u.units.sync(e.army,f,t=>{let n=e.army.get(t);if(t===re)return`#ff2020`;if((g.has(t)||t===j)&&n)return ih[e.army.typeOf(n).faction].line},e=>u.combat.meleePose(e,n)),S.sync(e.army,m.camera,e=>g.has(e)||e===j),u.shadows.sync(e.city,e.army),w.sync(e.crowds.all,f,e.tick,e.army);let ae=g.list().filter(t=>{let n=e.army.get(t),r=n&&e.army.typeOf(n);return r?.faction===e.playerFaction&&r.role===`harvester`});x.setSelectionEnabled(ae.length>0),x.sync(m.camera,m.zoomFraction);let Ce=ae.length>0?L(h.pointer):void 0;C.sync(e.tick,ae.length>0,Ce);let we=M?Em(m.camera,h.pointer):void 0,Te=M!==null&&we!==void 0&&e.constructionPlacement(M.builderId,M.structureTypeId,we.x,we.z)!==void 0;if(T.sync(M&&we?{structureTypeId:M.structureTypeId,x:we.x,z:we.z}:void 0,Te,e.constructionSites,n),t.render(u.scene,m.camera),j!==null&&e.army.get(j)===void 0&&(j=null),A+=s,A>=w_){A=0,E!==null&&n>D&&(E=null),F!==null&&n>I&&(F=null),k.render(Oh({world:e,selected:g.size,banner:E})),N.render(Mh(e,g,j===null?void 0:e.army.get(j)));let t=g.primary()===void 0?void 0:e.army.get(g.primary());P.render(Ph(e,t,F))}if(de+=s,de>=1e3&&(fe=(l.stepCount-ue)/de*1e3,ue=l.stepCount,de=0),y.add(e.tick,e.resources.humans),b.add(e.tick,e.resources.charge),pe+=s,pe>=S_){if(pe=0,ye){ye=!1;let t=e.city.startAnchors[0];if(t){let n={x:m.focus.x,z:m.focus.z},r=e.nav.onShardCells,i=e.nav.flood(t.x,t.z,`small`,n),a=e.nav.flood(t.x,t.z,`large`,n);he=i.count/r,ge=a.count/r,_e=i.reachedTarget,ve=a.reachedTarget}}let[t,n,r]=e.destructionCounts();_.render({faction:Yf[e.playerFaction].name,battlefield:e.battlefield,seed:e.seed,fps:v.fps,simHz:fe,stepCount:e.tick,droppedMs:l.droppedMs,alpha:f,zoomFraction:m.zoomFraction,pitchDeg:m.pitchDeg,distance:m.camera.position.distanceTo(m.focus),focusX:m.focus.x,focusZ:m.focus.z,cityBuildings:e.city.buildings.length,cityIntact:t??0,cityDamaged:n??0,cityRubble:r??0,populationLabels:x.enabled,units:e.army.units.length,unitsMoving:e.army.countMoving(),unitsBlocked:e.army.countBlocked(),unitsUnreached:e.army.countUnreached(),unitsStalled:e.army.countStalled(),selected:g.size,groups:g.occupiedGroups(),pathsQueued:e.army.pending,pathsTotal:e.army.pathsTotal,navCells:e.nav.cellCount,navRebuilds:e.nav.rebuildCount,navLastRebuildCells:e.nav.lastRebuildCells,navRebuildMs:me,smallPassable:e.nav.passableFraction(`small`),largePassable:e.nav.passableFraction(`large`),reachSmall:he,reachLarge:ge,atFocusSmall:_e,atFocusLarge:ve,humans:e.resources.humans,humansCap:e.resources.humansCap,charge:e.resources.charge,chargeCap:e.resources.chargeCap,chargeSegments:e.resources.segmentsReady,techTier:e.techTier,humansPerMinute:y.perMinute,chargePerMinute:b.perMinute,cargoInTransit:e.cargoInTransit(),populationRemaining:e.remainingPopulation(),populationTotal:e.populationCapacity.reduce((e,t)=>e+t,0),structures:e.army.units.filter(t=>e.army.typeOf(t).faction===e.playerFaction&&e.army.typeOf(t).role===`structure`).length,queued:e.queuedProduction(),civilianCrowds:e.crowds.all.length,civilianHumans:e.crowds.totalHumans(),harvesting:e.army.units.filter(wf).length,harvestIdle:e.harvestersIdle(),unitsDeployed:e.army.countDeployed(),unitsDeploying:e.army.countDeploying()},v)}be=requestAnimationFrame(Se)};return be=requestAnimationFrame(Se),{dispose(){xe=!0,cancelAnimationFrame(be),window.removeEventListener(`resize`,ae),h.dispose(),k.dispose(),N.dispose(),P.dispose(),re(),u.dispose(),x.dispose(),S.dispose(),C.dispose(),w.dispose(),T.dispose(),r.style.display=`none`}}}async function N_(){let e=window.location.pathname.endsWith(`/battle.html`),t=document.getElementById(`overlay`),n=document.getElementById(`overlay-content`),r=document.getElementById(`overlay-toggle`),i=document.getElementById(`selectbox`);if(!t||!n||!(r instanceof HTMLButtonElement)||!i)throw Error(`overlay controls or #selectbox missing from the page shell`);r.addEventListener(`click`,()=>{let e=t.classList.toggle(`minimized`);r.textContent=e?`+`:`−`,r.title=e?`Restore developer panel`:`Minimize developer panel`,r.setAttribute(`aria-expanded`,String(!e))});let a=new du({antialias:!0,powerPreference:`high-performance`});a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(a.domElement);let o=Dp.available?new Dp:null;o||console.warn(`IndexedDB unavailable; saving is disabled for this session`);let s=F_();Np(`machines`,s.colourVariant.machines),Np(`ancients`,s.colourVariant.ancients);let c=()=>{t.style.display=s.overlayVisible?``:`none`};c();let l=null,u=null,d=e=>{u?.dispose(),u=e},f=e=>{d(null),l?.dispose(),l=M_({world:e,renderer:a,overlayEl:n,boxEl:i,store:o,onLoadRequested:p,onSeedStepRequested:t=>{let n=e.seed+t>>>0;queueMicrotask(()=>f(e.battlefield?new _p(n,e.playerFaction,{battlefield:!0}):new _p(n,e.playerFaction)))},onExitToTitle:()=>{l?.dispose(),l=null,m()},onBattleFactionRequested:t=>{!e.battlefield||t===e.playerFaction||queueMicrotask(()=>f(new _p(e.seed,t,{battlefield:!0})))}})},p=e=>{o&&o.get(e).then(e=>{if(!e){console.warn(o.lastRejection??`no save to load`);return}f(bp(e.envelope))}).catch(e=>console.error(`load failed`,e))},m=async()=>{let e=o?await o.get().catch(()=>void 0):void 0,t=o?await o.list().catch(()=>[]):[];d(new Rh(document.body,{saved:e&&{faction:e.envelope.playerFaction,tick:e.envelope.tick,clock:Eh(e.envelope.tick)},slotCount:t.length,onStart:e=>f(new _p(x_,e)),onResume:()=>p(),onSelectSave:()=>void g(),onSettings:()=>h()}))},h=()=>{d(new Jh(document.body,s,{onColourVariant:(e,t)=>{s.colourVariant[e]=t,Np(e,t),I_(s),h()},onToggleOverlay:e=>{s.overlayVisible=e,I_(s),c(),h()},onBack:()=>void m()}))},g=async()=>{let e=o?await o.list().catch(()=>[]):[];d(new Yh(document.body,e.map(e=>({slot:e.slot,faction:e.readable?e.envelope.playerFaction:void 0,clock:Eh(e.envelope.tick??0),tick:e.envelope.tick??0,savedAtMs:e.savedAtMs,readable:e.readable})),{onLoad:e=>p(e),onDelete:e=>{o&&o.delete(e).then(()=>g()).catch(e=>console.error(`delete failed`,e))},onBack:()=>void m()}))},_=new URLSearchParams(window.location.search).get(`faction`);if(e){f(new _p(x_,_===`ancients`?`ancients`:`machines`,{battlefield:!0}));return}if(_===`machines`||_===`ancients`){f(new _p(x_,_));return}await m()}var P_=`human-resources.frontend`;function F_(){let e={colourVariant:{machines:0,ancients:0},overlayVisible:!0};try{let t=window.localStorage.getItem(P_);if(!t)return e;let n=JSON.parse(t),r=e=>+(e===1);return{colourVariant:{machines:r(n.colourVariant?.machines),ancients:r(n.colourVariant?.ancients)},overlayVisible:n.overlayVisible!==!1}}catch{return e}}function I_(e){try{window.localStorage.setItem(P_,JSON.stringify(e))}catch{}}N_();
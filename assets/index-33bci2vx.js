const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/gameStartup-D7Cbz1DJ.js","assets/loop-CCaCSFt0.js","assets/three.core-BnugWimV.js","assets/toon-DLatBX7x.js","assets/SkeletonUtils-CHxfGqZJ.js","assets/saveStore-DCvLN4QC.js"])))=>i.map(i=>d[i]);
...
`;function y(){let e=document.getElementById(`overlay`),t=document.getElementById(`overlay-content`),n=document.getElementById(`overlay-toggle`),r=document.getElementById(`selectbox`);if(!e||!t||!(n instanceof HTMLButtonElement)||!r)throw Error(`overlay controls or #selectbox missing from the page shell`);return{overlayPanelEl:e,overlayEl:t,overlayToggleEl:n,boxEl:r}}function b(e){e.overlayToggleEl.addEventListener(`click`,()=>{let t=e.overlayPanelEl.classList.toggle(`minimized`);e.overlayToggleEl.textContent=t?`+`:`−`,e.overlayToggleEl.title=t?`Restore developer panel`:`Minimize developer panel`,e.overlayToggleEl.setAttribute(`aria-expanded`,String(!t))})}var x=`modulepreload`,S=function(e){return`/HumanResourcesLowPoly/`+e},C={},w=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=S(t,n),t=s(t),t in C)return;C[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:x,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},T=e=>{`requestIdleCallback`in window?window.requestIdleCallback(e,{timeout:1500}):globalThis.setTimeout(e,0)};function E(){let e=new URLSearchParams(window.location.search).get(`faction`);return window.location.pathname.endsWith(`/battle.html`)||e===`machines`||e===`ancients`?`direct`:void 0}function D(){b(y());let e=E();if(e){w(async()=>{let{startGame:e}=await import(`./gameStartup-D7Cbz1DJ.js`);return{startGame:e}},__vite__mapDeps([0,1,2,3,4,5])).then(({startGame:t})=>t(e)).catch(O);return}let t,n=()=>t??=w(()=>import(`./gameStartup-D7Cbz1DJ.js`),__vite__mapDeps([0,1,2,3,4,5])),i,a=!1,o=!1,s=e=>{a||(a=!0,n().then(({startGame:t})=>{t(e),i.dispose()}).catch(e=>{a=!1,i.resumeAfterStartFailure(),O(e)}))},c=()=>{n().then(({startGame:e})=>{a||o||(e(),o=!0,i.dispose())}).catch(O)},l=(e,t=0)=>{i?.dispose(),i=new u(document.body,{...e?{saved:e}:{},slotCount:t,onStart:e=>s(e),onResume:()=>s(`resume`),onSelectSave:()=>s(`save-list`),onSettings:()=>s(`settings`),onRuntimeIntent:()=>{n()}})};l(),T(c),T(()=>{w(async()=>{let{SaveStore:e}=await import(`./saveStore-DCvLN4QC.js`);return{SaveStore:e}},__vite__mapDeps([5,1])).then(async({SaveStore:e})=>{if(!e.available||a||o)return;let t=new e,[n,i]=await Promise.all([t.get(),t.list()]);a||o||l(n?{faction:n.envelope.playerFaction,tick:n.envelope.tick,clock:r(n.envelope.tick)}:void 0,i.length)}).catch(e=>console.error(`title save summary failed`,e))})}function O(e){console.error(`application startup failed`,e)}D();export{o as a,u as i,y as n,a as o,v as r,r as s,w as t};